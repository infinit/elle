...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        boyer_moore<pattern_iterator> bm ( network_boost::begin(pattern), network_boost::end (pattern));
        return bm ( corpus_first, corpus_last );
    }
    ...
    template <typename Range>
    network_boost::algorithm::boyer_moore<typename network_boost::range_iterator<const Range>::type>
    make_boyer_moore ( const Range &r ) {
        return network_boost::algorithm::boyer_moore
            <typename network_boost::range_iterator<const Range>::type> (network_boost::begin(r), network_boost::end(r));
        }
    
    template <typename Range>
    network_boost::algorithm::boyer_moore<typename network_boost::range_iterator<Range>::type>
