...
namespace network_boost
{
    ...
    namespace range
    {
        ...
        inline bool equal( const SinglePassRange1& rng1, const SinglePassRange2& rng2 )
        {
            ...
            return ::network_boost::range_detail::equal(
                ::network_boost::begin(rng1), ::network_boost::end(rng1),
                ::network_boost::begin(rng2), ::network_boost::end(rng2) );
        }
    ...
    using ::network_boost::range::equal;
} // namespace network_boost
