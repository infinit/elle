...
bool one_of ( InputIterator first, InputIterator last, Predicate p )
{
    ...
    return network_boost::algorithm::none_of (++i, last, p);
}
...
{
    return network_boost::algorithm::one_of ( network_boost::begin (r), network_boost::end (r), p );
}
...
bool one_of_equal ( InputIterator first, InputIterator last, const V &val )
{
    ...
    if (i == last)
        return false;                    // Didn't occur at all
    return network_boost::algorithm::none_of_equal (++i, last, val);
}
...
{
    return network_boost::algorithm::one_of_equal ( network_boost::begin (r), network_boost::end (r), val );
} 
