...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::network_boost::detail::empty_helper<cvt,::network_boost::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::network_boost::detail::empty_helper<
                  cvt
                , ::network_boost::is_class<T>::value
                , ::network_boost::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::network_boost::detail::is_empty_impl<T>::value> {};
