...
template <class T> struct is_member_function_pointer 
   : public ::network_boost::integral_constant<bool, ::network_boost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value>{};
...
#pragma warning(disable:6334)
        ...
        BOOST_STATIC_CONSTANT(
            bool, value = (
                1 == sizeof(::network_boost::type_traits::is_mem_fun_pointer_tester(self_type::make_t))
            ));
#if BOOST_WORKAROUND(BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select< 
      ::network_boost::is_reference<T>::value || ::network_boost::is_array<T>::value>::template result_<T>{};
...
struct is_member_function_pointer
   : public integral_constant<bool, ::network_boost::detail::is_member_function_pointer_impl<T>::value>{};
