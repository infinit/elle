...
namespace network_boost {
    namespace algorithm {
        ...
        */
        ...
        {
            return 
                ::network_boost::find_format_all_copy(      
                    ::network_boost::trim_copy_if(Input, IsSpace),
                    ::network_boost::token_finder(IsSpace, ::network_boost::token_compress_on),
                    ::network_boost::dissect_formatter(::network_boost::head_finder(1)));
        }
        ...
        */
        ...
        {
            ::network_boost::trim_if(Input, IsSpace);
            ::network_boost::find_format_all(       
                Input,          
                ::network_boost::token_finder(IsSpace, ::network_boost::token_compress_on),
                ::network_boost::dissect_formatter(::network_boost::head_finder(1)));
        }
        ...
        */
        ...
        {
            return trim_all_copy_if(Input, ::network_boost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_all_if(Input, ::network_boost::is_space(Loc));
        }
        ...
        inline SequenceT trim_fill_copy_if(const SequenceT& Input, const RangeT& Fill, PredicateT IsSpace)
        {
            return 
                ::network_boost::find_format_all_copy(      
                    ::network_boost::trim_copy_if(Input, IsSpace),
                    ::network_boost::token_finder(IsSpace, ::network_boost::token_compress_on),
                    ::network_boost::const_formatter(::network_boost::as_literal(Fill)));
        }
        ...
        */
        ...
        {
            return trim_fill_copy_if(Input, Fill, ::network_boost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_fill_if(Input, Fill, ::network_boost::is_space(Loc));
        }
