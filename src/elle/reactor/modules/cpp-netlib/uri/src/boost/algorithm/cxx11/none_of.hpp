...
{
    return network_boost::algorithm::none_of (network_boost::begin (r), network_boost::end (r), p );
} 
...
{
    return network_boost::algorithm::none_of_equal (network_boost::begin (r), network_boost::end (r), val);
} 
