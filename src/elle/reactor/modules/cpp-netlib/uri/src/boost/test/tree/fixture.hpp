...
public:
    // Constructor
    function_based_fixture( network_boost::function<void ()> const& setup_, network_boost::function<void ()> const& teardown_ )
    : m_setup( setup_ )
...
private:
    ...
    // Data members
    network_boost::function<void ()>    m_setup;
    network_boost::function<void ()>    m_teardown;
};
