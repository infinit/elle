...
{
    return network_boost::algorithm::copy_if (network_boost::begin (r), network_boost::end(r), result, p);
}
...
///
template<typename Range, typename OutputIterator, typename Predicate>
std::pair<typename network_boost::range_iterator<const Range>::type, OutputIterator> 
copy_while ( const Range &r, OutputIterator result, Predicate p )
{
    return network_boost::algorithm::copy_while (network_boost::begin (r), network_boost::end(r), result, p);
}
...
{
    return network_boost::algorithm::copy_until (network_boost::begin (r), network_boost::end(r), result, p);
}

}} // namespace network_boost and algorithm
