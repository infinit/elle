...
template<> struct is_integral< ::network_boost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::network_boost::long_long_type> : public true_type{};
...
template<> struct is_integral<network_boost::int128_type> : public true_type{};
template<> struct is_integral<network_boost::uint128_type> : public true_type{};
#endif
