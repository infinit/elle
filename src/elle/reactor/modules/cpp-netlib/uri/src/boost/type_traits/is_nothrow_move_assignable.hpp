...
struct false_or_cpp11_noexcept_move_assignable: public ::network_boost::false_type {};

template <class T>
struct false_or_cpp11_noexcept_move_assignable <
        T,
        typename ::network_boost::enable_if_c<sizeof(T) && BOOST_NOEXCEPT_EXPR(::network_boost::declval<T&>() = ::network_boost::declval<T>())>::type
    > : public ::network_boost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(::network_boost::declval<T&>() = ::network_boost::declval<T>())>
{};

}

template <class T>
struct is_nothrow_move_assignable : public integral_constant<bool, ::network_boost::detail::false_or_cpp11_noexcept_move_assignable<T>::value>{};

template <class T> struct is_nothrow_move_assignable<T const> : public ::network_boost::false_type {};
template <class T> struct is_nothrow_move_assignable<T const volatile> : public ::network_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T volatile> : public ::network_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T&> : public ::network_boost::false_type{};
...
struct is_nothrow_move_assignable : public integral_constant<bool,
   (::network_boost::has_trivial_move_assign<T>::value || ::network_boost::has_nothrow_assign<T>::value) &&  ! ::network_boost::is_array<T>::value>{};
