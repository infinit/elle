...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return network_boost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) network_boost::unit_test::readwrite_property<property_type >
...
: public network_boost::unit_test::readonly_property<property_type > {                      \
    typedef network_boost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return network_boost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return network_boost::addressof( base_prop::value ); }
