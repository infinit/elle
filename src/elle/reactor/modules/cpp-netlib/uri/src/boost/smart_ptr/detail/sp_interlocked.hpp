...
# define BOOST_SP_INTERLOCKED_INCREMENT ::network_boost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::network_boost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::network_boost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::network_boost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::network_boost::detail::InterlockedExchangeAdd
