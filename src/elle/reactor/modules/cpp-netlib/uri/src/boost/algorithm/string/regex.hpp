...
//  find_regex  -----------------------------------------------//
        ...
        */
        ...
        {
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::network_boost::as_literal(Input));

            return ::network_boost::algorithm::regex_finder(Rx,Flags)(
                ::network_boost::begin(lit_input), ::network_boost::end(lit_input) );
        }
...
//  replace_regex --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::network_boost::algorithm::find_format_copy( 
                Output,
                Input,
                ::network_boost::algorithm::regex_finder( Rx, Flags ),
                ::network_boost::algorithm::regex_formatter( Format, Flags ) );
        }
        ...
        */
        ...
        inline void replace_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::network_boost::algorithm::find_format( 
                Input,
                ::network_boost::algorithm::regex_finder( Rx, Flags ),
                ::network_boost::algorithm::regex_formatter( Format, Flags ) );
        }
...
//  replace_all_regex --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_regex_copy(
            ...
            match_flag_type Flags=match_default | format_default )
        {
            return ::network_boost::algorithm::find_format_all_copy( 
                Output,
                Input,
                ::network_boost::algorithm::regex_finder( Rx, Flags ),
                ::network_boost::algorithm::regex_formatter( Format, Flags ) );
        ...
        */
        ...
        inline void replace_all_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::network_boost::algorithm::find_format_all( 
                Input,
                ::network_boost::algorithm::regex_finder( Rx, Flags ),
                ::network_boost::algorithm::regex_formatter( Format, Flags ) );
        }
       ...
       */
            ...
            match_flag_type Flags=match_default )
        {
            return ::network_boost::algorithm::find_format_copy(
                ...
                Input,
                ::network_boost::algorithm::regex_finder( Rx, Flags ),
                ::network_boost::algorithm::empty_formatter( Input ) );
        }
...
//  find_all_regex ------------------------------------------------------------------//
        ...
        /*!
            ...
            or \c std::list<network_boost::iterator_range<std::string::iterator>>
        ...
        */
        ...
        inline SequenceSequenceT& find_all_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::network_boost::algorithm::iter_find(
                Result,
                Input,
                ::network_boost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  split_regex ------------------------------------------------------------------//
        ...
        */
        ...
        inline SequenceSequenceT& split_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::network_boost::algorithm::iter_split(
                Result,
                Input,
                ::network_boost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  join_if ------------------------------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            // Parse input
            InputIteratorT itBegin=::network_boost::begin(Input);
            InputIteratorT itEnd=::network_boost::end(Input);
            ...
            while(
                itBegin!=itEnd && 
                !::network_boost::regex_match(::network_boost::begin(*itBegin), ::network_boost::end(*itBegin), Rx, Flags)) ++itBegin;

            // Add this element
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::network_boost::end(Result), *itBegin);
                ++itBegin;
            }

            for(;itBegin!=itEnd; ++itBegin)
            {
                if(::network_boost::regex_match(::network_boost::begin(*itBegin), ::network_boost::end(*itBegin), Rx, Flags))
                {
                    // Add separator
                    detail::insert(Result, ::network_boost::end(Result), ::network_boost::as_literal(Separator));
                    // Add element
                    detail::insert(Result, ::network_boost::end(Result), *itBegin);
                }
            }
