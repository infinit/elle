...
typename network_boost::range_iterator<const Range>::type find_if_not ( const Range &r, Predicate p )
{
    return network_boost::algorithm::find_if_not (network_boost::begin (r), network_boost::end(r), p);
}
