...
using network_boost::BOOST_REGEX_DETAIL_NS::directory_iterator;
using network_boost::BOOST_REGEX_DETAIL_NS::file_iterator;
using network_boost::BOOST_REGEX_DETAIL_NS::mapfile;
} // namespace network_boost
