...
network_boost::unit_test::make_test_case( network_boost::function<void ()>(test_function), \
                                  BOOST_TEST_STRINGIZE( test_function ),   \
                                  __FILE__, __LINE__ )
#define BOOST_CLASS_TEST_CASE( test_function, tc_instance )                \
network_boost::unit_test::make_test_case( (test_function),                         \
                                  BOOST_TEST_STRINGIZE( test_function ),   \
...
( new network_boost::unit_test::test_suite( testsuite_name, __FILE__, __LINE__ ) )
...
#define BOOST_AUTO_TEST_SUITE_NO_DECOR( suite_name )                    \
    BOOST_AUTO_TEST_SUITE_WITH_DECOR(                                   \
        suite_name,                                                     \
        network_boost::unit_test::decorator::collector::instance() )            \
/**/
...
BOOST_TEST_DECORATOR( * network_boost::unit_test::expected_failures( n ) )      \
/**/
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    network_boost::unit_test::make_test_case(                                   \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( network_boost::type<TestType>* = 0 )                       \
    {                                                                   \
        BOOST_TEST_CHECKPOINT('"' << #test_name <<"\" fixture entry."); \
        ...
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" exit.");         \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    network_boost::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                      \
    network_boost::unit_test::ut_detail::template_test_case_gen<name,typelist>( \
...
template<typename type_name>                                            \
void BOOST_JOIN( name, _impl )( network_boost::type<type_name>* );              \
                                                                        \
struct name {                                                           \
    template<typename TestType>                                         \
    static void run( network_boost::type<TestType>* frwrd = 0 )                 \
    {                                                                   \
...
static network_boost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static network_boost::unit_test::decorator::collector const&                    \
...
namespace network_boost { namespace unit_test { namespace ut_detail {
...
typedef ::network_boost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static network_boost::unit_test::ut_detail::auto_test_unit_registrar    \
...
bool init_unit_test()                   {
#else
::network_boost::unit_test::test_suite*
init_unit_test_suite( int, char* [] )   {
#endif

#ifdef BOOST_TEST_MODULE
    using namespace ::network_boost::unit_test;
