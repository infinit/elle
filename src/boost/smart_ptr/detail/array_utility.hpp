...
namespace network_boost {
    namespace detail {
        typedef network_boost::true_type  ms_is_trivial;
        typedef network_boost::false_type ms_no_trivial;
        ...
        inline void ms_destroy(T* memory, std::size_t size) {
            network_boost::has_trivial_destructor<T> trivial;
        ...
        inline void ms_init(T* memory, std::size_t size) {
            network_boost::has_trivial_default_constructor<T> trivial;
