...
{
    typedef typename ::network_boost::remove_cv<typename
     ::network_boost::remove_reference<T>::type>::type  type;

};  // network_boost::detail::remove_cv_ref
...
struct is_related
    : public ::network_boost::is_same<
     typename ::network_boost::detail::remove_cv_ref<T>::type,
     typename ::network_boost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::network_boost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::network_boost::disable_if< ::network_boost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::network_boost::detail::enable_if_unrelated<base_from_member, T...>::type>
...
};  // network_boost::base_from_member
