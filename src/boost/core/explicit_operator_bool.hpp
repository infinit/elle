...
#define BOOST_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE operator network_boost::detail::unspecified_bool_type () const\
    {\
        return (!this->operator! () ? &network_boost::detail::unspecified_bool::true_value : (network_boost::detail::unspecified_bool_type)0);\
    }

#define BOOST_EXPLICIT_OPERATOR_BOOL_NOEXCEPT()\
    BOOST_FORCEINLINE operator network_boost::detail::unspecified_bool_type () const BOOST_NOEXCEPT\
    {\
        return (!this->operator! () ? &network_boost::detail::unspecified_bool::true_value : (network_boost::detail::unspecified_bool_type)0);\
    }

#define BOOST_CONSTEXPR_EXPLICIT_OPERATOR_BOOL()\
    BOOST_FORCEINLINE BOOST_CONSTEXPR operator network_boost::detail::unspecified_bool_type () const BOOST_NOEXCEPT\
    {\
        return (!this->operator! () ? &network_boost::detail::unspecified_bool::true_value : (network_boost::detail::unspecified_bool_type)0);\
    }
