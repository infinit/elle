...
{
    static network_boost::core::typeinfo ti_;
...
template<class T> network_boost::core::typeinfo core_typeid_< T >::ti_ = core_typeid_< T >::name();
#else
template<class T> network_boost::core::typeinfo core_typeid_< T >::ti_(core_typeid_< T >::name());
#endif
...
#define BOOST_CORE_TYPEID(T) (network_boost::detail::core_typeid_<T>::ti_)
