...
//Forward declare network_boost::rv
...
{
   return ::network_boost::move_detail::addressof_impl<T>::f
      ( ::network_boost::move_detail::addr_impl_ref<T>( v ), 0 );
}
...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::network_boost::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::network_boost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< network_boost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const network_boost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::network_boost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
