...
namespace bmupmu = ::network_boost::move_upmu;
...
namespace bmupd = network_boost::move_upd;
namespace bmupmu = ::network_boost::move_upmu;
...
struct default_delete
{
      ...
      ) BOOST_NOEXCEPT
   {
      ...
      BOOST_STATIC_ASSERT(( !::network_boost::move_upmu::missing_virtual_destructor<default_delete, U>::value ));
   }
