...
// @endcond
   ...
   template <class T>
   class rv
      : public ::network_boost::move_detail::if_c
         < ::network_boost::move_detail::is_class<T>::value
         , T
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::network_boost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::network_boost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::network_boost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };

   }  //namespace network_boost {

   #define BOOST_RV_REF(TYPE)\
      ::network_boost::rv< TYPE >& \
   //

   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::network_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::network_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF(TYPE)\
      const ::network_boost::rv< TYPE >& \
   //

   #define BOOST_COPY_ASSIGN_REF_BEG \
      const ::network_boost::rv<  \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::network_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::network_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   inline typename ::network_boost::move_detail::enable_if_c
      <  ::network_boost::move_detail::is_lvalue_reference<Ret>::value ||
        !::network_boost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   inline typename ::network_boost::move_detail::enable_if_c
      < !::network_boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::network_boost::has_move_emulation_enabled<T>::value
      , ::network_boost::rv<T>&>::type
         move_return(::network_boost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      network_boost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::network_boost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      {  return *BOOST_MOVE_TO_RV_CAST(::network_boost::rv<TYPE>*, this);  }\
      operator const ::network_boost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::network_boost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< network_boost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::network_boost::move()` due to rvalue reference limitations.
   //!
