...
template<typename FPT>
struct fpt_limits : network_boost::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref network_boost::math::fpc::strength given at construction.
 */
template<typename FPT>
 ...
 *
 * Serves the same purpose as network_boost::math::fpc::close_at_tolerance, but used when one
