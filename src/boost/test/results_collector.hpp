...
public:
    ...
    /// @returns network_boost::exit_success on success, network_boost::exit_exception_failure in case test unit was aborted for any reason
    ///          (incuding uncausght exception) and network_boost::exit_test_failure otherwise
