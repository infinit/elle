...
#  define BOOST_LIB_NAME network_boost_unit_test_framework
...
namespace network_boost { namespace unit_test {
...
{
    return ::network_boost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
