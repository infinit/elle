...
#define BOOST_TEST_LOG_ENTRY( ll )                                                  \
    (::network_boost::unit_test::unit_test_log                                              \
        << ::network_boost::unit_test::log::begin( BOOST_TEST_L(__FILE__), __LINE__ ))(ll)  \
/**/
...
#define BOOST_TEST_MESSAGE( M )                                 \
    BOOST_TEST_LOG_ENTRY( ::network_boost::unit_test::log_messages )    \
...
#define BOOST_TEST_PASSPOINT()                                  \
    ::network_boost::unit_test::unit_test_log.set_checkpoint(           \
...
#define BOOST_TEST_CHECKPOINT( M )                              \
    ::network_boost::unit_test::unit_test_log.set_checkpoint(           \
        BOOST_TEST_L(__FILE__),                                 \
        static_cast<std::size_t>(__LINE__),                     \
        (::network_boost::wrap_stringstream().ref() << M).str() )       \
/**/
