...
class base;
typedef network_boost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( network_boost::function<void()> const& setup, network_boost::function<void()> const& teardown = network_boost::function<void()>() )
{
...
public:
    typedef network_boost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
