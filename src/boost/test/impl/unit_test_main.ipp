...
unit_test_main( init_unit_test_func init_func, int argc, char* argv[] )
{
    ...
    BOOST_TEST_I_TRY {
        ...
        if( list_cont != unit_test::OF_INVALID ) {
            ...
            return network_boost::exit_success;
        }
    ...
    BOOST_TEST_I_CATCH( framework::internal_error, ex ) {
        ...
        result_code = network_boost::exit_exception_failure;
    }
...
main( int argc, char* argv[] )
{
    ...
    network_boost::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::network_boost::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    network_boost::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::network_boost::unit_test::unit_test_main( init_func, argc, argv );
}
