...
namespace rt = network_boost::runtime;
...
register_parameters( rt::parameters_store& store )
{
    rt::option auto_start_dbg( AUTO_START_DBG, (
        ...
        rt::help = "Option " + AUTO_START_DBG + " specifies whether Boost.Test should attempt "
                   ...
                   "Boost.Test debug API, specifically the function network_boost::debug::set_debugger."
    ));
...
init( int& argc, char** argv )
{
    ...
    BOOST_TEST_I_TRY {
        ...
        if( runtime_config::get<bool>( USAGE ) ) {
            ...
            BOOST_TEST_I_THROW( framework::nothing_to_test( network_boost::exit_success ) );
        }
    ...
    BOOST_TEST_I_CATCH( rt::ambiguous_param, ex ) {
        ...
        BOOST_TEST_I_THROW( framework::nothing_to_test( network_boost::exit_exception_failure ) );
    }
