...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::network_boost::mpl::aux::yes_tag operator|( \
      ::network_boost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::network_boost::mpl::aux::no_tag operator|( \
      ::network_boost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::network_boost::mpl::na) >* \
    ); \
/**/
...
::network_boost::mpl::aux::yes_tag operator|( \
      ::network_boost::mpl::aux::has_rebind_tag<int> \
    , ::network_boost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
