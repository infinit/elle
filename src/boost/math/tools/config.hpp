...
#include <boost/cstdint.hpp> // for network_boost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         network_boost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    network_boost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  network_boost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  network_boost::non_type<t, v>*
...
#  define BOOST_MATH_NOEXCEPT(T) noexcept(network_boost::is_floating_point<T>::value)
#  define BOOST_MATH_IS_FLOAT(T) (network_boost::is_floating_point<T>::value)
#endif
#else
...
{
   static const bool value = network_boost::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#    define BOOST_FPU_EXCEPTION_GUARD network_boost::math::detail::fpu_guard local_guard_object;
