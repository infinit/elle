...
{
   return network_boost::lexical_cast<T>(s);
}
#endif
template <class T>
...
#define BOOST_MATH_BIG_CONSTANT(T, D, x)\
   network_boost::math::tools::make_big_value<T>(\
      BOOST_MATH_LARGEST_FLOAT_C(x), \
      BOOST_STRINGIZE(x), \
      mpl::bool_< (is_convertible<network_boost::math::tools::largest_float, T>::value) && \
      ((D <= network_boost::math::tools::numeric_traits<network_boost::math::tools::largest_float>::digits) \
          || is_floating_point<T>::value \
          || (network_boost::math::tools::numeric_traits<T>::is_specialized && \
          (network_boost::math::tools::numeric_traits<T>::digits10 <= network_boost::math::tools::numeric_traits<network_boost::math::tools::largest_float>::digits10))) >(), \
      network_boost::is_convertible<const char*, T>())
//
...
#define BOOST_MATH_HUGE_CONSTANT(T, D, x)\
   network_boost::math::tools::make_big_value<T>(0.0L, BOOST_STRINGIZE(x), \
   mpl::bool_<is_floating_point<T>::value || (network_boost::math::tools::numeric_traits<T>::is_specialized && network_boost::math::tools::numeric_traits<T>::max_exponent <= network_boost::math::tools::numeric_traits<network_boost::math::tools::largest_float>::max_exponent && network_boost::math::tools::numeric_traits<T>::digits <= network_boost::math::tools::numeric_traits<network_boost::math::tools::largest_float>::digits)>(), \
   network_boost::is_convertible<const char*, T>())
