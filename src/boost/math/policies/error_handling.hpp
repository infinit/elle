...
namespace network_boost{ namespace math{
...
void raise_error(const char* function, const char* message)
{
...
#ifndef BOOST_NO_RTTI
  msg += (network_boost::format(function) % network_boost::math::policies::detail::name_of<T>()).str();
#else
  msg += function;
#endif
  msg += ": ";
  ...
  E e(msg);
  network_boost::throw_exception(e);
}
...
void raise_error(const char* function, const char* message, const T& val)
{
  ...
  int prec = 2 + (network_boost::math::policies::digits<T, network_boost::math::policies::policy<> >() * 30103UL) / 100000UL;
  msg = do_format(network_boost::format(msg), network_boost::io::group(std::setprecision(prec), val));
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const ::network_boost::math::policies::domain_error< ::network_boost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::network_boost::math::policies::domain_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::network_boost::math::policies::domain_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::domain_error< ::network_boost::math::policies::user_error>&)
{
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::pole_error< ::network_boost::math::policies::throw_on_error>&)
{
   return network_boost::math::policies::detail::raise_domain_error(function, message, val,  ::network_boost::math::policies::domain_error< ::network_boost::math::policies::throw_on_error>());
}
...
inline BOOST_MATH_CONSTEXPR T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::pole_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::network_boost::math::policies::detail::raise_domain_error(function, message, val,  ::network_boost::math::policies::domain_error< ::network_boost::math::policies::ignore_error>());
}
...
inline BOOST_MATH_CONSTEXPR T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::pole_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::network_boost::math::policies::detail::raise_domain_error(function, message, val,  ::network_boost::math::policies::domain_error< ::network_boost::math::policies::errno_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::pole_error< ::network_boost::math::policies::user_error>&)
{
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::network_boost::math::policies::overflow_error< ::network_boost::math::policies::throw_on_error>&)
{
   raise_error<std::overflow_error, T>(function, message ? message : "numeric overflow");
   // We should never get here:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : network_boost::math::tools::max_value<T>();
}
...
inline BOOST_MATH_CONSTEXPR T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::network_boost::math::policies::overflow_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : network_boost::math::tools::max_value<T>();
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::network_boost::math::policies::overflow_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::network_boost::math::policies::overflow_error< ::network_boost::math::policies::user_error>&)
{
...
#ifndef BOOST_NO_RTTI
   fmsg += (network_boost::format(function) % network_boost::math::policies::detail::name_of<T>()).str();
#else
   fmsg += function;
#endif
   int prec = 2 + (network_boost::math::policies::digits<T, network_boost::math::policies::policy<> >() * 30103UL) / 100000UL;
   std::string msg = do_format(network_boost::format(message), network_boost::io::group(std::setprecision(prec), val));
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::network_boost::math::policies::underflow_error< ::network_boost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_underflow_error(
           const char* ,
           const char* ,
           const  ::network_boost::math::policies::underflow_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return T(0);
...
inline T raise_underflow_error(
           const char* /* function */,
           const char* /* message */,
           const  ::network_boost::math::policies::underflow_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::network_boost::math::policies::underflow_error< ::network_boost::math::policies::user_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& /* val */,
           const  ::network_boost::math::policies::denorm_error< ::network_boost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_denorm_error(
           ...
           const char* ,
           const T&  val,
           const  ::network_boost::math::policies::denorm_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T& val,
           const  ::network_boost::math::policies::denorm_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::denorm_error< ::network_boost::math::policies::user_error>&)
{
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::evaluation_error< ::network_boost::math::policies::throw_on_error>&)
{
   raise_error<network_boost::math::evaluation_error, T>(function, message, val);
   // we never get here:
   return T(0);
}
...
inline BOOST_MATH_CONSTEXPR T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::network_boost::math::policies::evaluation_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::network_boost::math::policies::evaluation_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::network_boost::math::policies::evaluation_error< ::network_boost::math::policies::user_error>&)
{
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::network_boost::math::policies::rounding_error< ::network_boost::math::policies::throw_on_error>&)
{
   raise_error<network_boost::math::rounding_error, T>(function, message, val);
   // we never get here:
   return TargetType(0);
}
...
inline BOOST_MATH_CONSTEXPR TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::network_boost::math::policies::rounding_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::network_boost::math::policies::rounding_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
           ...
           const  ::network_boost::math::policies::rounding_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   ...
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
   return  val > 0 ? network_boost::math::tools::max_value<T>() : -network_boost::math::tools::max_value<T>();
}
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType& t,
           const  ::network_boost::math::policies::rounding_error< ::network_boost::math::policies::user_error>&)
{
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::network_boost::math::policies::indeterminate_result_error< ::network_boost::math::policies::throw_on_error>&)
{
   raise_error<std::domain_error, T>(function, message, val);
   // we never get here:
   return std::numeric_limits<T>::quiet_NaN();
...
inline BOOST_MATH_CONSTEXPR T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::network_boost::math::policies::indeterminate_result_error< ::network_boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return result;
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::network_boost::math::policies::indeterminate_result_error< ::network_boost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::network_boost::math::policies::indeterminate_result_error< ::network_boost::math::policies::user_error>&)
{
...
inline bool check_overflow(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      network_boost::math::policies::detail::raise_overflow_error<R>(function, 0, pol);
...
inline bool check_underflow(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(network_boost::math::policies::detail::raise_underflow_error<R>(function, 0, pol));
      return true;
   }
   return false;
}
...
inline bool check_denorm(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(network_boost::math::policies::detail::raise_denorm_error<R>(function, 0, static_cast<R>(val), pol));
      return true;
   }
   return false;
}
...
template <class T, class Policy>
inline void check_series_iterations(const char* function, network_boost::uintmax_t max_iter, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && is_noexcept_error_policy<Policy>::value)
{
...
template <class T, class Policy>
inline void check_root_iterations(const char* function, network_boost::uintmax_t max_iter, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && is_noexcept_error_policy<Policy>::value)
{
