...
inline typename tools::promote_args<T>::type round(const T& v, const Policy& pol, const mpl::false_)
{
   ...
   if(!(network_boost::math::isfinite)(v))
      return policies::raise_rounding_error("network_boost::math::round<%1%>(%1%)", 0, static_cast<result_type>(v), static_cast<result_type>(v), pol);
   //
...
{
   BOOST_MATH_STD_USING
   T r = network_boost::math::round(v, pol);
   if((r > (std::numeric_limits<int>::max)()) || (r < (std::numeric_limits<int>::min)()))
      return static_cast<int>(policies::raise_rounding_error("network_boost::math::iround<%1%>(%1%)", 0, v, 0, pol));
...
inline long lround(const T& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<long>::max)()) || (r < (std::numeric_limits<long>::min)()))
      return static_cast<long int>(policies::raise_rounding_error("network_boost::math::lround<%1%>(%1%)", 0, v, 0L, pol));
...
template <class T, class Policy>
inline network_boost::long_long_type llround(const T& v, const Policy& pol)
{
   BOOST_MATH_STD_USING
   T r = network_boost::math::round(v, pol);
   if((r > (std::numeric_limits<network_boost::long_long_type>::max)()) || (r < (std::numeric_limits<network_boost::long_long_type>::min)()))
      return static_cast<network_boost::long_long_type>(policies::raise_rounding_error("network_boost::math::llround<%1%>(%1%)", 0, v, static_cast<network_boost::long_long_type>(0), pol));
   return static_cast<network_boost::long_long_type>(r);
}
template <class T>
inline network_boost::long_long_type llround(const T& v)
{
