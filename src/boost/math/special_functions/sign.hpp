...
namespace detail {
  ...
  // signbit
    ...
    {
       return (network_boost::math::signbit)(static_cast<double>(x));
    }
    ...
    inline long double (changesign_impl)(long double x, generic_tag<true> const&)
    {
       ...
       pd[0] = network_boost::math::changesign(pd[0]);
       pd[1] = network_boost::math::changesign(pd[1]);
       return x;
    }
...
{
   return (z == 0) ? 0 : (network_boost::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (network_boost::math::signbit)(static_cast<result_type>(x)) != (network_boost::math::signbit)(static_cast<result_type>(y)) 
      ? (network_boost::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
