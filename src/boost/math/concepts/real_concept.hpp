...
//   test_spots(network_boost::math::concepts::real_concept(0.));
...
public:
   ...
   real_concept(network_boost::ulong_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   real_concept(network_boost::long_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   ...
   real_concept& operator=(network_boost::long_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
   real_concept& operator=(network_boost::ulong_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
#endif
...
inline real_concept modf(real_concept a, real_concept* ipart)
{
   ...
   real_concept_base_type result = network_boost::math::modf(a.value(), &ip);
   *ipart = ip;
   return result;
#else
   real_concept_base_type ip;
...
{ return network_boost::math::iround(v.value(), pol); }
inline int iround(const concepts::real_concept& v)
{ return network_boost::math::iround(v.value(), policies::policy<>()); }
template <class Policy>
inline long lround(const concepts::real_concept& v, const Policy& pol)
{ return network_boost::math::lround(v.value(), pol); }
inline long lround(const concepts::real_concept& v)
{ return network_boost::math::lround(v.value(), policies::policy<>()); }

#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline network_boost::long_long_type llround(const concepts::real_concept& v, const Policy& pol)
{ return network_boost::math::llround(v.value(), pol); }
inline network_boost::long_long_type llround(const concepts::real_concept& v)
{ return network_boost::math::llround(v.value(), policies::policy<>()); }
#endif

template <class Policy>
inline int itrunc(const concepts::real_concept& v, const Policy& pol)
{ return network_boost::math::itrunc(v.value(), pol); }
inline int itrunc(const concepts::real_concept& v)
{ return network_boost::math::itrunc(v.value(), policies::policy<>()); }
template <class Policy>
inline long ltrunc(const concepts::real_concept& v, const Policy& pol)
{ return network_boost::math::ltrunc(v.value(), pol); }
inline long ltrunc(const concepts::real_concept& v)
{ return network_boost::math::ltrunc(v.value(), policies::policy<>()); }

#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline network_boost::long_long_type lltrunc(const concepts::real_concept& v, const Policy& pol)
{ return network_boost::math::lltrunc(v.value(), pol); }
inline network_boost::long_long_type lltrunc(const concepts::real_concept& v)
{ return network_boost::math::lltrunc(v.value(), policies::policy<>()); }
#endif
...
template <>
inline concepts::real_concept make_big_value<concepts::real_concept>(network_boost::math::tools::largest_float val, const char* , mpl::false_ const&, mpl::false_ const&)
{
...
namespace policies {
   namespace detail {
         ...
         const  ::network_boost::math::policies::rounding_error< ::network_boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
      {
         ...
         return  val > 0 ? network_boost::math::tools::max_value<concepts::real_concept>() : -network_boost::math::tools::max_value<concepts::real_concept>();
      }
