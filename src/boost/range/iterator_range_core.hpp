...
namespace network_boost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( network_boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( network_boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( network_boost::begin(l),
                                                 network_boost::end(l),
                                                 network_boost::begin(r),
                                                 network_boost::end(r) );
        }
        ...
        {
            return network_boost::equal(l, r);
        }
...
incrementable_t test_traversal_tag(network_boost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(network_boost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(network_boost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef network_boost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef network_boost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef network_boost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *network_boost::prior(this->m_End);
    }
    ...
    typedef BOOST_DEDUCED_TYPENAME
        network_boost::mpl::if_<
            network_boost::mpl::or_<
                network_boost::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                network_boost::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                network_boost::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                network_boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::network_boost::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME network_boost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME network_boost::enable_if<
            mpl::not_<network_boost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, network_boost::next(first, n));
        }
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( network_boost::begin( r ), network_boost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = network_boost::begin( r ),
                    new_end   = network_boost::end( r );
        ...
        */
        ...
        {
            return SeqT( network_boost::begin( r ), network_boost::end( r ) );
        }
