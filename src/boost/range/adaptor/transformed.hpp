...
namespace network_boost
{
    namespace range_detail
    {
        ...
        struct transformed_range :
            public network_boost::iterator_range<
        ...
        private:
            ...
            typedef network_boost::iterator_range<transform_iter_t> base;
        ...
        public:
            ...
            transformed_range(transform_fn_type f, R& r)
                : base(transform_iter_t(network_boost::begin(r), f),
                       transform_iter_t(network_boost::end(r), f))
            {
            }
        };
