...
namespace network_boost
{
    namespace range_detail
    {
        ...
        inline typename ::network_boost::enable_if<
        ...
        range_calculate_size(const SinglePassRange& rng)
        {
            return std::distance(network_boost::begin(rng), network_boost::end(rng));
        }
    }
...
// but only on the Mac!
        ...
        BOOST_RANGE_CONCEPT_ASSERT((network_boost::SinglePassRangeConcept<SinglePassRange>));
#endif
