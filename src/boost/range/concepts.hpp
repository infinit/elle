...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the network_boost::adaptors::filtered
        // class with a network_boost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                network_boost::ignore_unused_variable_warning(i2);
                ...
                BOOST_DEDUCED_TYPENAME network_boost::detail::iterator_traits<Iterator>::reference r1(*i);
                network_boost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME network_boost::detail::iterator_traits<Iterator>::reference r2(*(++i));
                network_boost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME network_boost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                network_boost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME network_boost::detail::iterator_traits<Iterator>::reference r(*(i++));
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = network_boost::begin(*m_range);
            iterator i2 = network_boost::end(*m_range);

            network_boost::ignore_unused_variable_warning(i1);
            network_boost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = network_boost::begin(const_range);
            const_iterator ci2 = network_boost::end(const_range);

            network_boost::ignore_unused_variable_warning(ci1);
            network_boost::ignore_unused_variable_warning(ci2);
        }
