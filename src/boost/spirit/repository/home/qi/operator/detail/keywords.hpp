...
namespace network_boost { namespace spirit { namespace repository { namespace qi { namespace detail {
    ...
    template < typename Elements, typename Iterator ,typename Context ,typename Skipper
        ...
        : public network_boost::static_visitor<bool>
        {
    ...
    template <typename Elements, typename StringKeywords, typename IndexList, typename FlagsType, typename Modifiers>
        struct string_keywords
        {
            ...
            typedef typename get_keyword_char_type<
                typename mpl::if_<
                  mpl::equal_to<
                    ...
                    , mpl::int_<0>
                    >
                  , mpl::vector< network_boost::spirit::standard::char_type >
                  , char_types >::type
                >::type  char_type;
            ...
            struct keyword_entry_adder
            {
                ...
                const String get_string(const network_boost::spirit::qi::literal_string<String,no_attribute> &parser) const
                {
                        return parser.str;
                }

        template <typename String, bool no_attribute>
                const typename network_boost::spirit::qi::no_case_literal_string<String,no_attribute>::string_type &
                        get_string(const network_boost::spirit::qi::no_case_literal_string<String,no_attribute> &parser) const
                {
