...
namespace network_boost { namespace spirit { namespace repository { namespace qi
{
    ...
    struct keywords : spirit::qi::nary_parser<keywords<Elements,Modifiers> >
    {
        ...
        // build_parser_tags
        //
        // Builds a network_boost::variant from an mpl::range_c in order to "mark" every
        ...
        typedef network_boost::array<bool, fusion::result_of::size<Elements>::value> flags_type;
        typedef network_boost::array<int, fusion::result_of::size<Elements>::value> counters_type;
