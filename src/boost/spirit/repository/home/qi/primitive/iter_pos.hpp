...
namespace network_boost { namespace spirit { namespace repository { namespace qi
{
    struct iter_pos_parser 
      : network_boost::spirit::qi::primitive_parser<iter_pos_parser>
    {
        ...
        {
            network_boost::spirit::qi::skip_over(first, last, skipper);
            network_boost::spirit::traits::assign_to(first, attr);
            return true;
        }
        ...
        network_boost::spirit::info what(Context&) const
        {
            return network_boost::spirit::info("iter_pos");
        }
    };
}}}}
