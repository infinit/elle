...
namespace network_boost { namespace spirit { namespace repository { namespace qi
{
...
namespace network_boost { namespace spirit { namespace qi
{
    ...
    struct make_directive_internal_2_args
    {
        ...
        result_type create_kwd_string(Terminal const &term, Subject const & subject, network_boost::mpl::true_ ) const
        {
        ...
        template <typename Terminal>
        result_type create_kwd_string(Terminal const &term, Subject const & subject, network_boost::mpl::false_ ) const
        {
           return result_type(subject
        ...
        template <typename Terminal>
        result_type create_kwd(Terminal const &term, Subject const & subject, Modifiers const& modifiers, network_boost::mpl::true_ ) const
        {
           return create_kwd_string(term,subject,no_case());
        }
        // Return a complex_kwd parser object
        template <typename Terminal>
        result_type create_kwd(Terminal const &term , Subject const & subject, Modifiers const& modifiers, network_boost::mpl::false_ ) const
        {
           return result_type(subject
