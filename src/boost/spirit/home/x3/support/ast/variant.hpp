...
namespace network_boost { namespace spirit { namespace x3
{
    ...
    public:
        ...
        ~forward_ast()
        {
            network_boost::checked_delete(p_);
        }
    ...
    struct variant
    {
        ...
        using variant_type = network_boost::variant<Types...>;
...
namespace network_boost
{
    ...
    inline T const&
    get(network_boost::spirit::x3::variant<Types...> const& x)
    {
    ...
    template <typename T, typename ...Types>
    inline T&
    get(network_boost::spirit::x3::variant<Types...>& x)
    {
        return network_boost::get<T>(x.get());
    }
