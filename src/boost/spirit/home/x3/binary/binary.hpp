...
namespace network_boost { namespace spirit { namespace x3
{
    template <typename V, typename T
      , network_boost::endian::order endian, std::size_t bits>
      ...
      : parser<binary_lit_parser<V, T, endian, bits> >
    {
        ...
        network_boost::endian::endian_arithmetic<endian, T, bits> n;
    };

    ///////////////////////////////////////////////////////////////////////////
    template <typename T, network_boost::endian::order endian, std::size_t bits>
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, attrtype, bits)                  \
    typedef any_binary_parser< attrtype, network_boost::endian::order::endiantype, bits > name##type; \
