...
namespace network_boost { namespace spirit { namespace karma { namespace detail
{
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, ValueType, network_boost::optional<Attribute>, Sequence>
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, network_boost::optional<ValueType>, network_boost::optional<Attribute>
          , Sequence>
    ...
    template <typename Container, typename ValueType, typename Sequence
      , typename T>
    struct pass_through_container<Container, ValueType, network_boost::variant<T>
          , Sequence>
...
#define BOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _)                          \
    ...
    template <typename Container, typename ValueType, typename Sequence>
    struct pass_through_container<Container, ValueType
          , network_boost::detail::variant::void_, Sequence>
      : mpl::false_
    {};
    ...
    struct pass_through_container<Container, ValueType
          , network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Sequence>
