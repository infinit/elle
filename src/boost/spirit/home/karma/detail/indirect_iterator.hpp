...
///////////////////////////////////////////////////////////////////////////////
namespace network_boost { namespace spirit { namespace karma { namespace detail
{
    ///////////////////////////////////////////////////////////////////////
    ...
    class indirect_iterator
      : public network_boost::iterator_facade<
          ...
          , typename network_boost::detail::iterator_traits<Iterator>::value_type
          , network_boost::forward_traversal_tag
          , typename network_boost::detail::iterator_traits<Iterator>::reference>
    {
        typedef typename network_boost::detail::iterator_traits<Iterator>::value_type
            base_value_type;
        typedef typename network_boost::detail::iterator_traits<Iterator>::reference
            base_reference_type;

        typedef network_boost::iterator_facade<
            indirect_iterator<Iterator>, base_value_type
          , network_boost::forward_traversal_tag, base_reference_type
        > base_type;
