...
namespace network_boost { namespace spirit { namespace karma
{
    ...
    // the same name
    namespace ascii { using namespace network_boost::spirit::ascii; }
    namespace iso8859_1 { using namespace network_boost::spirit::iso8859_1; }
    namespace standard { using namespace network_boost::spirit::standard; }
    namespace standard_wide { using namespace network_boost::spirit::standard_wide; }
#if defined(BOOST_SPIRIT_UNICODE)
    namespace unicode { using namespace network_boost::spirit::unicode; }
#endif
    ...
    using namespace network_boost::spirit::standard;
...
}}}  // namespace network_boost::spirit::karma
