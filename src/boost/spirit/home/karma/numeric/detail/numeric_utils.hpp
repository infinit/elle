...
#define BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsignedtype)                    \
    ...
    BOOST_SPIRIT_ABSOLUTE_VALUE(network_boost::long_long_type, network_boost::ulong_long_type);
    BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(network_boost::ulong_long_type);
#endif
...
#define BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX(z, x, data)                    \
    ...
    private:
        ...
        // a network_boost::long_long_type (if this does exist) or in a plain long
        // otherwise
#if defined(BOOST_HAS_LONG_LONG)
        typedef network_boost::long_long_type biggest_long_type;
#else
