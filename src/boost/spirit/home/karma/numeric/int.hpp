...
#ifdef BOOST_HAS_LONG_LONG
    template <>
    struct use_terminal<karma::domain, network_boost::long_long_type> // enables lit(0LL)
      : mpl::true_ {};
#endif
...
namespace network_boost { namespace spirit { namespace karma
{
    ...
    struct make_primitive<tag::long_long, Modifiers>
      : detail::make_int<network_boost::long_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_int_direct<network_boost::long_long_type, Modifiers> {};
#endif
...
#ifdef BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<network_boost::long_long_type, Modifiers>
      : detail::basic_int_literal<network_boost::long_long_type, Modifiers> {};
#endif
