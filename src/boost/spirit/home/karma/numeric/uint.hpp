...
namespace network_boost { namespace spirit
{
    ...
    struct use_terminal<karma::domain, network_boost::ulong_long_type>
      : mpl::true_ {};
#endif
...
namespace network_boost { namespace spirit { namespace karma
{
    ...
    struct make_primitive<tag::ulong_long, Modifiers>
      : detail::make_uint<network_boost::ulong_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_uint_direct<network_boost::ulong_long_type, Modifiers> {};
#endif
...
#ifdef BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<network_boost::ulong_long_type, Modifiers>
      : detail::basic_uint_literal<network_boost::ulong_long_type, Modifiers> {};
#endif
