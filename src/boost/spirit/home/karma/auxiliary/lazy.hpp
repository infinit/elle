...
namespace network_boost { namespace spirit
{
    ...
    struct use_terminal<karma::domain, network_boostphoenix::actor<Eval> >  // enables phoenix actors
        : mpl::true_ {};
...
namespace network_boost { namespace spirit { namespace karma
{
    ...
    struct lazy_generator : generator<lazy_generator<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                network_boost::result_of<karma_modify(tag::lazy_eval, Modifiers)>::type
            modifier;

            typedef typename
                remove_reference<
                    typename network_boost::result_of<Function(unused_type, Context)>::type
                >::type
            expr_type;
    ...
    struct make_primitive<network_boostphoenix::actor<Eval>, Modifiers>
    {
        typedef lazy_generator<network_boostphoenix::actor<Eval>, Modifiers> result_type;
        result_type operator()(network_boostphoenix::actor<Eval> const& f
