...
namespace network_boost { namespace spirit { namespace karma
{
    ...
    // optional
    template <typename T>
    struct meta_create<network_boost::optional<T> >
    {
        typedef make_unary_proto_expr<
    ...
    struct meta_create<network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        typedef make_nary_proto_expr<
            typename network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::types
    ...
    template <>
    struct meta_create<network_boost::long_long_type>
    {
        typedef spirit::long_long_type type;
        static type call() { return type(); }
    };
    template <>
    struct meta_create<network_boost::ulong_long_type>
    {
