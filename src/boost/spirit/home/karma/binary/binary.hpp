...
///////////////////////////////////////////////////////////////////////////////
namespace network_boost { namespace spirit { namespace karma
{
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    using network_boost::spirit::byte_;
    using network_boost::spirit::word;
    using network_boost::spirit::big_word;
    using network_boost::spirit::little_word;
    using network_boost::spirit::dword;
    using network_boost::spirit::big_dword;
    using network_boost::spirit::little_dword;
#ifdef BOOST_HAS_LONG_LONG
    using network_boost::spirit::qword;
    using network_boost::spirit::big_qword;
    using network_boost::spirit::little_qword;
#endif
    using network_boost::spirit::bin_float;
    using network_boost::spirit::big_bin_float;
    using network_boost::spirit::little_bin_float;
    using network_boost::spirit::bin_double;
    using network_boost::spirit::big_bin_double;
    using network_boost::spirit::little_bin_double;
#endif

    using network_boost::spirit::byte_type;
    using network_boost::spirit::word_type;
    using network_boost::spirit::big_word_type;
    using network_boost::spirit::little_word_type;
    using network_boost::spirit::dword_type;
    using network_boost::spirit::big_dword_type;
    using network_boost::spirit::little_dword_type;
#ifdef BOOST_HAS_LONG_LONG
    using network_boost::spirit::qword_type;
    using network_boost::spirit::big_qword_type;
    using network_boost::spirit::little_qword_type;
#endif
    using network_boost::spirit::bin_float_type;
    using network_boost::spirit::big_bin_float_type;
    using network_boost::spirit::little_bin_float_type;
    using network_boost::spirit::bin_double_type;
    using network_boost::spirit::big_bin_double_type;
    using network_boost::spirit::little_bin_double_type;
    ...
    namespace detail
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <BOOST_SCOPED_ENUM(network_boost::endian::endianness) bits>
        struct what;

        template <>
        struct what<network_boost::endian::endianness::native>
        {
            static info is()
            {
        ...
        template <>
        struct what<network_boost::endian::endianness::little>
        {
            static info is()
            {
        ...
        template <>
        struct what<network_boost::endian::endianness::big>
        {
            static info is()
            {
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, BOOST_SCOPED_ENUM(network_boost::endian::endianness) endian, int bits>
      ...
      : primitive_generator<any_binary_generator<T, endian, bits> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            network_boost::endian::endian<endian, typename T::type, bits> p;
...
#pragma warning(pop)
        ...
        typedef network_boost::endian::endian<endian, typename T::type,
            bits> data_type;
    ...
    namespace detail
    {
        template <typename T, BOOST_SCOPED_ENUM(network_boost::endian::endianness) endian
          , int bits>
        struct basic_binary
        {
        ...
        template <typename Modifiers, typename T
          , BOOST_SCOPED_ENUM(network_boost::endian::endianness) endian, int bits>
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)            \
    ...
    struct make_primitive<tag::name, Modifiers>                               \
      : detail::basic_binary<detail::integer<bits>,                           \
        network_boost::endian::endianness::endiantype, bits> {};                      \
                                                                              \
