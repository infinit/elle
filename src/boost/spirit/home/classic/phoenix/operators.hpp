...
template <> struct rank< ::network_boost::long_long_type>          { static int const value = 110; };
template <> struct rank< ::network_boost::ulong_long_type> { static int const value = 120; };
#endif
