...
struct member_var_ptr_action {
    ...
    struct result {
        typedef typename network_boost::mpl::if_<network_boost::is_const<CT>, T const&, T&
            >::type type;
    };
...
> {
    ...
    typedef typename network_boost::mpl::if_<network_boost::is_const<ClassT>, cmf, mf>::type
        mem_func_ptr_t;
