...
///////////////////////////////////////////////////////////////////////////////
namespace network_boostphoenix {
...
namespace impl
{
    ...
    private:
        network_boost::thread_specific_ptr<frame_ptr> tsp_frame;
...
#endif
} // namespace network_boostphoenix::impl
...
#ifdef PHOENIX_THREADSAFE
    static network_boost::thread_specific_ptr<holder_t*> &
    tsp_frame_instance()
    {
        static network_boost::thread_specific_ptr<holder_t*> the_instance;
        return the_instance;
    }
...
#endif
        network_boost::call_once(been_here, tsp_frame_instance_init);
        network_boost::thread_specific_ptr<holder_t*> &tsp_frame = tsp_frame_instance();
        if (!tsp_frame.get())
