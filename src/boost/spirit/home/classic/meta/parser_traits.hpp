...
struct is_parser
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::network_boost::is_base_and_derived<parser<T>, T>::value));

//  [JDG 2/3/03] simplified implementation by
//  using network_boost::is_base_and_derived
};
...
struct is_unary_composite {
    ...
    BOOST_STATIC_CONSTANT(bool, value = (::network_boost::is_convertible<
