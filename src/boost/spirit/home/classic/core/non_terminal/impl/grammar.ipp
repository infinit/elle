...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef network_boost::shared_ptr<helper_t> helper_ptr_t;
        typedef network_boost::weak_ptr<helper_t>   helper_weak_ptr_t;
...
#ifdef BOOST_SPIRIT_THREADSAFE
            network_boost::unique_lock<network_boost::mutex> lock(helpers.mutex());
#endif
...
# ifdef BOOST_SPIRIT_THREADSAFE
        network_boost::thread_specific_ptr<ptr_t> & tld_helper
            = static_<network_boost::thread_specific_ptr<ptr_t>,
