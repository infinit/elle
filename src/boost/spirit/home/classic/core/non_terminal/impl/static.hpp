...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    //      T::T() MUST not throw!
    //          this is a requirement of network_boost::call_once.
    //
    template <class T, class Tag>
    struct static_
        : network_boost::noncopyable
    {
    private:
    ...
    public:
        ...
        static_(Tag = Tag())
        {
            network_boost::call_once(&default_ctor::construct, constructed_);
        }
    ...
    private:
        typedef typename network_boost::add_pointer<value_type>::type pointer;
        ...
        typedef network_boost::aligned_storage<sizeof(value_type),
            network_boost::alignment_of<value_type>::value> storage_type;
