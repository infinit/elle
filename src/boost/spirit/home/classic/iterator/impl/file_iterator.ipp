...
private:
    network_boost::shared_ptr<std::FILE> m_file;
    std::size_t m_pos;
    CharT m_curChar;
    bool m_eof;
...
private:
    typedef network_boost::remove_pointer<HANDLE>::type handle_t;

    network_boost::shared_ptr<CharT> m_mem;
...
private:
    ...
    network_boost::shared_ptr<mapping> m_mem;
...
///////////////////////////////////////////////////////////////////////////////
} /* namespace network_boost::spirit::fileiter_impl */
