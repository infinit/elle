...
/* namespace network_boost::spirit { */ namespace iterator_ { namespace impl {

///////////////////////////////////////////////////////////////////////////////
//
//  position_iterator_base_generator
//
//  Metafunction to generate the iterator type using network_boost::iterator_adaptors,
...
{
private:
    typedef network_boost::detail::iterator_traits<ForwardIterT> traits;
    typedef typename traits::value_type value_type;
    typedef typename traits::iterator_category iter_category_t;

    // Position iterator is always a non-mutable iterator
    typedef typename network_boost::add_const<value_type>::type const_value_type;
...
public:
    ...
    typedef typename network_boost::mpl::if_<
        typename network_boost::is_same<MainIterT, nil_t>::type,
        position_iterator<ForwardIterT, PositionT, nil_t>,
        MainIterT
    >::type main_iter_t;

    typedef network_boost::iterator_adaptor<
        main_iter_t,
        ForwardIterT,
        const_value_type,
...
}} /* namespace network_boost::spirit::iterator_::impl */
