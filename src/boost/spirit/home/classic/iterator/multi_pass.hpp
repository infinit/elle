...
class buf_id_check
{
    protected:
        ...
        void check_if_valid() const
        {
            ...
            {
                network_boost::throw_exception(illegal_backtracking());
            }
        }
...
class inner
{
    private:
        typedef
            typename network_boost::detail::iterator_traits<InputT>::value_type
            result_type;
    ...
    public:
        typedef
            typename network_boost::detail::iterator_traits<InputT>::difference_type
            difference_type;
        typedef
            typename network_boost::detail::iterator_traits<InputT>::pointer
            pointer;
        typedef
            typename network_boost::detail::iterator_traits<InputT>::reference
            reference;
...
// We are using network_boost::iterator<> because it offers an automatic workaround
...
struct iterator_base_creator
{
    ...
    typedef network_boost::iterator
    <
