...
//  of network_boost::iterator_adaptor, that is inhering an object created with it.
...
//  with network_boost::iterator_adaptor only 5 functions are needed to implement
...
namespace fileiter_impl {
    ...
    //  file_iter_generator
    //
    //  Template meta-function to invoke network_boost::iterator_adaptor
...
public:
    ...
    // operator bool. This borrows a trick from network_boost::shared_ptr to avoid
