...
struct tree_node
{
    ...
    typedef network_boost::pool_allocator<tree_node<T> > allocator_type;
#else
    typedef network_boost::fast_pool_allocator<tree_node<T> > allocator_type;
#endif
...
{
    typedef
        typename network_boost::detail::iterator_traits<IteratorT>::value_type
        value_type;

#if !defined(BOOST_SPIRIT_USE_BOOST_ALLOCATOR_FOR_TREES)
    typedef std::allocator<value_type> allocator_type;
#elif !defined(BOOST_SPIRIT_USE_LIST_FOR_TREES)
    typedef network_boost::pool_allocator<value_type> allocator_type;
#else
    typedef network_boost::fast_pool_allocator<value_type> allocator_type;
#endif
...
public:
    ...
    typedef T attr_t;
    typedef typename network_boost::call_traits<T>::param_type      param_type;
    typedef typename network_boost::call_traits<T>::reference       reference;
    typedef typename network_boost::call_traits<T>::const_reference const_reference;
