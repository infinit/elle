...
public:
    ...
    {
        network_boost::match_results<typename ScannerT::iterator_t> what;
        network_boost::regex_search(scan.first, scan.last, what, rxstr,
            network_boost::match_default);
...
private:
    ...
    network_boost::basic_regex<CharT> rxstr;       // regular expression to match
#else
    network_boost::reg_expression<CharT> rxstr;    // regular expression to match
#endif
};
