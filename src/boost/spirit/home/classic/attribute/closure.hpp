...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    public:
        ...
        typedef typename ::network_boostphoenix::tuple_element<0,
        ...
        { hit.value(frame[::network_boostphoenix::tuple_index<0>()]); return hit; }

    private:

        ::network_boostphoenix::closure_frame<typename ClosureT::phoenix_closure_t> frame;
    };
    ...
    //      contains network_boostphoenix::actor objects. These actors have to be
    //      dereferenced to gain the values to be used for initialization
    //      (this is done by the help of the network_boostphoenix::convert_actors<>
    //      template).
    //
    ///////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        : frame(clos.subject(), ::network_boostphoenix::convert_actors<tuple_t>(clos.init)) {}
    ...
    private:
        ...
        ::network_boostphoenix::closure_frame<closure_t> frame;
    };
    ...
    : public unary<ParserT, parser<init_closure_parser<ParserT, ActorTupleT> > >
    {
        ...
        typedef typename ::network_boostphoenix::tuple_element<0, tuple_t>::type   attr_t;
    ...
    >
    struct closure :
        public ::network_boostphoenix::closure<
            T0, T1, T2
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 3
        ,   T3, T4, T5
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 6
        ...
        >
    {
        typedef ::network_boostphoenix::closure<
                T0, T1, T2
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 3
            ,   T3, T4, T5
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 6
        ...
        // initialization functions
            ...
            init_closure_parser<
                DerivedT2,
                ::network_boostphoenix::tuple<
                    typename ::network_boostphoenix::as_actor<A>::type
                >
            >
            operator()(A const &a) const
            {
                typedef typename ::network_boostphoenix::as_actor<A>::type a_t;
                typedef ::network_boostphoenix::tuple<a_t> actor_tuple_t;

                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        aux_derived(),
                        actor_tuple_t(
                            ::network_boostphoenix::as_actor<A>::convert(a)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    typename ::network_boostphoenix::as_actor<A>::type,
                    typename ::network_boostphoenix::as_actor<B>::type
                >
            >
            operator()(A const &a, B const &b) const
            {
                typedef typename ::network_boostphoenix::as_actor<A>::type a_t;
                typedef typename ::network_boostphoenix::as_actor<B>::type b_t;
                typedef ::network_boostphoenix::tuple<a_t, b_t> actor_tuple_t;

                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        aux_derived(),
                        actor_tuple_t(
                            ::network_boostphoenix::as_actor<A>::convert(a),
                            ::network_boostphoenix::as_actor<B>::convert(b)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    typename ::network_boostphoenix::as_actor<A>::type,
                    typename ::network_boostphoenix::as_actor<B>::type,
                    typename ::network_boostphoenix::as_actor<C>::type
                >
            >
            operator()(A const &a, B const &b, C const &c) const
            {
                typedef typename ::network_boostphoenix::as_actor<A>::type a_t;
                typedef typename ::network_boostphoenix::as_actor<B>::type b_t;
                typedef typename ::network_boostphoenix::as_actor<C>::type c_t;
                typedef ::network_boostphoenix::tuple<a_t, b_t, c_t> actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ::network_boostphoenix::as_actor<A>::convert(a),
                            ::network_boostphoenix::as_actor<B>::convert(b),
                            ::network_boostphoenix::as_actor<C>::convert(c)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<B>::type,
                    typename ::network_boostphoenix::as_actor<C>::type,
                    typename ::network_boostphoenix::as_actor<D>::type
                >
            >
            operator()(
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<B>::type b_t;
                typedef typename ::network_boostphoenix::as_actor<C>::type c_t;
                typedef typename ::network_boostphoenix::as_actor<D>::type d_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<B>::convert(b),
                            ::network_boostphoenix::as_actor<C>::convert(c),
                            ::network_boostphoenix::as_actor<D>::convert(d)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<C>::type,
                    typename ::network_boostphoenix::as_actor<D>::type,
                    typename ::network_boostphoenix::as_actor<E>::type
                >
            >
            operator()(
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<C>::type c_t;
                typedef typename ::network_boostphoenix::as_actor<D>::type d_t;
                typedef typename ::network_boostphoenix::as_actor<E>::type e_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<C>::convert(c),
                            ::network_boostphoenix::as_actor<D>::convert(d),
                            ::network_boostphoenix::as_actor<E>::convert(e)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<D>::type,
                    typename ::network_boostphoenix::as_actor<E>::type,
                    typename ::network_boostphoenix::as_actor<F>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<D>::type d_t;
                typedef typename ::network_boostphoenix::as_actor<E>::type e_t;
                typedef typename ::network_boostphoenix::as_actor<F>::type f_t;
                typedef ::network_boostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<D>::convert(d),
                            ::network_boostphoenix::as_actor<E>::convert(e),
                            ::network_boostphoenix::as_actor<F>::convert(f)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<E>::type,
                    typename ::network_boostphoenix::as_actor<F>::type,
                    typename ::network_boostphoenix::as_actor<G>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<E>::type e_t;
                typedef typename ::network_boostphoenix::as_actor<F>::type f_t;
                typedef typename ::network_boostphoenix::as_actor<G>::type g_t;
                typedef ::network_boostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<E>::convert(e),
                            ::network_boostphoenix::as_actor<F>::convert(f),
                            ::network_boostphoenix::as_actor<G>::convert(g)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<F>::type,
                    typename ::network_boostphoenix::as_actor<G>::type,
                    typename ::network_boostphoenix::as_actor<H>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<F>::type f_t;
                typedef typename ::network_boostphoenix::as_actor<G>::type g_t;
                typedef typename ::network_boostphoenix::as_actor<H>::type h_t;
                typedef ::network_boostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<F>::convert(f),
                            ::network_boostphoenix::as_actor<G>::convert(g),
                            ::network_boostphoenix::as_actor<H>::convert(h)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<G>::type,
                    typename ::network_boostphoenix::as_actor<H>::type,
                    typename ::network_boostphoenix::as_actor<I>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<G>::type g_t;
                typedef typename ::network_boostphoenix::as_actor<H>::type h_t;
                typedef typename ::network_boostphoenix::as_actor<I>::type i_t;
                typedef ::network_boostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<G>::convert(g),
                            ::network_boostphoenix::as_actor<H>::convert(h),
                            ::network_boostphoenix::as_actor<I>::convert(i)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<H>::type,
                    typename ::network_boostphoenix::as_actor<I>::type,
                    typename ::network_boostphoenix::as_actor<J>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<H>::type h_t;
                typedef typename ::network_boostphoenix::as_actor<I>::type i_t;
                typedef typename ::network_boostphoenix::as_actor<J>::type j_t;
                typedef ::network_boostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<H>::convert(h),
                            ::network_boostphoenix::as_actor<I>::convert(i),
                            ::network_boostphoenix::as_actor<J>::convert(j)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<I>::type,
                    typename ::network_boostphoenix::as_actor<J>::type,
                    typename ::network_boostphoenix::as_actor<K>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<I>::type i_t;
                typedef typename ::network_boostphoenix::as_actor<J>::type j_t;
                typedef typename ::network_boostphoenix::as_actor<K>::type k_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<I>::convert(i),
                            ::network_boostphoenix::as_actor<J>::convert(j),
                            ::network_boostphoenix::as_actor<K>::convert(k)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<J>::type,
                    typename ::network_boostphoenix::as_actor<K>::type,
                    typename ::network_boostphoenix::as_actor<L>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<J>::type j_t;
                typedef typename ::network_boostphoenix::as_actor<K>::type k_t;
                typedef typename ::network_boostphoenix::as_actor<L>::type l_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<J>::convert(j),
                            ::network_boostphoenix::as_actor<K>::convert(k),
                            ::network_boostphoenix::as_actor<L>::convert(l)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<K>::type,
                    typename ::network_boostphoenix::as_actor<L>::type,
                    typename ::network_boostphoenix::as_actor<M>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<K>::type k_t;
                typedef typename ::network_boostphoenix::as_actor<L>::type l_t;
                typedef typename ::network_boostphoenix::as_actor<M>::type m_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t, m_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<K>::convert(k),
                            ::network_boostphoenix::as_actor<L>::convert(l),
                            ::network_boostphoenix::as_actor<M>::convert(m)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<L>::type,
                    typename ::network_boostphoenix::as_actor<M>::type,
                    typename ::network_boostphoenix::as_actor<N>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<L>::type l_t;
                typedef typename ::network_boostphoenix::as_actor<M>::type m_t;
                typedef typename ::network_boostphoenix::as_actor<N>::type n_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t, m_t, n_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<L>::convert(l),
                            ::network_boostphoenix::as_actor<M>::convert(m),
                            ::network_boostphoenix::as_actor<N>::convert(n)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::network_boostphoenix::tuple<
                    ...
                    typename ::network_boostphoenix::as_actor<M>::type,
                    typename ::network_boostphoenix::as_actor<N>::type,
                    typename ::network_boostphoenix::as_actor<O>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::network_boostphoenix::as_actor<M>::type m_t;
                typedef typename ::network_boostphoenix::as_actor<N>::type n_t;
                typedef typename ::network_boostphoenix::as_actor<O>::type o_t;
                typedef ::network_boostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t, m_t, n_t, o_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::network_boostphoenix::as_actor<M>::convert(m),
                            ::network_boostphoenix::as_actor<N>::convert(n),
                            ::network_boostphoenix::as_actor<O>::convert(o)
                        )
                    );
            }
    ...
    struct container_begin
    {
        ...
        struct result
        {
            typedef typename ::network_boostphoenix::actor_result<ActorT, TupleT>
        ...
        template <typename TupleT>
        typename ::network_boostphoenix::actor_result<self_t, TupleT>::type
    ...
    inline f_chseq<
        ::network_boostphoenix::actor<container_begin< ::network_boostphoenix::actor<BaseT> > >,
        ::network_boostphoenix::actor<container_end< ::network_boostphoenix::actor<BaseT> > >
    >
    f_chseq_p(::network_boostphoenix::actor<BaseT> const& a)
    {
        typedef ::network_boostphoenix::actor<container_begin< ::network_boostphoenix::actor<BaseT> > >
            container_begin_t;
        typedef ::network_boostphoenix::actor<container_end< ::network_boostphoenix::actor<BaseT> > >
            container_end_t;
    ...
    inline f_strlit<
        ...
        ::network_boostphoenix::actor<container_end< ::network_boostphoenix::actor<BaseT> > >
    >
    f_str_p(::network_boostphoenix::actor<BaseT> const& a)
    {
        typedef ::network_boostphoenix::actor<container_begin< ::network_boostphoenix::actor<BaseT> > >
            container_begin_t;
        typedef ::network_boostphoenix::actor<container_end< ::network_boostphoenix::actor<BaseT> > >
