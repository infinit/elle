...
#define BOOST_SPIRIT_DEFINE_CHAR_CODES(charset)                                 \
    namespace network_boost { namespace spirit { namespace tag { namespace charset      \
    {                                                                           \
        BOOST_SPIRIT_TAG_CHAR_SPEC(spirit::char_encoding::charset)              \
    }}}}                                                                        \
    namespace network_boost { namespace spirit { namespace charset                      \
    {                                                                           \
...
BOOST_SPIRIT_DEFINE_CHAR_CODES(unicode)
    ...
    namespace network_boost { namespace spirit { namespace tag { namespace unicode
    {
        BOOST_SPIRIT_TAG_CHAR_SPEC(spirit::char_encoding::unicode)
    }}}}

    namespace network_boost { namespace spirit { namespace unicode
    {
