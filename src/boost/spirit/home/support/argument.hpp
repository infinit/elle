...
#define SPIRIT_DECLARE_ARG(z, n, data)                                        \
    typedef network_boostphoenix::actor<argument<n> >                                      \
        BOOST_PP_CAT(BOOST_PP_CAT(_, BOOST_PP_INC(n)), _type);                \
    network_boostphoenix::actor<argument<n> > const                                        \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , network_boost::spirit::argument<N>
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <typename Dummy>
  , network_boost::spirit::attribute_context<Dummy>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            network_boost::spirit::attribute_context<Dummy>()
...
namespace network_boost { namespace spirit
{
    ...
    typedef network_boostphoenix::actor<attribute_context<void> > _0_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    ...
    typedef network_boostphoenix::actor<argument<0> > _1_type;
    typedef network_boostphoenix::actor<argument<1> > _2_type;
    typedef network_boostphoenix::actor<argument<2> > _3_type;
