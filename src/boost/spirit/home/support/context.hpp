...
#define SPIRIT_DECLARE_ATTRIBUTE(z, n, data)                                   \
    typedef network_boostphoenix::actor<attribute<n> >                                      \
        BOOST_PP_CAT(BOOST_PP_CAT(_r, n), _type);                              \
    network_boostphoenix::actor<attribute<n> > const                                        \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , network_boost::spirit::attribute<N>
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , network_boost::spirit::local_variable<N>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            network_boost::spirit::local_variable<N>()
...
namespace network_boost { namespace spirit
{
    ...
    typedef network_boostphoenix::actor<attribute<0> > _val_type;
    typedef network_boostphoenix::actor<attribute<0> > _r0_type;
    typedef network_boostphoenix::actor<attribute<1> > _r1_type;
    typedef network_boostphoenix::actor<attribute<2> > _r2_type;
    ...
    typedef network_boostphoenix::actor<local_variable<0> > _a_type;
    typedef network_boostphoenix::actor<local_variable<1> > _b_type;
    typedef network_boostphoenix::actor<local_variable<2> > _c_type;
    typedef network_boostphoenix::actor<local_variable<3> > _d_type;
    typedef network_boostphoenix::actor<local_variable<4> > _e_type;
    typedef network_boostphoenix::actor<local_variable<5> > _f_type;
    typedef network_boostphoenix::actor<local_variable<6> > _g_type;
    typedef network_boostphoenix::actor<local_variable<7> > _h_type;
    typedef network_boostphoenix::actor<local_variable<8> > _i_type;
    typedef network_boostphoenix::actor<local_variable<9> > _j_type;
