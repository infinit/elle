...
namespace network_boost { namespace spirit
{
    ...
    struct make_lazy<F, A0>
    {
        typedef typename
            proto::terminal<
                lazy_terminal<
                  ...
                  , typename network_boostphoenix::detail::expression::function_eval<F, A0>::type
                  , 1 // arity
                >
            >::type
        result_type;
        ...
        operator()(F f, A0 const& _0_) const
        {
            ...
            return result_type::make(child_type(
                network_boostphoenix::detail::expression::function_eval<F, A0>::make(f, _0_)
              , f.proto_base().child0
            ));
        }
    };
    ...
    struct make_lazy<F, A0, A1>
    {
        typedef typename
            proto::terminal<
               lazy_terminal<
                    typename F::terminal_type
                  , typename network_boostphoenix::detail::expression::function_eval<F, A0, A1>::type
                  , 2 // arity
                >
            >::type
        result_type;
        ...
        operator()(F f, A0 const& _0_, A1 const& _1_) const
        {
            typedef typename result_type::proto_child0 child_type;
            return result_type::make(child_type(
                network_boostphoenix::detail::expression::function_eval<F, A0, A1>::make(f, _0_, _1_)
              , f.proto_base().child0
            ));
        }
    };
    ...
    struct make_lazy<F, A0, A1, A2>
    {
        typedef typename
            proto::terminal<
               lazy_terminal<
                    typename F::terminal_type
                  , typename network_boostphoenix::detail::expression::function_eval<F, A0, A1, A2>::type
                  , 3 // arity
                >
            >::type
        result_type;
        ...
        operator()(F f, A0 const& _0_, A1 const& _1_, A2 const& _2_) const
        {
            typedef typename result_type::proto_child0 child_type;
            return result_type::make(child_type(
                network_boostphoenix::detail::expression::function_eval<F, A0, A1, A2>::make(f, _0_, _1_, _2_)
              , f.proto_base().child0
            ));
        }
    };
    ...
    namespace detail
    {
        ...
        struct contains_actor
            : bool_<
                  network_boostphoenix::is_actor<A0>::value
               || network_boostphoenix::is_actor<A1>::value
               || network_boostphoenix::is_actor<A2>::value
              >
        {};
        ...
        template <typename A>
        struct to_lazy_arg
          : network_boostphoenix::as_actor<A> // wrap A in a Phoenix actor if not already one
        {};
        ...
        >
    {
          ...
          , typename detail::contains_actor<A0>::is_true = 0) const
        {
            return make_lazy<this_type
              , typename network_boostphoenix::as_actor<A0>::type>()(*this
              , network_boostphoenix::as_actor<A0>::convert(_0_));
        }
        ...
        {
            return make_lazy<this_type
              , typename network_boostphoenix::as_actor<A0>::type
              , typename network_boostphoenix::as_actor<A1>::type>()(*this
              , network_boostphoenix::as_actor<A0>::convert(_0_)
              , network_boostphoenix::as_actor<A1>::convert(_1_));
        }
          ...
          , typename detail::contains_actor<A0, A1, A2>::is_true = 0) const
        {
            return make_lazy<this_type
              , typename network_boostphoenix::as_actor<A0>::type
              , typename network_boostphoenix::as_actor<A1>::type
              , typename network_boostphoenix::as_actor<A2>::type>()(*this
              , network_boostphoenix::as_actor<A0>::convert(_0_)
              , network_boostphoenix::as_actor<A1>::convert(_1_)
              , network_boostphoenix::as_actor<A2>::convert(_2_));
        }
...
// Common placeholders are placed in the main network_boost::spirit namespace
...
#define BOOST_SPIRIT_TERMINAL_NAME(name, type_name)                             \
    ...
    typedef network_boost::proto::terminal<tag::name>::type type_name;                  \
...
#define BOOST_SPIRIT_TERMINAL_NAME_EX(name, type_name)                          \
    namespace tag { struct name { BOOST_SPIRIT_IS_TAG() }; }                    \
    typedef network_boost::spirit::terminal<tag::name> type_name;                       \
