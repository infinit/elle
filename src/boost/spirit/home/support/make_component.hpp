...
namespace network_boost { namespace spirit { namespace detail
{
    ...
    template <typename Expr, typename State, typename Data, typename Domain>
    struct make_terminal_impl<network_boostphoenix::actor<Expr>, State, Data, Domain>
      : proto::transform_impl<network_boostphoenix::actor<Expr>, State, Data>
    {
        typedef network_boostphoenix::actor<Expr> value;
        typedef typename result_of::make_cons<value>::type elements;
    ...
    template <typename Expr, typename State, typename Data, typename Domain>
    struct make_terminal_impl<network_boostphoenix::actor<Expr> &, State, Data, Domain>
        : make_terminal_impl<network_boostphoenix::actor<Expr>, State, Data, Domain>
    {};

    template <typename Expr, typename State, typename Data, typename Domain>
    struct make_terminal_impl<network_boostphoenix::actor<Expr> const &, State, Data, Domain>
        : make_terminal_impl<network_boostphoenix::actor<Expr>, State, Data, Domain>
    {};
            ...
            ) const
            {
                return
                    (*this)(
                      ...
                      , state
                      , data
                      , typename network_boostphoenix::is_actor<
                            typename proto::result_of::child_c<Expr, 1>::type
                        >::type()
                    );
            }
