...
{
    typedef typename network_boost::lexer::basic_string_token<CharT> string_token;
    ...
    typename network_boost::lexer::basic_state_machine<CharT>::iterator iter_ =
        state_machine_.begin();
    typename network_boost::lexer::basic_state_machine<CharT>::iterator end_ =
        state_machine_.end();
    ...
    os_ << "// Auto-generated by network_boost::lexer\n";
    ...
    for (std::size_t dfa_ = 0; dfa_ < dfas_; ++dfa_)
    {
        ...
        for (std::size_t state_ = 0; state_ < states_; ++state_)
        {
            ...
            if (t_ < transitions_ || iter_->bol_index != network_boost::lexer::npos ||
