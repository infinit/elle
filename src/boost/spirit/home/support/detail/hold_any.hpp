/*=============================================================================
    ...
    The class network_boost::spirit::hold_any is built based on the any class
...
namespace network_boost { namespace spirit
{
    struct bad_any_cast
      : std::bad_cast
    {
        bad_any_cast(network_boost::detail::sp_typeinfo const& src, network_boost::detail::sp_typeinfo const& dest)
    ...
    namespace detail
    {
        ...
        {
            network_boost::detail::sp_typeinfo const& (*get_type)();
        ...
        struct fxns<mpl::true_>
        {
            ...
            struct type
            {
                static network_boost::detail::sp_typeinfo const& get_type()
                {
    ...
    public:
        ...
        network_boost::detail::sp_typeinfo const& type() const
        {
...
// implicit casting is disabled by default for compatibility with network_boost::any
    ...
    // network_boost::any-like casting
    template <typename T, typename Char>
    ...
    T any_cast(basic_hold_any<Char>& operand)
    {
        ...
        if(!result)
            network_boost::throw_exception(bad_any_cast(operand.type(), BOOST_SP_TYPEID(T)));
        return *result;
    }
...
}}    // namespace network_boost::spirit
