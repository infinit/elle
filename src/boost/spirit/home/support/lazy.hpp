...
namespace network_boost { namespace spirit
{
    ...
    typename proto::terminal<network_boostphoenix::actor<Eval> >::type
    lazy(network_boostphoenix::actor<Eval> const& f)
    {
        return proto::terminal<network_boostphoenix::actor<Eval> >::type::make(f);
    }
