...
namespace network_boost { namespace spirit
{
    ...
    */
    struct utree_type
    {
        ...
        typedef network_boost::uint_t<sizeof(info)*8>::exact exact_integral_type; 
        typedef network_boost::uint_t<sizeof(info)*8>::fast fast_integral_type; 
    };
    //]
    ...
    {
        network_boost::io::ios_all_saver saver(out);
        switch (t) {
    ...
    */
    typedef basic_string<
        network_boost::iterator_range<char const*>, utree_type::binary_type
    > binary_range_type;
    typedef basic_string<
    ...
    */
    typedef basic_string<
        network_boost::iterator_range<char const*>, utree_type::string_type
    ...
    */
    typedef basic_string<
        network_boost::iterator_range<char const*>, utree_type::symbol_type
    ...
    public:
        ...
        typename network_boost::disable_if<
            network_boost::is_polymorphic<
                typename network_boost::remove_pointer<Ptr>::type>,
            Ptr>::type
        get() const
        {
            if (*i == typeid(Ptr))
            ...
            network_boost::throw_exception(std::bad_cast());
        }
    ...
    public:
        ...
        typedef detail::list::node_iterator<network_boost::reference_wrapper<utree> >
          ref_iterator;

        typedef network_boost::iterator_range<iterator> range;
        typedef network_boost::iterator_range<const_iterator> const_range;
        ...
        */
        ...
        // where a network_boost::optional is expected (i.e. as an attribute for the 
        ...
        utree(network_boost::reference_wrapper<utree>);
        reference operator=(network_boost::reference_wrapper<utree>);
        ...
        utree(network_boost::iterator_range<Iterator>);
        template <class Iterator>
        reference operator=(network_boost::iterator_range<Iterator>);
