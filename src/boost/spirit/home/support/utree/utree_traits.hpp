...
{
    template <typename T>
    inline T get(network_boost::spirit::utree const& x)
    {
        return x.get<T>();
    }
}
...
namespace network_boost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        struct attribute_as_string_type
        {
            ...
            {
                return network_boost::get<utf8_string_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_symbol_type
        {
            ...
            static type call(utree const& attr)
            {
                return network_boost::get<utf8_symbol_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_binary_string_type
        {
            ...
            static type call(utree const& attr)
            {
                return network_boost::get<binary_range_type>(attr);
            }
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_list_container<network_boost::optional<Attribute> >
          : mpl::true_
        {};

        template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
        struct handles_utree_list_container<
                network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
          : mpl::true_
        {};
    }
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_container<network_boost::optional<Attribute> >
          : mpl::true_
        {};
    ...
    struct symbols_lookup<utree, utf8_symbol_type>
    {
        ...
        {
            utf8_symbol_range_type r = network_boost::get<utf8_symbol_range_type>(t);
    ...
    namespace detail
    {
        ...
        {
            if (detail::is_list(t))
                return network_boost::get<T>(t.front());
            return network_boost::get<T>(t);
        }
    }
        ...
        iterator_range<Iterator> const, utree, karma::domain>
    {
        ...
        static type pre(iterator_range<Iterator> const& t)
        {
            ...
            Iterator it = network_boost::begin(t);
            utree result(network_boost::ref(*it));
            ++it;
            return result;
        }
    };
