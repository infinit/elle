...
namespace network_boost { namespace spirit { namespace detail
{
    ...
    struct list::node : network_boost::noncopyable
    {
        template <typename T>
    ...
    private:
        ...
        friend class network_boost::spirit::utree;
        friend struct network_boost::spirit::detail::list;
    ...
    template <typename Value>
    class list::node_iterator<network_boost::reference_wrapper<Value> >
      : public network_boost::iterator_facade<
            node_iterator<network_boost::reference_wrapper<Value> >
          , network_boost::reference_wrapper<Value>
          , network_boost::bidirectional_traversal_tag>
    {
    public:
    ...
    private:
        ...
        void increment()
        {
            if (node != 0) // not at end
            {
                prev = node;
                node = node->next;
                curr = network_boost::ref(node ? node->val : nil_node);
            }
        }
        ...
        mutable network_boost::reference_wrapper<Value> curr;
    };

    template <typename Value>
    Value list::node_iterator<network_boost::reference_wrapper<Value> >::nil_node = Value();
    ...
    struct visit_impl
    {
        ...
        {
            typedef typename
                network_boost::mpl::if_<network_boost::is_const<UTreeX>,
                typename UTreeX::const_iterator,
                typename UTreeX::iterator>::type
            iterator;

            typedef network_boost::iterator_range<iterator> list_range;
...
namespace network_boost { namespace spirit
{
    ...
    inline utree::utree(network_boost::reference_wrapper<utree> ref)
    {
        s.initialize();
        p = ref.get_pointer();
    ...
    inline utree::utree(network_boost::iterator_range<Iter> r)
    {
        s.initialize();
    ...
    inline utree& utree::operator=(network_boost::reference_wrapper<utree> ref)
    {
        free();
        p = ref.get_pointer();
        set_type(type::reference_type);
    ...
    template <typename Iter>
    inline utree& utree::operator=(network_boost::iterator_range<Iter> r)
    {
        free();
        assign(r.begin(), r.end());
        return *this;
    ...
    template <typename F>
    typename network_boost::result_of<F(utree const&)>::type
    ...
    template <typename F>
    typename network_boost::result_of<F(utree&)>::type
    ...
    template <typename F>
    typename network_boost::result_of<F(utree const&, utree const&)>::type
    ...
    template <typename F>
    typename network_boost::result_of<F(utree const&, utree&)>::type
    ...
    template <typename F>
    typename network_boost::result_of<F(utree&, utree const&)>::type
    ...
    template <typename F>
    typename network_boost::result_of<F(utree&, utree&)>::type
    ...
    template <typename Iterator>
    struct is_iterator_range<network_boost::iterator_range<Iterator> >
    ...
    struct utree_cast
    {
        ...
        To dispatch(From const& val, network_boost::mpl::true_) const
        {
            return To(val); // From is convertible to To
        }

        template <typename From>
        To dispatch(From const&, network_boost::mpl::false_) const
        {
        ...
        {
            // network_boost::iterator_range has a templated constructor, accepting
            // any argument and hence any type is 'convertible' to it.
            typedef typename network_boost::mpl::eval_if<
                is_iterator_range<To>
              , network_boost::is_same<From, To>, network_boost::is_convertible<From, To>
            >::type is_convertible;
