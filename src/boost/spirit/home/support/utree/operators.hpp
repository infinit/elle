...
namespace network_boost { namespace spirit 
{
    ...
    struct utree_is_equal
    {
        ...
        bool dispatch(const A&, const B&, network_boost::mpl::false_) const
        {
            return false; // cannot compare different types by default
        }

        template <typename A, typename B>
        bool dispatch(const A& a, const B& b, network_boost::mpl::true_) const
        {
        ...
        bool operator()(const A& a, const B& b) const
        {
            return dispatch(a, b,
                network_boost::mpl::and_<
                    network_boost::is_arithmetic<A>,
                    network_boost::is_arithmetic<B> >());
        }
    ...
    struct utree_print
    {
        ...
        void operator()(network_boost::iterator_range<Iterator> const& range) const
        {
            typedef typename network_boost::iterator_range<Iterator>::const_iterator iterator;
            (*this)('(');
            for (iterator i = range.begin(); i != range.end(); ++i)
            {
                network_boost::spirit::utree::visit(*i, *this);
            }
            (*this)(')');
        }
    ...
    struct logical_function
    {
        ...
        {
            return dispatch(a, network_boost::is_arithmetic<A>());
        }
    ...
    struct arithmetic_function
    {
        ...
        template <typename A, typename B>
        utree dispatch(A const&, B const&, network_boost::mpl::false_) const
        {
            return utree(); // cannot apply to non-arithmetic types
        }

        template <typename A, typename B>
        utree dispatch(A const& a, B const& b, network_boost::mpl::true_) const
        {
            return Base::eval(a, b); // for arithmetic types
        }
        ...
        template <typename A>
        utree dispatch(A const&, network_boost::mpl::false_) const
        {
            return utree(); // cannot apply to non-arithmetic types
        }

        template <typename A>
        utree dispatch(A const& a, network_boost::mpl::true_) const
        {
    ...
    struct integral_function
    {
        ...
        utree operator()(A const& a, B const& b) const
        {
            return dispatch(a, b,
                network_boost::mpl::and_<
                    network_boost::is_integral<A>,
                    network_boost::is_integral<B> >());
        }
        ...
        utree operator()(A const& a) const
        {
            return dispatch(a, network_boost::is_integral<A>());
        }
    };
