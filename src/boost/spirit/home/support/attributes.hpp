...
//        {};
    ...
    template <typename T, typename Expected>
    struct is_weak_substitute<network_boost::variant<T>, Expected>
      : is_weak_substitute<T, Expected>
    {};

    template <typename T0, typename T1, typename ...TN, typename Expected>
    struct is_weak_substitute<network_boost::variant<T0, T1, TN...>,
            Expected>
      : mpl::bool_<is_weak_substitute<T0, Expected>::type::value &&
            is_weak_substitute<network_boost::variant<T1, TN...>, Expected>::type::value>
    {};
#else
#define BOOST_SPIRIT_IS_WEAK_SUBSTITUTE(z, N, _)                              \
    ...
    struct is_weak_substitute<network_boost::detail::variant::void_, Expected>
      : mpl::true_
    {};

    template <BOOST_VARIANT_ENUM_PARAMS(typename T), typename Expected>
    struct is_weak_substitute<
            network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Expected>
...
#undef BOOST_SPIRIT_IS_WEAK_SUBSTITUTE
    ...
    struct not_is_variant<network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Domain>
      : mpl::false_
    {};

    template <typename T, typename Domain>
    struct not_is_variant<network_boost::optional<T>, Domain>
    ...
    template <typename T>
    struct variant_type<network_boost::optional<T> >
      : variant_type<T>
    {};
    ...
    namespace detail
    {
        ...
        template <typename Expected, typename Attribute>
        struct attribute_is_compatible<Expected, network_boost::optional<Attribute> >
          : is_convertible<Attribute, Expected>
        {};
    ...
    struct variant_which<network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static int call(network_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& v)
        {
            return v.which();
        }
    };
    ...
    template <typename T, typename Domain>
    struct not_is_optional<network_boost::optional<T>, Domain>
      : mpl::false_
    {};
    ...
    {
        typedef typename network_boost::detail::iterator_traits<Iterator>::
            difference_type type;

        static type call(iterator_range<Iterator> const& r)
        {
            return network_boost::detail::distance(r.begin(), r.end());
        }
    };
    ...
    // build_optional
    //
    // Build a network_boost::optional from T. Return unused_type if T is unused_type.
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    struct build_optional
    {
        typedef network_boost::optional<T> type;
    };

    template <typename T>
    struct build_optional<network_boost::optional<T> >
    {
        typedef network_boost::optional<T> type;
    };
    ...
    namespace detail
    {
        ...
        {
            typedef network_boost::optional<
    ...
    // build_variant
    //
    // Build a network_boost::variant from a fusion sequence. build_variant makes sure
    ...
    struct make_attribute
    {
        ...
        static Attribute call(unused_type)
        {
            ...
            return network_boost::get(value_initialized<attribute_type>());
        }
    ...
    // optionals
    template <typename T>
    struct clear_value<network_boost::optional<T> >
    {
        static void call(network_boost::optional<T>& val)
        {
            if (val)
    ...
    struct print_attribute_debug<Out, network_boost::optional<T> >
    {
        static void call(Out& out, network_boost::optional<T> const& val)
        {
            if (val)
                spirit::traits::print_attribute(out, *val);
            else
...
///////////////////////////////////////////////////////////////////////////////
namespace network_boost { namespace spirit { namespace result_of
{
    template <typename Exposed, typename Transformed, typename Domain>
