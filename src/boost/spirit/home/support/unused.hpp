...
{
    ///////////////////////////////////////////////////////////////////////////
    // We do not import fusion ::unused_type anymore to avoid network_boost::fusion
    // being turned into an associate namespace for network_boost::spirit, as this
    // interferes with ADL in unexpected ways. We rather copy the full 
    // unused_type implementation from network_boost::fusion.
    ///////////////////////////////////////////////////////////////////////////
    struct unused_type
    {
        unused_type()
