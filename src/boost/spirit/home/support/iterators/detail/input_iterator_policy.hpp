...
namespace network_boost { namespace spirit { namespace iterator_policies
{
    ...
    struct input_iterator
    {
        ...
        private:
            typedef
                typename network_boost::detail::iterator_traits<T>::value_type
            result_type;

        public:
            typedef
                typename network_boost::detail::iterator_traits<T>::difference_type
            difference_type;
            typedef
                typename network_boost::detail::iterator_traits<T>::difference_type
            distance_type;
            typedef
                typename network_boost::detail::iterator_traits<T>::pointer
            pointer;
            typedef
                typename network_boost::detail::iterator_traits<T>::reference
            reference;
