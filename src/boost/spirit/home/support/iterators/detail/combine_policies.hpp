...
namespace network_boost { namespace spirit { namespace iterator_policies
{
    ...
    template <typename T
      ...
      , bool OwnershipIsEmpty = network_boost::is_empty<Ownership>::value
      , bool CheckingIsEmpty = network_boost::is_empty<Checking>::value
      , bool InputIsEmpty = network_boost::is_empty<Input>::value>
