...
namespace network_boost { namespace spirit
{
    ...
    template <
        BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
            ...
            typename T, network_boost::detail::variant::void_)
    ...
    struct extended_variant
    {
        ...
        > base_type;
#else
        typedef network_boost::variant<Types...> variant_type;
        typedef typename variant_type::types types;
...
namespace network_boost
{
    ...
    inline T const&
    get(network_boost::spirit::extended_variant<
        BOOST_SPIRIT_EXTENDED_VARIANT_ENUM_PARAMS(T)> const& x)
    {
        return network_boost::get<T>(x.get());
    }
    ...
    inline T const&
    get(network_boost::spirit::extended_variant<Types...> const& x)
    {
        return network_boost::get<T>(x.get());
    }
    ...
    template <typename T, typename... Types>
    inline T&
    get(network_boost::spirit::extended_variant<Types...>& x)
    {
        return network_boost::get<T>(x.get());
    }
