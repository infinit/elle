...
{
    static const ::network_boost::uint8_t category_stage1[] = {
    ...
    static const ::network_boost::uint16_t category_stage2[] = {
    ...
    inline ::network_boost::uint16_t category_lookup(::network_boost::uint32_t ch)
    {
        ::network_boost::uint32_t block_offset = category_stage1[ch / 256] * 256;
