...
{
    static const ::network_boost::uint8_t lowercase_stage1[] = {
    ...
    static const ::network_boost::uint32_t lowercase_stage2[] = {
    ...
    inline ::network_boost::uint32_t lowercase_lookup(::network_boost::uint32_t ch)
    {
        ::network_boost::uint32_t block_offset = lowercase_stage1[ch / 256] * 256;
