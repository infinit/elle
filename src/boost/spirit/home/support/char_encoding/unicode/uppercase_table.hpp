...
{
    static const ::network_boost::uint8_t uppercase_stage1[] = {
    ...
    static const ::network_boost::uint32_t uppercase_stage2[] = {
    ...
    inline ::network_boost::uint32_t uppercase_lookup(::network_boost::uint32_t ch)
    {
        ::network_boost::uint32_t block_offset = uppercase_stage1[ch / 256] * 256;
