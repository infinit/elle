...
namespace network_boost { namespace spirit { namespace qi
{
      ...
      : char_parser<char_range<CharEncoding, false>, typename CharEncoding::char_type>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            network_boost::get<std::string>(result.value) += '-';
            network_boost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to));
            return result;
        }
      ...
      : char_parser<char_range<CharEncoding, true>, typename CharEncoding::char_type>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            network_boost::get<std::string>(result.value) += '-';
            network_boost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to_lo));
            return result;
        }
