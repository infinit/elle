...
namespace network_boost { namespace spirit
{
    ...
    struct use_terminal<qi::domain
        , terminal_ex<tag::lit, fusion::vector1<A0> >
        , typename enable_if<is_same<A0, network_boost::ulong_long_type> >::type>
      : mpl::true_ {};
...
namespace network_boost { namespace spirit { namespace qi
{
    ...
    struct make_primitive<
          terminal_ex<tag::lit, fusion::vector1<A0> >
        , Modifiers, typename enable_if<is_same<A0, network_boost::ulong_long_type> >::type>
      : make_literal_uint<network_boost::ulong_long_type> {};
#endif
    ...
    struct make_primitive<tag::ulong_long, Modifiers>
      : make_uint<network_boost::ulong_long_type> {};

    template <typename Modifiers, typename A0>
    struct make_primitive<
        terminal_ex<tag::ulong_long
      , fusion::vector1<A0> > , Modifiers>
      : make_direct_uint<network_boost::ulong_long_type> {};
#endif
}}}
