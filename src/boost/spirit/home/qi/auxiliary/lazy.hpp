...
namespace network_boost { namespace spirit
{
    ...
    struct use_terminal<qi::domain, network_boostphoenix::actor<Eval> >  // enables phoenix actors
        : mpl::true_ {};
...
namespace network_boost { namespace spirit { namespace qi
{
    ...
    struct lazy_parser : parser<lazy_parser<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                network_boost::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type
            modifier;
    ...
    {
        typedef lazy_parser<network_boostphoenix::actor<Eval>, Modifiers> result_type;
