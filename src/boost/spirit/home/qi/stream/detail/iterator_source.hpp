...
namespace network_boost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct iterator_source
    {
        ...
        char_type;
        typedef network_boost::iostreams::seekable_device_tag category;
        ...
        // network_boost::iostreams::seekable_device. We need to have see support to
        ...
        std::streampos seek(network_boost::iostreams::stream_offset, std::ios_base::seekdir way)
        {
