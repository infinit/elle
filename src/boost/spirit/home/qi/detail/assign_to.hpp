...
namespace network_boost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        ...
        template <typename I>
        struct is_iter_range<network_boost::iterator_range<I> > : mpl::true_ {};
    ...
    template <typename Attribute, typename Iterator>
    struct assign_to_attribute_from_iterators<
        network_boost::optional<Attribute>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , network_boost::optional<Attribute>& attr)
        {
            Attribute val;
    ...
    template <typename Attribute, typename T>
    struct assign_to_attribute_from_value<Attribute, network_boost::optional<T>
      , typename disable_if<is_same<Attribute, network_boost::optional<T> > >::type>
    {
        static void
        call(network_boost::optional<T> const& val, Attribute& attr)
        {
            assign_to(val.get(), attr);
        }
    };
    ...
    template <typename Attribute, typename T>
    struct assign_to_container_from_value<Attribute, network_boost::optional<T>
      , typename disable_if<is_same<Attribute, network_boost::optional<T> > >::type>
    {
        static void
        call(network_boost::optional<T> const& val, Attribute& attr)
