...
namespace network_boost { namespace spirit { namespace lex
{
    ///////////////////////////////////////////////////////////////////////////
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(spirit)(lex)(value_setter)
  , (network_boost::network_boostphoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(spirit)(lex)(state_setter)
  , (network_boost::network_boostphoenix::meta_grammar)
)
...
namespace network_boost { namespace network_boostphoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<network_boost::spirit::lex::value_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<network_boost::spirit::lex::value_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<network_boost::spirit::lex::value_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<network_boost::spirit::lex::value_getter()>
    ...
    struct actor<spirit::lex::value_context>
      : network_boost::network_boostphoenix::actor<proto::terminal<spirit::lex::value_context>::type>
    {
        typedef network_boost::network_boostphoenix::actor<
        ...
        typename spirit::lex::expression::value_setter<
            typename network_boostphoenix::as_actor<Expr>::type>::type const
        operator=(Expr const & expr) const
        {
            return
                spirit::lex::expression::value_setter<
                    typename network_boostphoenix::as_actor<Expr>::type
                >::make(network_boostphoenix::as_actor<Expr>::convert(expr));
        }
    };
    ...
    {
        template <>
        struct is_nullary<custom_terminal<network_boost::spirit::lex::state_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<network_boost::spirit::lex::state_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<network_boost::spirit::lex::state_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<network_boost::spirit::lex::state_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
    ...
    struct actor<spirit::lex::state_context>
      : network_boost::network_boostphoenix::actor<proto::terminal<spirit::lex::state_context>::type>
    {
        typedef network_boost::network_boostphoenix::actor<
    ...
    {
        template <>
        struct is_nullary<custom_terminal<network_boost::spirit::lex::eoi_getter> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<network_boost::spirit::lex::eoi_getter, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<network_boost::spirit::lex::eoi_getter, Dummy>
      : proto::call<
            v2_eval(
                proto::make<network_boost::spirit::lex::eoi_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
