...
namespace network_boost { namespace spirit { namespace lex
{
    ...
    typedef network_boostphoenix::arg_names::_1_type _start_type;
    typedef network_boostphoenix::arg_names::_2_type _end_type;
    ...
    // definition).
    // typedef network_boostphoenix::arg_names::_3_type _pass_type;
    using network_boost::spirit::_pass_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    using network_boost::spirit::_pass;
#endif

    // '_tokenid' may be used to access and change the tokenid of the current 
    // token
    typedef network_boostphoenix::arg_names::_4_type _tokenid_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    _tokenid_type const _tokenid = _tokenid_type();
#endif

    typedef network_boostphoenix::actor<value_context> _val_type;
    typedef network_boostphoenix::actor<state_context> _state_type;
    typedef network_boostphoenix::actor<eoi_getter> _eoi_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
