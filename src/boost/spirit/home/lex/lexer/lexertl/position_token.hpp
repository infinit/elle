...
{ 
    ...
    struct position_token<Iterator, lex::omit, mpl::false_, Idtype>
    {
        ...
        position_token() 
          : id_(id_type(network_boost::lexer::npos)) {}
    ...
    public:
        ...
        //  default constructed tokens correspond to EOI tokens
        position_token() : state_(network_boost::lexer::npos) {}

        //  construct an invalid token
        explicit position_token(int) 
          : base_type(0), state_(network_boost::lexer::npos) {}
    ...
    public:
        ...
        typedef typename base_type::iterpair_type iterpair_type;
        typedef HasState has_state;
        typedef network_boost::optional<Attribute> token_value_type;
