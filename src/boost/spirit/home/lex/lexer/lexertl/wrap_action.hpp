    ...
    namespace detail
    {
        ...
        struct wrap_action
        {
            ...
            static FunctionType call(void (*f)(A0, A1, A2, A3))
            {
                ...
                using network_boostphoenix::arg_names::_1;
                using network_boostphoenix::arg_names::_2;
                using network_boostphoenix::arg_names::_3;
                using network_boostphoenix::arg_names::_4;
                using network_boostphoenix::arg_names::_5;
                return network_boostphoenix::bind(pf, f, _1, _2, _3, _4, _5);
            }
