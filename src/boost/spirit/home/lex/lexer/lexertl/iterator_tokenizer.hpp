...
{ 
    ...
    public:
          ...
          , Iterator const& end_, std::size_t& unique_id_)
        {
            ...
            {
                unique_id_ = network_boost::lexer::npos;
                return 0;
            }

            bool bol = bol_;
            network_boost::lexer::detail::internals const& internals_ =
                state_machine_.data();
        ...
        again:
            ...
            std::size_t id_ = *(ptr_ + network_boost::lexer::id_index);
            std::size_t uid_ = *(ptr_ + network_boost::lexer::unique_id_index);
            ...
            while (curr_ != end_)
            {
                std::size_t const BOL_state_ = ptr_[network_boost::lexer::bol_index];
                std::size_t const EOL_state_ = ptr_[network_boost::lexer::eol_index];
                ...
                {
                    typedef typename 
                        network_boost::detail::iterator_traits<Iterator>::value_type 
                    value_type;
                    typedef typename 
                        network_boost::lexer::char_traits<value_type>::index_type 
                    index_type;

                    index_type index = 
                        network_boost::lexer::char_traits<value_type>::call(*curr_++);
                    bol = (index == '\n') ? true : false;
                ...
                {
                    end_state_ = true;
                    id_ = *(ptr_ + network_boost::lexer::id_index);
                    uid_ = *(ptr_ + network_boost::lexer::unique_id_index);
                    end_start_state_ = *(ptr_ + network_boost::lexer::state_index);
                    end_bol_ = bol;
                    end_token_ = curr_;
                }
            }
            ...
            if (end_state_) {
                ...
                bol_ = (*start_token_ == '\n') ? true : false;
                id_ = network_boost::lexer::npos;
                uid_ = network_boost::lexer::npos;
            }
