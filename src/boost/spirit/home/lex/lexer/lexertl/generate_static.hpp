...
///////////////////////////////////////////////////////////////////////////////
namespace network_boost { namespace spirit { namespace lex { namespace lexertl
{
    namespace detail
    {
    ...
    struct string_lit<wchar_t>
    {
        ...
        static std::basic_string<wchar_t> get(char const* source = "")
        {
            ...
            network_boost::scoped_array<wchar_t> result (new wchar_t[len+1]);
            result.get()[len] = '\0';
    ...
    template <typename Char>
    inline bool
    generate_cpp_state_info (network_boost::lexer::basic_rules<Char> const& rules_
      , std::basic_ostream<Char> &os_, Char const* name_suffix)
    {
        ...
        typedef typename
            network_boost::lexer::basic_rules<Char>::string_size_t_map::const_iterator
        state_iterator;
        ...
        os_ << network_boost::lexer::detail::strings<Char>::char_name()
        ...
        for (iterator rit = reverse_state_map.begin(); rit != rend; ++last_id)
        {
            ...
            os_ << "    "
                << network_boost::lexer::detail::strings<Char>::char_prefix()
                << "\"" << (*rit).second << "\"";
            if (++rit != rend)
                os_ << ",\n";
            else
      ...
      , Char const* name_suffix, bool bol, bool eol)
    {
        ...
        os_ << "    enum\n";
        os_ << "    {\n        static_version = "
            << network_boost::lexical_cast<std::basic_string<Char> >(SPIRIT_STATIC_LEXER_VERSION)
            << ",\n";
        ...
        os_ << "    static " << network_boost::lexer::detail::strings<Char>::char_name()
    ...
    bool generate_function_body_dfa(std::basic_ostream<Char>& os_
      , network_boost::lexer::basic_state_machine<Char> const &sm_)
    {
    ...
    inline std::basic_string<Char> get_charlit(Char ch)
    {
        ...
        network_boost::lexer::basic_string_token<Char>::escape_char(ch, result);
        return result;
    }

    // check whether state0_0 is referenced from any of the other states
    template <typename Char>
    bool need_label0_0(network_boost::lexer::basic_state_machine<Char> const &sm_)
    {
        typedef typename network_boost::lexer::basic_state_machine<Char>::iterator
            iterator_type;
      ...
      , network_boost::lexer::basic_state_machine<Char> const &sm_)
    {
        ...
        for (std::size_t dfa_ = 0; dfa_ < dfas_; ++dfa_)
        {
            ...
            for (std::size_t state_ = 0; state_ < states_; ++state_)
            {
                ...
                if (t_ < transitions_ ||
                    iter_->bol_index != network_boost::lexer::npos ||
                    iter_->eol_index != network_boost::lexer::npos)
                {
                    os_ << "    if (curr_ == end_) goto end;\n";
                    os_ << "    ch_ = *curr_;\n";
                    if (iter_->bol_index != network_boost::lexer::npos)
                    {
                        os_ << "\n    if (bol) goto state" << dfa_ << '_'
                            << iter_->bol_index << ";\n";
                    }
                    if (iter_->eol_index != network_boost::lexer::npos)
                    {
                        os_ << "\n    if (ch_ == '\n') goto state" << dfa_
                            << '_' << iter_->eol_index << ";\n";
                    }
    ...
    inline bool
    generate_cpp (network_boost::lexer::basic_state_machine<Char> const& sm_
      , network_boost::lexer::basic_rules<Char> const& rules_
      , std::basic_ostream<Char> &os_, Char const* name_suffix
...
//         std::size_t const lookups_ = sm_.data()._lookup->front()->size();
        ...
        os_ << "// Auto-generated by network_boost::lexer, do not edit\n\n";
        ...
        os_ << "// the generated table of state names and the tokenizer have to be\n"
               "// defined in the network_boost::spirit::lex::lexertl::static_ namespace\n";
        os_ << "namespace network_boost { namespace spirit { namespace lex { "
        ...
        os_ << "}}}}}  // namespace network_boost::spirit::lex::lexertl::static_\n\n";
