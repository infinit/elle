...
// needed leading to false static asserts
        ...
        public:
            ...
            { 
                ...
                // definition.
                BOOST_ASSERT(state_id != network_boost::lexer::npos);

                if (state_id != network_boost::lexer::npos)
                    state_ = state_id;
            }
        ...
        public:
            ...
            {
                Iterator end = end_;
                std::size_t unique_id = network_boost::lexer::npos;
                bool bol = this->bol_;
        ...
        template <typename Iterator, typename HasState, typename TokenValue>
        class data<Iterator, mpl::true_, HasState, network_boost::optional<TokenValue> > 
          : public data<Iterator, mpl::false_, HasState, TokenValue>
        {
        public:
            typedef semantic_actions<Iterator, HasState, data> 
        ...
        public:
            typedef Iterator base_iterator_type;
            typedef network_boost::optional<TokenValue> token_value_type;
            typedef network_boost::optional<TokenValue> const& get_value_type;
            typedef typename base_type::state_type state_type;
            typedef typename base_type::state_name_type state_name_type;
