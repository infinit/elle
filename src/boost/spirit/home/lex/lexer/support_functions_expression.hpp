...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(spirit)(lex)(less)
  , (network_boost::network_boostphoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(spirit)(lex)(lookahead)
  , (network_boost::network_boostphoenix::meta_grammar)
    (network_boost::network_boostphoenix::meta_grammar)
)
...
namespace network_boost { namespace network_boostphoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<network_boost::spirit::lex::more_type> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<network_boost::spirit::lex::more_type, Dummy> : mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<network_boost::spirit::lex::more_type, Dummy>
        : proto::call<
            v2_eval(
                proto::make<network_boost::spirit::lex::more_type()>
