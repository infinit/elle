...
struct return_type_1<other_action<addressof_action>, A> { 
  ...
  typedef typename detail::IF<
    network_boost::is_same<type1, detail::unspecified>::value, 
...
template <class A> struct contentsof_type {
  typedef typename network_boost::indirect_reference<A>::type type; 
};
...
struct pointer_arithmetic_traits<plus_action, A, B> { 
  ...
  typedef typename 
    array_to_pointer<typename network_boost::remove_reference<A>::type>::type AP;
  typedef typename 
    array_to_pointer<typename network_boost::remove_reference<B>::type>::type BP;

  static const bool is_pointer_A = network_boost::is_pointer<AP>::value;
  static const bool is_pointer_B = network_boost::is_pointer<BP>::value;  
...
struct pointer_arithmetic_traits<minus_action, A, B> { 
  ...
  static const bool same_pointer_type =
    ...
    network_boost::is_same<
      typename network_boost::remove_const<
        typename network_boost::remove_pointer<
          typename network_boost::remove_const<AP>::type
        >::type
      >::type,
      typename network_boost::remove_const<
        typename network_boost::remove_pointer<
          typename network_boost::remove_const<BP>::type
        >::type
      >::type
    >::value;
...
struct return_type_2<bitwise_action<Act>, A, B>
{
  ...
  // the apply function
  BOOST_STATIC_ASSERT(!(network_boost::is_float<plain_A>::value && network_boost::is_float<plain_B>::value));
...
private:
  typedef typename network_boost::remove_reference<A>::type plainA;
public:
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    detail::IF<
      network_boost::is_same<type1, detail::unspecified>::value, 
      typename network_boost::add_reference<A>::type,
      type1
    >::RET type;
};
...
struct return_type_2<other_action<subscript_action>, A, B> {
  ...
  typedef typename network_boost::remove_reference<A>::type nonref_A;
  typedef typename network_boost::remove_reference<B>::type nonref_B;
