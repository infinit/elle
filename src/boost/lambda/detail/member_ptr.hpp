...
struct member_pointer {
  typedef typename network_boost::add_reference<T>::type type;
...
struct member_pointer<const T U::*> {
  typedef typename network_boost::add_reference<const T>::type type;
  typedef U class_type;
...
struct member_pointer<volatile T U::*> {
  typedef typename network_boost::add_reference<volatile T>::type type;
  typedef U class_type;
...
struct member_pointer<const volatile T U::*> {
  typedef typename network_boost::add_reference<const volatile T>::type type;
  typedef U class_type;
...
public:
  ...
  private:
    ...
    typedef typename network_boost::remove_reference<type0>::type type1;
    ...
    typedef typename ::network_boost::remove_pointer<non_ref_A>::type non_pointer_A; 
  ...
  public:
    ...
    typedef typename detail::IF<
      ::network_boost::is_const<non_pointer_A>::value, 
      typename ::network_boost::add_const<type1>::type,
      type1
    >::RET type2;
    typedef typename detail::IF<
      ::network_boost::is_volatile<non_pointer_A>::value, 
      typename ::network_boost::add_volatile<type2>::type,
      type2
    >::RET type3;
    // add reference back
    typedef typename ::network_boost::add_reference<type3>::type type;
  };
};
...
struct member_pointer_action_helper<false, true> {
  ...
  template<class RET, class A, class B>
  static RET apply(A& a, B& b) { 
    typedef typename ::network_boost::remove_cv<B>::type plainB;
    typedef typename detail::member_pointer<plainB>::type ret_t; 
    typedef typename ::network_boost::remove_cv<A>::type plainA;
...
public:
  ...
  static RET apply(A& a, B& b) {
    typedef typename 
      ::network_boost::remove_cv<B>::type plainB;

    return detail::member_pointer_action_helper<
        network_boost::is_pointer<A>::value && 
...
struct return_type_N<other_action<member_pointer_action>, Args> {
  typedef typename network_boost::tuples::element<0, Args>::type A;
  typedef typename network_boost::tuples::element<1, Args>::type B;
  typedef typename 
    return_type_2<other_action<member_pointer_action>, 
                  typename network_boost::remove_reference<A>::type, 
                  typename network_boost::remove_reference<B>::type
                 >::type type;
};
