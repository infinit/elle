...
struct remove_references_from_elements {
  typedef typename network_boost::tuples::cons<
    typename network_boost::remove_reference<typename Tuple::head_type>::type,
    typename remove_references_from_elements<typename Tuple::tail_type>::type
  > type;
};

template<>
struct remove_references_from_elements<network_boost::tuples::null_type> {
  typedef network_boost::tuples::null_type type;
};
...
template <class Func> struct function_adaptor {
  ...
  // Support functors that use the network_boost::result_of return type convention.
...
struct function_adaptor<T Object::*> {
  ...
  template<class Args> class sig { 
    typedef typename network_boost::tuples::element<1, Args>::type argument_type;
    typedef typename network_boost::remove_reference<
      argument_type
    >::type unref_type;

    typedef typename detail::IF<network_boost::is_const<unref_type>::value,
      typename network_boost::add_const<T>::type,
      T
    >::RET properly_consted_return_type;

    typedef typename detail::IF<network_boost::is_volatile<unref_type>::value,
      typename network_boost::add_volatile<properly_consted_return_type>::type,
      properly_consted_return_type
    >::RET properly_cvd_return_type;


  public:
    typedef typename detail::IF<network_boost::is_reference<argument_type>::value,
      typename network_boost::add_reference<properly_cvd_return_type>::type,
      typename network_boost::remove_cv<T>::type
    >::RET type;
  };
