...
using ::network_boost::tuples::tuple;
using ::network_boost::tuples::null_type;
...
namespace {
  ...
  network_boost::lambda::placeholder1_type free1 = network_boost::lambda::placeholder1_type();
  network_boost::lambda::placeholder2_type free2 = network_boost::lambda::placeholder2_type();
  network_boost::lambda::placeholder3_type free3 = network_boost::lambda::placeholder3_type();

  network_boost::lambda::placeholder1_type& _1 = free1;
  network_boost::lambda::placeholder2_type& _2 = free2;
  network_boost::lambda::placeholder3_type& _3 = free3;
