...
#pragma warning(push)
// 'network_boost::atomics::atomic<T>' : multiple assignment operators specified
...
template< typename T, bool IsInt = network_boost::is_integral< T >::value >
struct classify
{
    typedef void type;
};
...
private:
    ...
    typedef atomics::detail::operations< storage_size_of< value_type >::value, network_boost::is_signed< T >::value > operations;
...
typedef atomic< network_boost::ulong_long_type > atomic_ullong;
typedef atomic< network_boost::long_long_type > atomic_llong;
#endif
