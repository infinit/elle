...
{
    typedef network_boost::uint8_t type;
...
{
    typedef network_boost::int8_t type;
...
{
    typedef network_boost::uint16_t type;
...
{
    typedef network_boost::int16_t type;
...
{
    typedef network_boost::uint32_t type;
...
{
    typedef network_boost::int32_t type;
...
{
    typedef network_boost::uint64_t type;
...
{
    typedef network_boost::int64_t type;
...
{
    typedef network_boost::uint128_type type;
...
{
    typedef network_boost::int128_type type;
