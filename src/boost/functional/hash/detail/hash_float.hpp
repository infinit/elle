...
namespace network_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME network_boost::enable_if_c<
        ...
        {
            network_boost::hash_detail::call_frexp<T> frexp;
            network_boost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        network_boost::static_log2<limits<T>::radix>::value
...
namespace network_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return network_boost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
