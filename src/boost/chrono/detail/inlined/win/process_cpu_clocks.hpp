...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( network_boost::detail::winapi::GetProcessTimes(
            network_boost::detail::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        network_boost::detail::winapi::DWORD_ cause = network_boost::detail::winapi::GetLastError();
        if (BOOST_CHRONO_IS_THROWS(ec))
        {
            network_boost::throw_exception(
                    system::system_error(
