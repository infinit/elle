...
thread_clock::time_point thread_clock::now( system::error_code & ec )
{
    ...
    network_boost::detail::winapi::FILETIME_ creation, exit, user_time, system_time;

    if ( network_boost::detail::winapi::GetThreadTimes(
            network_boost::detail::winapi::GetCurrentThread (), &creation, &exit,
    ...
    else
    {
        ...
        {
            ec.assign( network_boost::detail::winapi::GetLastError(), BOOST_CHRONO_SYSTEM_CATEGORY );
