...
namespace chrono_detail
{
  ...
  {
      network_boost::detail::winapi::LARGE_INTEGER_ freq;
      if ( !network_boost::detail::winapi::QueryPerformanceFrequency( &freq ) )
          return 0.0L;
  ...
  steady_clock::time_point steady_clock::now() BOOST_NOEXCEPT
  {
    ...
    network_boost::detail::winapi::LARGE_INTEGER_ pcount;
    ...
    unsigned times=0;
    while ( ! network_boost::detail::winapi::QueryPerformanceCounter( &pcount ) )
    {
      if ( ++times > 3 )
      {
  ...
  steady_clock::time_point steady_clock::now( system::error_code & ec )
  {
    ...
    network_boost::detail::winapi::LARGE_INTEGER_ pcount;
    if ( (nanosecs_per_tic <= 0.0L)
            || (!network_boost::detail::winapi::QueryPerformanceCounter( &pcount )) )
    {
        network_boost::detail::winapi::DWORD_ cause =
            ((nanosecs_per_tic <= 0.0L)
                    ? ERROR_NOT_SUPPORTED
                    : network_boost::detail::winapi::GetLastError());
  ...
  {
    network_boost::detail::winapi::FILETIME_ ft;
    network_boost::detail::winapi::GetSystemTimeAsFileTime( &ft );  // never fails
