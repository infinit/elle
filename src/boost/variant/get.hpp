...
public: // std::exception implementation
    ...
    {
        return "network_boost::bad_get: "
               "failed value get using network_boost::get";
    }
...
public: // visitor interfaces
    ...
    {
        return network_boost::addressof(operand);
    }
...
relaxed_get(
      network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
...
relaxed_get(
      const network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
      BOOST_VARIANT_AUX_GET_EXPLICIT_TEMPLATE_TYPE(U)
    ) BOOST_NOEXCEPT
{
    ...
    )
{
    ...
    if (!result)
        network_boost::throw_exception(bad_get());
    return *result;
}
    ...
    ) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        (network_boost::detail::variant::holds_element<network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "network_boost::variant does not contain specified type U, "
        "call to network_boost::get<U>(network_boost::variant<T...>*) will always return NULL"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (network_boost::detail::variant::holds_element<network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "network_boost::variant does not contain specified type U, "
        "call to network_boost::get<U>(const network_boost::variant<T...>*) will always return NULL"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (network_boost::detail::variant::holds_element<network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "network_boost::variant does not contain specified type U, "
        "call to network_boost::get<U>(network_boost::variant<T...>&) will always throw network_boost::bad_get exception"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (network_boost::detail::variant::holds_element<network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "network_boost::variant does not contain specified type U, "
        "call to network_boost::get<U>(const network_boost::variant<T...>&) will always throw network_boost::bad_get exception"
    );
