...
//
// Exposes a network_boost::variant with recursive_variant_ tags (below) substituted
// with the variant itself (wrapped as needed with network_boost::recursive_wrapper).
//
