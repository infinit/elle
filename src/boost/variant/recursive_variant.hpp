...
template <
    ...
    >
struct substitute<
      ::network_boost::variant<
          recursive_flag< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::network_boost::recursive_variant_
      BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(Arity)
    >
{
    typedef ::network_boost::variant<
          recursive_flag< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        > type;
};
...
struct substitute<
      ::network_boost::variant<
          ::network_boost::detail::variant::over_sequence< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::network_boost::recursive_variant_
...
public:
    ...
    typedef typename mpl::if_<
          mpl::equal<initial_types, types, ::network_boost::is_same<mpl::_1, mpl::_2> >
        , ::network_boost::variant<
              ::network_boost::detail::variant::over_sequence< T0 >
            , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
            >
        , ::network_boost::variant< over_sequence<types> >
        >::type type;
};
...
public: // metafunction result
    ...
    typedef ::network_boost::variant< BOOST_VARIANT_ENUM_PARAMS(wknd_T) > type;
