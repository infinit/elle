...
template <typename R = ::network_boost::detail::static_visitor_default_return>
...
struct is_static_visitor_impl
{
    BOOST_STATIC_CONSTANT(bool, value = 
        (::network_boost::is_base_and_derived< 
...
template< typename T > struct is_static_visitor
	: public ::network_boost::integral_constant<bool,(::network_boost::detail::is_static_visitor_impl<T>::value)>
{
public:
