...
class BOOST_SYMBOL_VISIBLE basic_iarchive :
    ...
    public network_boost::archive::detail::helper_collection
{
    friend class basic_iarchive_impl;
    // hide implementation of this class to minimize header conclusion
    network_boost::scoped_ptr<basic_iarchive_impl> pimpl;
...
protected:
    ...
    network_boost::archive::detail::helper_collection &
...
public:
    ...
    load_pointer(
        ...
        const basic_pointer_iserializer * (*finder)(
            const network_boost::serialization::extended_type_info & eti
        )
    );
