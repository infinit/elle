...
#define BOOST_SERIALIZATION_NVP(name)                              \
    network_boost::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    network_boost::serialization::make_nvp(                                \
        BOOST_PP_STRINGIZE(name),                                  \
        network_boost::serialization::base_object<name >(*this)            \
    )
/**/
