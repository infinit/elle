...
};  // network_boost::integer::gcd_evaluator
...
};  // network_boost::integer::lcm_evaluator
...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( network_boost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( network_boost::long_long_type, network_boost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
