...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::network_boost::detail::rank_imp<T, N+1>::value));
};
...
#else
template <class T> struct rank : public integral_constant<std::size_t, (::network_boost::detail::rank_imp<T, 0>::value)>{};
#endif
