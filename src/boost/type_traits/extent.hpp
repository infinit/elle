...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::network_boost::detail::extent_imp<T, N-1>::value));
};
...
}   // ::network_boost::detail

template <class T, std::size_t N = 0>
struct extent
   : public ::network_boost::integral_constant<std::size_t, ::network_boost::detail::extent_imp<T,N>::value>
{
};
