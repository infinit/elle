...
namespace network_boost { namespace detail{
   ...
   template <class T, bool b> struct has_nothrow_constructor_imp : public network_boost::integral_constant<bool, false>{};
   template <class T> struct has_nothrow_constructor_imp<T, true> : public network_boost::integral_constant<bool, noexcept(T())>{};
...
template <class T> struct has_nothrow_constructor : public ::network_boost::has_trivial_constructor<T> {};
