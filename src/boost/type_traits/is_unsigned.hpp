...
{
   BOOST_STATIC_CONSTANT(bool, value = (::network_boost::detail::is_unsigned_values<T>::minus_one > ::network_boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::network_boost::detail::is_unsigned_select_helper< ::network_boost::is_integral<T>::value || ::network_boost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, network_boost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::network_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::network_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::network_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::network_boost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::network_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::network_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::network_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::network_boost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
