...
// 4.5/2
template <class T> struct need_promotion : public network_boost::is_enum<T> {};
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(network_boost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(network_boost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, network_boost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, network_boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, network_boost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, network_boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (network_boost::type_traits::detail::promoted_index<T>::value)
      , (network_boost::is_const<T>::value)
      , (network_boost::is_volatile<T>::value)
      >::type type;
};
...
{
private:
   typedef network_boost::type_traits::detail::need_promotion<typename remove_cv<T>::type> tag_type;
public:
   typedef typename network_boost::type_traits::detail::integral_promotion<T, tag_type::value>::type type;
};
