...
struct is_abstract_imp
{
   typedef is_abstract_select< ::network_boost::is_class<T>::value> selector;
...
template <class T> struct is_abstract : public integral_constant<bool, ::network_boost::detail::is_abstract_imp<T>::value> {};
#else
template <class T> struct is_abstract : public integral_constant<bool, ::network_boost::detail::is_polymorphic_imp<T>::value> {};
#endif
