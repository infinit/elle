...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename network_boost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::network_boost::is_pointer<T>::value>::type type;
   };
}

template <class T> struct remove_pointer{ typedef typename network_boost::detail::remove_pointer_imp2<T>::type type; };
