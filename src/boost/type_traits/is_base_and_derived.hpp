...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::network_boost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::network_boost::is_class<B>::value,
       ::network_boost::is_class<D>::value,
       ::network_boost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::network_boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::network_boost::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
