...
template<class T> struct common_type<T>: network_boost::decay<T>
{
};
...
template<class T1, class T2> using builtin_common_type = typename network_boost::decay<decltype( network_boost::declval<bool>()? network_boost::declval<T1>(): network_boost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( network_boost::declval<bool>()? network_boost::declval<T1>(): network_boost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename network_boost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: network_boost::decay<decltype( network_boost::declval<bool>()? network_boost::declval<T1>(): network_boost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename network_boost::decay<T1>::type, class T2d = typename network_boost::decay<T2>::type> struct common_type_decay_helper: network_boost::common_type<T1d, T2d>
{
};
