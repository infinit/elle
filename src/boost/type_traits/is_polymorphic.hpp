...
{
   typedef is_polymorphic_selector< ::network_boost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::network_boost::detail::is_polymorphic_imp<T>::value> {};
