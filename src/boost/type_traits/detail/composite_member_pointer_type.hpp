...
template<class C1, class C2> struct common_member_class
{
    typedef typename network_boost::conditional<
        ...
        network_boost::is_base_of<C1, C2>::value,
        C2,
        typename network_boost::conditional<network_boost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename network_boost::remove_pointer<CPT>::type CT;
