...
struct operator_returns_void {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::network_boost::type_traits::yes_type)==sizeof(returns_void((BOOST_TT_TRAIT_OP make<Rhs>(),returns_void_t())))));
};
...
struct operator_returns_Ret < Rhs, Ret, false > {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(BOOST_TT_TRAIT_OP make<Rhs>()))==sizeof(::network_boost::type_traits::yes_type)));
};
...
struct operator_exists {
   ...
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((BOOST_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::network_boost::type_traits::yes_type)));
};
...
template <class Rhs, class Ret=::network_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,_impl)::dont_care>
struct BOOST_TT_TRAIT_NAME : public integral_constant<bool, (::network_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl)::trait_impl < Rhs, Ret >::value)>{};
