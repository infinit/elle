...
{
    BOOST_STATIC_CONSTANT( bool, ct = network_boost::is_class<T>::value || network_boost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = network_boost::is_class<U>::value || network_boost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public network_boost::conditional<

    network_boost::is_convertible<T, U>::value && !network_boost::is_convertible<U, T>::value,
    network_boost::type_identity<U>,

    typename network_boost::conditional<

        network_boost::is_convertible<U, T>::value && !network_boost::is_convertible<T, U>::value,
        network_boost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public network_boost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public network_boost::conditional<
    network_boost::is_pointer<T>::value || network_boost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public network_boost::conditional<
    network_boost::is_member_pointer<T>::value || network_boost::is_member_pointer<U>::value,
