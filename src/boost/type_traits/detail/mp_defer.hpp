...
struct mp_valid_impl
{
    ...
    static network_boost::true_type check(int);

    template<template<class...> class>
    static network_boost::false_type check(...);
...
template<template<class...> class F, class... T> using mp_defer = typename network_boost::conditional<mp_valid<F, T...>::value, mp_defer_impl<F, T...>, mp_empty>::type;
