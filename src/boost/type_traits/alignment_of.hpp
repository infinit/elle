...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::network_boost::detail::alignment_logic<
            sizeof(::network_boost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
template <class T> struct alignment_of : public integral_constant<std::size_t, ::network_boost::detail::alignment_of_impl<T>::value>{};
