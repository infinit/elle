...
struct has_nothrow_copy_constructor_imp : public network_boost::integral_constant<bool, false>{};
template <class T>
struct has_nothrow_copy_constructor_imp<T, true> : public network_boost::integral_constant<bool, noexcept(T(network_boost::declval<const T&>()))>{};

}

template <class T> struct has_nothrow_copy_constructor : public detail::has_nothrow_copy_constructor_imp<T, network_boost::is_copy_constructible<T>::value>{};
...
template <class T> struct has_nothrow_copy_constructor : public integral_constant<bool, ::network_boost::has_trivial_copy<T>::value>{};
