...
namespace network_boost
{
    ...
    public:
        lock_error()
        : base_type(0, "network_boost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "network_boost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::resource_unavailable_try_again), "network_boost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "network_boost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::invalid_argument), "network_boost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "network_boost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(static_cast<int>(system::errc::invalid_argument), "network_boost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "network_boost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::permission_denied), "network_boost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "network_boost::thread_permission_error")
          {
          }
