...
#define _InterlockedCompareExchange InterlockedCompareExchange
...
#else
                    ::network_boost::detail::win32::Sleep(0);
#endif
                }
                else
                {
#if BOOST_PLAT_WINDOWS_RUNTIME
                    ::network_boost::detail::win32::WaitForSingleObjectEx(::network_boost::detail::win32::GetCurrentThread(), milliseconds, 0);
#else
                    ::network_boost::detail::win32::Sleep(milliseconds);
#endif
                }
            }
            ...
            public:
                ...
                ~scoped_winrt_thread()
                {
                    if (m_completionHandle != ::network_boost::detail::win32::invalid_handle_value)
                    {
                ...
                {
                    BOOST_ASSERT(m_completionHandle != ::network_boost::detail::win32::invalid_handle_value);
