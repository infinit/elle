...
//#endif
        ...
        typedef network_boost::intrusive_ptr<detail::thread_data_base> thread_data_ptr;
        ...
        struct BOOST_SYMBOL_VISIBLE timeout
        {
            ...
            bool relative;
            network_boost::system_time abs_time;
            ...
            timeout(uintmax_t milliseconds_):
                ...
                relative(true)
            //,
            //    abs_time(network_boost::get_system_time())
            {}

            timeout(network_boost::system_time const& abs_time_):
                start(win32::GetTickCount64_()()),
                milliseconds(0),
                relative(false),
                abs_time(abs_time_)
