...
namespace executors
{
  ...
  public:
    ...
    executor_adaptor(BOOST_THREAD_RV_REF(Args) ... args) : ex(network_boost::forward<Args>(args)...) {}
#else
    /**
     * executor_adaptor constructor
     */
    ...
    void submit(BOOST_THREAD_RV_REF(work) closure)  {
      return ex.submit(network_boost::move(closure));
    }
    ...
    {
      //submit(work(network_boost::forward<Closure>(closure)));
      work w((network_boost::forward<Closure>(closure)));
      submit(network_boost::move(w));
    }
