...
namespace network_boost
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(network_boost::forward<F>(f), network_boost::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(network_boost::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      invoker& operator=(BOOST_THREAD_RV_REF(invoker) f)
      {
        if (this != &f)
        {
          f_ = network_boost::move(BOOST_THREAD_RV(f).f_);
        }
        return *this;
      }
    ...
    private:
      ...
      {
        return detail::invoke(network_boost::move(csbl::get<0>(f_)), network_boost::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(network_boost::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(network_boost::move(csbl::get<0>(f_)), network_boost::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , network_boost::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , network_boost::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(network_boost::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(network_boost::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(network_boost::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , network_boost::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) network_boost::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    class invoker<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8>
    {
      ...
      T7 v7_;
      T8 v8_;
      //::network_boost::tuple<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> f_;
    ...
    public:
      ...
      : fp_(network_boost::move(f))
      , v0_(network_boost::move(a0))
      , v1_(network_boost::move(a1))
      , v2_(network_boost::move(a2))
      , v3_(network_boost::move(a3))
      , v4_(network_boost::move(a4))
      , v5_(network_boost::move(a5))
      , v6_(network_boost::move(a6))
      , v7_(network_boost::move(a7))
      , v8_(network_boost::move(a8))
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f)
      : fp_(network_boost::move(BOOST_THREAD_RV(f).fp))
      , v0_(network_boost::move(BOOST_THREAD_RV(f).v0_))
      , v1_(network_boost::move(BOOST_THREAD_RV(f).v1_))
      , v2_(network_boost::move(BOOST_THREAD_RV(f).v2_))
      , v3_(network_boost::move(BOOST_THREAD_RV(f).v3_))
      , v4_(network_boost::move(BOOST_THREAD_RV(f).v4_))
      , v5_(network_boost::move(BOOST_THREAD_RV(f).v5_))
      , v6_(network_boost::move(BOOST_THREAD_RV(f).v6_))
      , v7_(network_boost::move(BOOST_THREAD_RV(f).v7_))
      , v8_(network_boost::move(BOOST_THREAD_RV(f).v8_))
      {}

      result_type operator()()
      {
        return detail::invoke(network_boost::move(fp_)
            , network_boost::move(v0_)
            , network_boost::move(v1_)
            , network_boost::move(v2_)
            , network_boost::move(v3_)
            , network_boost::move(v4_)
            , network_boost::move(v5_)
            , network_boost::move(v6_)
            , network_boost::move(v7_)
            , network_boost::move(v8_)
        );
      }
    };
