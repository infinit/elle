      ...
      public:
          BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(BOOST_THREAD_RV_REF(F) f_, BOOST_THREAD_RV_REF(ArgTypes)... args_):
              fp(network_boost::forward<F>(f_), network_boost::forward<ArgTypes>(args_)...)
            {}
...
//            {}
        ...
        template<typename F>
        class thread_data<network_boost::reference_wrapper<F> >:
            public detail::thread_data_base
        {
        private:
            F& f;
        public:
            BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(network_boost::reference_wrapper<F> f_):
                f(f_)
            {}
            void run()
            {
        ...
        template<typename F>
        class thread_data<const network_boost::reference_wrapper<F> >:
            public detail::thread_data_base
        {
        private:
            F& f;
        public:
            BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(const network_boost::reference_wrapper<F> f_):
                f(f_)
            {}
            void run()
            {
    ...
    private:
        ...
        void start_thread()
        {
          ...
          {
            network_boost::throw_exception(thread_resource_error());
          }
        }
        ...
        static inline detail::thread_data_ptr make_thread_info(BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_RV_REF(ArgTypes)... args)
        {
            return detail::thread_data_ptr(detail::heap_new<
                  detail::thread_data<typename network_boost::remove_reference<F>::type, ArgTypes...>
                  >(
                    network_boost::forward<F>(f), network_boost::forward<ArgTypes>(args)...
                  )
                );
        }
#else
        ...
        {
            return detail::thread_data_ptr(detail::heap_new<detail::thread_data<typename network_boost::remove_reference<F>::type> >(
                network_boost::forward<F>(f)));
        }
#endif
        static inline detail::thread_data_ptr make_thread_info(void (*f)())
        {
            return detail::thread_data_ptr(detail::heap_new<detail::thread_data<void(*)()> >(
                network_boost::forward<void(*)()>(f)));
        }
#else
        template<typename F>
        static inline detail::thread_data_ptr make_thread_info(F f
            , typename disable_if_c<
                //network_boost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F)>::value ||
    ...
    public:
        ...
        //, typename disable_if<is_same<typename decay<F>::type, thread>, dummy* >::type=0
          ...
          thread_info(make_thread_info(thread_detail::decay_copy(network_boost::forward<F>(f))))
        {
            start_thread();
        }
        template <
        ...
        explicit thread(F f
        , typename disable_if_c<
        network_boost::thread_detail::is_rv<F>::value // todo ass a thread_detail::is_rv
        //network_boost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F)>::value
            //|| is_same<typename decay<F>::type, thread>::value
           , dummy* >::type=0
        ):
        ...
        template <class F>
        thread(attributes const& attrs, F f
            , typename disable_if<network_boost::thread_detail::is_rv<F>, dummy* >::type=0
            //, typename disable_if<network_boost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F) >, dummy* >::type=0
        ):
            thread_info(make_thread_info(f))
        {
            start_thread(attrs);
        ...
        thread_info(make_thread_info(network_boost::move<F>(f))) // todo : Add forward
#else
        ...
        thread(F&& f, Arg&& arg, Args&&... args) :
          thread_info(make_thread_info(
              ...
              thread_detail::decay_copy(network_boost::forward<Arg>(arg)),
              thread_detail::decay_copy(network_boost::forward<Args>(args))...)
          )
        ...
        thread(F f,A1 a1,typename disable_if<network_boost::thread_detail::is_convertible<F&,thread_attributes >, dummy* >::type=0):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1)))
        {
            start_thread();
        }
        template <class F,class A1,class A2>
        thread(F f,A1 a1,A2 a2):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3,a4)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3,a4,a5)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3,a4,a5,a6)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7,a8)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8,A9 a9):
            thread_info(make_thread_info(network_boost::bind(network_boost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7,a8,a9)))
        {
            start_thread();
        }
#endif
    ...
    public:
        ...
        bool try_join_until(const chrono::time_point<chrono::system_clock, chrono::nanoseconds>& tp)
        {
          ...
          timespec ts = network_boost::detail::to_timespec(d);
          return do_try_join_until(ts);
        }
#endif
  ...
  std::basic_ostream<charT, traits>&
    ...
    namespace this_thread
    {
        inline thread::id get_id() BOOST_NOEXCEPT
        {
             ...
             return pthread_self();
        #else
            network_boost::detail::thread_data_base* const thread_info=get_or_make_current_thread_data();
    ...
    void thread::join() {
        if (this_thread::get_id() == get_id())
          network_boost::throw_exception(thread_resource_error(static_cast<int>(system::errc::resource_deadlock_would_occur), "boost thread: trying joining itself"));
    ...
    {
        template<typename F>
        void network_boostat_thread_exit(F f)
        {
