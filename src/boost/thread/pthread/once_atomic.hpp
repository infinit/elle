...
namespace network_boost
{
  ...
  namespace thread_detail
  {
    ...
    typedef network_boost::atomic<atomic_int_type> atomic_type;
...
#define BOOST_ONCE_INIT network_boost::once_flag()
    ...
    if (thread_detail::enter_once_region(flag))
    {
      BOOST_TRY
      {
        BOOST_THREAD_INVOKE_RET_VOID(
            thread_detail::decay_copy(network_boost::forward<Function>(f)),
            thread_detail::decay_copy(network_boost::forward<T1>(p1)),
            thread_detail::decay_copy(network_boost::forward<T1>(p2))
        ) BOOST_THREAD_INVOKE_RET_VOID_CALL;
      }
      BOOST_CATCH (...)
      {
    ...
    if (thread_detail::enter_once_region(flag))
    {
      BOOST_TRY
      {
        BOOST_THREAD_INVOKE_RET_VOID(
            ...
            thread_detail::decay_copy(network_boost::forward<T1>(p1)),
            thread_detail::decay_copy(network_boost::forward<T1>(p2)),
            thread_detail::decay_copy(network_boost::forward<T1>(p3))
        ) BOOST_THREAD_INVOKE_RET_VOID_CALL;
