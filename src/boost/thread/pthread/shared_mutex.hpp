...
namespace network_boost
{
    ...
    private:
        ...
        state_data state;
        network_boost::mutex state_change;
        network_boost::condition_variable shared_cond;
        network_boost::condition_variable exclusive_cond;
        network_boost::condition_variable upgrade_cond;
    ...
    public:
        ...
        {
#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            network_boost::this_thread::disable_interruption do_not_disturb;
#endif
            network_boost::unique_lock<network_boost::mutex> lk(state_change);
