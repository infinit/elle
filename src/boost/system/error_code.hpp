    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename network_boost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorConditionEnum>
        typename network_boost::enable_if<is_error_condition_enum<ErrorConditionEnum>, error_condition>::type &
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename network_boost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorCodeEnum>
        typename network_boost::enable_if<is_error_code_enum<ErrorCodeEnum>, error_code>::type &
...
# endif
    ...
    //  "throws" function in namespace network_boost rather than namespace network_boost::system.
