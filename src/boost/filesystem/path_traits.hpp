...
namespace network_boost { namespace filesystem {
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename network_boost::disable_if<network_boost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename network_boost::disable_if<network_boost::is_array<Container>, void>::type
...
}}} // namespace network_boost::filesystem::path_traits
