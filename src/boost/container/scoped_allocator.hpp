   ...
   : public OuterAlloc
{
   ...
   scoped_allocator_adaptor_base(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs &...args)
      : outer_allocator_type(::network_boost::forward<OuterA2>(outerAlloc))
      , m_inner(args...)
      {}
   ...
   scoped_allocator_adaptor_base(BOOST_RV_REF(scoped_allocator_adaptor_base) other)
      : outer_allocator_type(::network_boost::move(other.outer_allocator()))
      , m_inner(::network_boost::move(other.inner_allocator()))
      {}
   ...
   {
      outer_allocator_type::operator=(network_boost::move(other.outer_allocator()));
      m_inner = ::network_boost::move(other.inner_allocator());
      return *this;
   }
   ...
   {
      network_boost::adl_move_swap(this->outer_allocator(), r.outer_allocator());
      network_boost::adl_move_swap(this->m_inner, r.inner_allocator());
   }
         ...
         <OuterAlloc BOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, BOOST_CONTAINER_SCOPEDALLOC_ALLINNER>
{
   ...
   scoped_allocator_adaptor(BOOST_RV_REF(scoped_allocator_adaptor) other)
      : base_type(::network_boost::move(other.base()))
      {}
   ...
   //!
   //! <b>Effects</b>: initializes the OuterAlloc base class with network_boost::forward<OuterA2>(outerAlloc) and inner
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs & ...innerAllocs)
      : base_type(::network_boost::forward<OuterA2>(outerAlloc), innerAllocs...)
      {}
   #else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc BOOST_MOVE_I##N BOOST_MOVE_CREF##N)\
      : base_type(::network_boost::forward<OuterA2>(outerAlloc) BOOST_MOVE_I##N BOOST_MOVE_ARG##N)\
      {}\
   //
   ...
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(network_boost::move(other.base()))); }
   ...
   void construct(T* p, BOOST_FWD_REF(Args)...args)
   {
      container_detail::dispatch_uses_allocator
         ...
         , this->inner_allocator(), p, ::network_boost::forward<Args>(args)...);
   }
   ...
   scoped_allocator_adaptor(internal_type_t, BOOST_FWD_REF(OuterA2) outer, const inner_allocator_type& inner)
      : base_type(internal_type_t(), ::network_boost::forward<OuterA2>(outer), inner)
   {}
                      ...
                      ,const scoped_allocator_adaptor<OuterA2, BOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& b)
{
   ...
   #else
   const bool has_zero_inner = network_boost::container::container_detail::is_same<P0, void>::value;
   #endif
