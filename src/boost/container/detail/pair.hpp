...
struct pair
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::network_boost::move(p.first)), second(::network_boost::move(p.second))
   {}
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::network_boost::forward<U>(u))
      , second(::network_boost::forward<V>(v))
   {}
   ...
   {
      first  = ::network_boost::move(p.first);
      second = ::network_boost::move(p.second);
      return *this;
   }

   template <class D, class S>
   typename ::network_boost::container::container_detail::disable_if_or
      < pair &
      , ::network_boost::container::container_detail::is_same<T1, D>
      , ::network_boost::container::container_detail::is_same<T2, S>
      >::type
...
//std::pair copy assignment
   ...
   void swap(pair& p)
   {
      ::network_boost::adl_move_swap(this->first, p.first);
      ::network_boost::adl_move_swap(this->second, p.second);
   }
};
...
struct is_enum< ::network_boost::container::container_detail::pair<T, U> >
{
   static const bool value = false;
};
...
template <class T1, class T2>
struct is_class< ::network_boost::container::container_detail::pair<T1, T2> >
{
   static const bool value = true;
};
...
template<class T1, class T2>
struct has_move_emulation_enabled< ::network_boost::container::container_detail::pair<T1, T2> >
{
   static const bool value = true;
};
...
template <class T1, class T2>
struct is_class_or_union< ::network_boost::container::container_detail::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = true;
