...
//! \file
//!   This header forward declares network_boost::container::constructible_with_allocator_prefix,
//!   network_boost::container::constructible_with_allocator_suffix and
//!   network_boost::container::uses_allocator. Also defines the following types:
