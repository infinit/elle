...
# endif
        ...
        struct result_of_it_fold<0,It,State,F
          , typename network_boost::enable_if_has_type<BOOST_FUSION_FOLD_IMPL_ENABLER(State)>::type
# if BOOST_WORKAROUND (BOOST_MSVC, < 1500)
          , true
# endif
          >
        ...
        struct result_of_it_fold<SeqSize,It,State,F
          , typename network_boost::enable_if_has_type<
# if BOOST_WORKAROUND (BOOST_MSVC, >= 1500)
                
                
                
                typename network_boost::disable_if_c<SeqSize == 0, State>::type::type
# else
