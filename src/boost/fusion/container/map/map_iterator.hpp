...
namespace network_boost { namespace fusion
{
          ...
          , typename Seq::category>
    {
        ...
        struct value_of
        {
            ...
            typedef
                decltype(network_boost::declval<sequence>().get_val(index()))
            type;
        };
        ...
        struct value_of_data
        {
            ...
            typedef typename Iterator::index index;
            typedef
                decltype(network_boost::declval<sequence>().get_val(index()).second)
            type;
        };
        ...
        struct key_of
        {
            typedef typename Iterator::sequence sequence;
            typedef typename Iterator::index index;
            typedef decltype(network_boost::declval<sequence>().get_key(index())) key_identity_type;
        ...
        struct deref
        {
            ...
            typedef typename Iterator::index index;
            typedef
                decltype(network_boost::declval<sequence>().get(index()))
            type;
        ...
        struct deref_data
        {
            ...
            typedef decltype(network_boost::declval<sequence>().get(index()).second) second_type_;
...
{
    template <typename Seq, int Pos>
    struct iterator_traits< ::network_boost::fusion::map_iterator<Seq, Pos> >
    { };
}
#endif
