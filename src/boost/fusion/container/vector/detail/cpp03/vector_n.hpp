...
FUSION_HASH endif
        ...
        BOOST_PP_CAT(vector_data, N)(BOOST_PP_ENUM_BINARY_PARAMS(N, U, && arg)
          , typename network_boost::enable_if<is_convertible<U0, T0> >::type* /*dummy*/ = 0
        )
...
FUSION_HASH endif
        ...
        BOOST_PP_CAT(vector, N)(
            Sequence const& seq
          , typename network_boost::enable_if<traits::is_sequence<Sequence> >::type* = 0
#if (N == 1)
          , typename network_boost::disable_if<is_convertible<Sequence, T0> >::type* /*dummy*/ = 0
#endif
            )
...
FUSION_HASH endif
        ...
        template <typename Sequence>
        BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        typename network_boost::disable_if<is_convertible<Sequence, T0>, this_type&>::type
