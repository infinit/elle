...
namespace network_boost { namespace fusion
{
    ...
    namespace extension
    {
        ...
        struct value_at_impl<vector_tag>
        {
            ...
            struct apply
            {
                typedef typename network_boost::remove_cv<Sequence>::type seq;
                typedef typename mpl::identity<decltype(seq::template value_at_impl<N::value>(network_boost::declval<seq*>()))>::type::type type;
            };
        };
    }
}}
