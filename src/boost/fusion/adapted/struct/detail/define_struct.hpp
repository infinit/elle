...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_FILLER_I(                             \
    ...
    BOOST_PP_EXPR_IF(                                                           \
        I_,                                                                     \
        typedef typename                                                        \
            network_boost::fusion::result_of::next<                                     \
                BOOST_PP_CAT(I,BOOST_PP_DEC(I_))                                \
            >::type                                                             \
        BOOST_PP_CAT(I,I_);                                                     \
        BOOST_PP_CAT(I,I_) BOOST_PP_CAT(i,I_)=                                  \
                network_boost::fusion::next(BOOST_PP_CAT(i,BOOST_PP_DEC(I_)));          \
    )                                                                           \
                                                                                \
    BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPEL_SIZE,1,ATTRIBUTE)=                      \
        network_boost::fusion::deref(BOOST_PP_CAT(i,I_));
...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_OP(                                   \
    ...
    {                                                                           \
        typedef typename                                                        \
            network_boost::fusion::result_of::begin<Seq const>::type                    \
        I0;                                                                     \
        I0 i0=network_boost::fusion::begin(seq);                                        \
                                                                                \
...
#define BOOST_FUSION_DEFINE_STRUCT_SEQ_CTOR_FILLER_I(                           \
    ...
    BOOST_PP_COMMA_IF(I)                                                        \
    BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPEL_SIZE,1,ATTRIBUTE)(                      \
        network_boost::fusion::deref(network_boost::fusion::advance_c<I>(network_boost::fusion::begin(  \
            seq))))
...
#define BOOST_FUSION_DEFINE_STRUCT_CTOR_1(                                      \
        ...
        BOOST_FUSION_GPU_ENABLED                                                \
        explicit                                                                \
        NAME(network_boost::call_traits<                                                \
                BOOST_PP_TUPLE_ELEM(                                            \
...
#define BOOST_FUSION_DEFINE_TPL_STRUCT_CTOR_1(                                  \
        ...
        BOOST_FUSION_GPU_ENABLED                                                \
        explicit                                                                \
        NAME(typename network_boost::call_traits<                                       \
                typename network_boost::fusion::detail::get_first_arg<                  \
                    BOOST_PP_TUPLE_ELEM(                                        \
                        ATTRIBUTE_TUPEL_SIZE,                                   \
                        0,                                                      \
                        BOOST_PP_SEQ_HEAD(ATTRIBUTES_SEQ))                      \
...
#define BOOST_FUSION_DEFINE_TPL_STRUCT_CTOR_ARG_I(R, DATA, I, ATTRIBUTE)        \
                                                                                \
        BOOST_PP_COMMA_IF(I)                                                    \
        typename network_boost::call_traits<                                            \
            typename network_boost::fusion::detail::get_first_arg<                      \
                BOOST_PP_TUPLE_ELEM(                                            \
...
namespace network_boost { namespace fusion { namespace detail
{
