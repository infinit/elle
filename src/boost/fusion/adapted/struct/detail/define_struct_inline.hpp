...
#define BOOST_FUSION_MAKE_ITERATOR_VALUE_OF_SPECS(Z, N, NAME)                   \
    ...
    struct value_of<                                                            \
           ...
           >                                                                    \
        : network_boost::mpl::identity<                                                 \
              typename network_boost_fusion_detail_Sq::t##N##_type                      \
          >                                                                     \
    {                                                                           \
    };
...
#define BOOST_FUSION_MAKE_ITERATOR_DEREF_SPEC(                                  \
    ...
    {                                                                           \
        typedef typename network_boost_fusion_detail_Sq::t##N##_type TYPE_QUAL& type;   \
...
#define BOOST_FUSION_MAKE_VALUE_AT_SPECS(Z, N, DATA)                            \
    template <typename boost_fusion_detail_Sq>                                  \
    struct value_at<boost_fusion_detail_Sq, network_boost::mpl::int_<N> >               \
    {                                                                           \
        typedef typename network_boost_fusion_detail_Sq::t##N##_type type;              \
    };

#define BOOST_FUSION_MAKE_AT_SPECS(R, DATA, N, ATTRIBUTE)                       \
    template <typename boost_fusion_detail_Sq>                                  \
    struct at<boost_fusion_detail_Sq, network_boost::mpl::int_<N> >                     \
    {                                                                           \
        typedef typename network_boost::mpl::if_<                                       \
            network_boost::is_const<boost_fusion_detail_Sq>,                            \
            typename network_boost_fusion_detail_Sq::t##N##_type const&,                \
            typename network_boost_fusion_detail_Sq::t##N##_type&                       \
        >::type type;                                                           \
                                                                                \
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                                \
...
#define BOOST_FUSION_DEFINE_ITERATOR_VALUE_OF(NAME, ATTRIBUTE_SEQ_SIZE)         \
        ...
        struct value_of : network_boost::fusion::result_of::at_c<                       \
                              ref_vec_t,                                        \
                              network_boost_fusion_detail_Iterator::index::value        \
                          >                                                     \
        {                                                                       \
        };
...
#define BOOST_FUSION_DEFINE_ITERATOR_DEREF(NAME, ATTRIBUTES_SEQ)                \
        ...
        struct deref                                                            \
        {                                                                       \
            typedef typename network_boost::remove_const<                               \
                boost_fusion_detail_Iterator                                    \
            >::type iterator_raw_type;                                          \
                                                                                \
            static const int index = iterator_raw_type::index::value;           \
                                                                                \
            typedef typename network_boost::fusion::result_of::at_c<                    \
                ref_vec_t,                                                      \
                index                                                           \
            >::type result_raw_type;                                            \
                                                                                \
            typedef typename network_boost::mpl::if_<                                   \
                network_boost::is_const<typename iterator_raw_type::sequence_type>,     \
                typename network_boost::add_const<result_raw_type>::type,               \
                result_raw_type                                                 \
            >::type type;                                                       \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
            ...
            {                                                                   \
                return network_boost::fusion::at_c<index>(iter.ref_vec);                \
            }                                                                   \
        };
...
#define BOOST_FUSION_MAKE_ITERATOR_WKND_REF(Z, N, DATA)                         \
        ...
        typename network_boost::mpl::if_<                                               \
                network_boost::is_const<boost_fusion_detail_Seq>,                       \
                typename network_boost::add_const<                                      \
                        typename network_boost_fusion_detail_Seq::t##N##_type           \
                >::type,                                                        \
                typename network_boost_fusion_detail_Seq::t##N##_type                   \
        >::type&

#define BOOST_FUSION_DEFINE_ITERATOR_WKND_MEMBERS(ATTRIBUTES_SEQ_SIZE)          \
        typedef network_boost::fusion::vector<                                          \
            BOOST_PP_REPEAT(                                                    \
                    ATTRIBUTES_SEQ_SIZE,                                        \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_IMPL(NAME, ATTRIBUTES)                \
    ...
    struct NAME : network_boost::fusion::sequence_facade<                               \
                      NAME,                                                     \
                      network_boost::fusion::random_access_traversal_tag                \
                  >                                                             \
    {                                                                           \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_ITERATOR_IMPL_IMPL(                   \
    ...
    struct BOOST_FUSION_ITERATOR_NAME(NAME)                                     \
        : network_boost::fusion::iterator_facade<                                       \
              BOOST_FUSION_ITERATOR_NAME(NAME)<boost_fusion_detail_Seq, N>,     \
              network_boost::fusion::random_access_traversal_tag                        \
          >                                                                     \
    {                                                                           \
        typedef network_boost::mpl::int_<N> index;                                      \
        ...
        {                                                                       \
            typedef BOOST_FUSION_ITERATOR_NAME(NAME)<                           \
                typename network_boost_fusion_detail_It::sequence_type,                 \
                network_boost_fusion_detail_It::index::value + 1                        \
            > type;                                                             \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
        ...
        struct distance                                                         \
        {                                                                       \
            typedef typename network_boost::mpl::minus<                                 \
                typename network_boost_fusion_detail_It2::index,                        \
                typename network_boost_fusion_detail_It1::index                         \
            >::type type;                                                       \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
        ...
        {                                                                       \
            typedef BOOST_FUSION_ITERATOR_NAME(NAME)<                           \
                typename network_boost_fusion_detail_It::sequence_type,                 \
                network_boost_fusion_detail_It::index::value                            \
                    + network_boost_fusion_detail_M::value                              \
            > type;                                                             \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
            static type call(boost_fusion_detail_It const& it)                  \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_MEMBERS_IMPL_IMPL(                    \
    ...
    {                                                                           \
        network_boost::fusion::copy(rhs, *this);                                        \
    }                                                                           \
                                                                                \
    template <typename boost_fusion_detail_Seq>                                 \
    BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED                              \
    ...
    {                                                                           \
        ...
        {                                                                       \
            return type(sq);                                                    \
                                                                                ...
                                                                                \
    template <typename boost_fusion_detail_Sq>                                  \
    struct size : network_boost::mpl::int_<ATTRIBUTES_SEQ_SIZE>                         \
    {                                                                           \
    };                                                                          \
                                                                                \
    template <typename boost_fusion_detail_Sq>                                  \
    struct empty : network_boost::mpl::bool_<ATTRIBUTES_SEQ_SIZE == 0>                  \
    {                                                                           \
    };                                                                          \
                                                                                \
    template <                                                                  \
    ...
    struct value_at : value_at<                                                 \
                          boost_fusion_detail_Sq,                               \
                          network_boost::mpl::int_<network_boost_fusion_detail_N::value>        \
                      >                                                         \
    {                                                                           \
    };                                                                          \
                                                                                \
