    ...
    namespace extension
    {
        ...
        struct value_at_impl<transform_view_tag>
        {
            ...
            struct apply
            {
                ...
                typedef typename network_boost::fusion::result_of::value_at<typename Seq::sequence_type, N>::type value_type;
        ...
        struct value_at_impl<transform_view2_tag>
        {
            ...
            struct apply
            {
                typedef typename Seq::transform_type F;
                typedef detail::apply_transform_result<F> transform_type;
                typedef typename network_boost::fusion::result_of::value_at<typename Seq::sequence1_type, N>::type value1_type;
                typedef typename network_boost::fusion::result_of::value_at<typename Seq::sequence2_type, N>::type value2_type;
