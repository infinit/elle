...
{
    template <typename First, typename F>
    struct iterator_traits< ::network_boost::fusion::transform_view_iterator<First, F> >
    { };
    template <typename First1, typename First2, typename F>
    struct iterator_traits< ::network_boost::fusion::transform_view_iterator2<First1, First2, F> >
    { };
}
#endif
