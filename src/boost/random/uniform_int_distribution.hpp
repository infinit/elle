...
T generate_uniform_int(
    ...
    network_boost::mpl::true_ /** is_integral<Engine::result_type> */)
{
    typedef T result_type;
    typedef typename network_boost::random::traits::make_unsigned_or_unbounded<T>::type range_type;
    typedef typename Engine::result_type base_result;
    // ranges are always unsigned or unbounded
    typedef typename network_boost::random::traits::make_unsigned_or_unbounded<base_result>::type base_unsigned;
...
inline T generate_uniform_int(
    Engine& eng, T min_value, T max_value,
    network_boost::mpl::false_ /** is_integral<Engine::result_type> */)
{
    uniform_int_float<Engine> wrapper(eng);
    return generate_uniform_int(wrapper, min_value, max_value, network_boost::mpl::true_());
}
...
inline T generate_uniform_int(Engine& eng, T min_value, T max_value)
{
    ...
    return generate_uniform_int(eng, min_value, max_value,
        network_boost::random::traits::is_integral<base_result>());
}
