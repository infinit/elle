...
public:
    ...
    result_type operator()() {
        ...
        typedef typename network_boost::random::traits::make_unsigned<result_type>::type base_unsigned;
        ...
        if(k == 1) {
            ...
            network_boost::uintmax_t divisor =
                static_cast<network_boost::uintmax_t>(brange) + 1;
