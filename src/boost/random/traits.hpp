...
namespace traits {
   ...
   {
      typedef typename network_boost::make_unsigned<T>::type type;
   };
   template <class T>
   ...
   * types this trait defaults to `network_boost::make_unsigned<T>::type`.  For user defined types it simply asserts that
   ...
   */
   ...
   // \cond show_private
      : public make_unsigned_imp < T, network_boost::is_integral<T>::value > 
      // \endcond
   {};
   // \cond show_private
   template <class T, bool intrinsic>
   ...
   */
   ...
   struct make_unsigned_or_unbounded
      // \cond show_private
      : public make_unsigned_or_unbounded_imp < T, network_boost::is_integral<T>::value > 
      // \endcond
   {};
   ...
   */
   template <class T>
   struct is_integral
      : public mpl::bool_<network_boost::is_integral<T>::value || (std::numeric_limits<T>::is_integer)>
   {};
   /** \brief Traits class that indicates whether type T is a signed integer
   */
   template <class T> struct is_signed
      : public mpl::bool_ < network_boost::is_signed<T>::value || (std::numeric_limits<T>::is_specialized && std::numeric_limits<T>::is_integer && std::numeric_limits<T>::is_signed)>
   {};
