...
struct subtract_with_carry_discard
{
    ...
    static void apply(Engine& eng, network_boost::uintmax_t z)
    {
...
public:
                                        ...
                                        IntType, value)
    {
        ...
        gen_t intgen(static_cast<network_boost::uint32_t>(value == 0 ? default_seed : value));
    ...
    { return network_boost::low_bits_mask_t<w>::sig_bits; }
...
public:
    ...
    BOOST_STATIC_CONSTANT(std::size_t, long_lag = r);
    BOOST_STATIC_CONSTANT(std::size_t, short_lag = s);
    BOOST_STATIC_CONSTANT(network_boost::uint32_t, default_seed = 19780503u);
...
class subtract_with_carry :
    public subtract_with_carry_engine<IntType,
        network_boost::static_log2<m>::value, s, r>
{
    typedef subtract_with_carry_engine<IntType,
        network_boost::static_log2<m>::value, s, r> base_type;
public:
    subtract_with_carry() {}
