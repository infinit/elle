 ...
 * network_boost::geometric_distribution.  A backwards compatible
 * wrapper is provided in namespace network_boost.
 * @endxmlwarning
 */
...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        using std::log;
        using std::floor;
        RealType x = RealType(1) - network_boost::uniform_01<RealType>()(eng);
