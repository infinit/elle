 ...
 * (to-be-invented) @c network_boost::bigfloat class with random bits efficiently.
...
{
  typedef network_boost::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
public:
