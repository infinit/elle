...
*/
    ...
    public:
        ...
        corpusIter operator () ( corpusIter corpus_first, corpusIter corpus_last ) const {
            BOOST_STATIC_ASSERT (( network_boost::is_same<
        ...
        typename network_boost::range_iterator<Range>::type operator () ( Range &r ) const {
            return (*this) (network_boost::begin(r), network_boost::end(r));
            }
...
///
    ...
    {
        typedef typename network_boost::range_iterator<const PatternRange>::type pattern_iterator;
        boyer_moore_horspool<pattern_iterator> bmh ( network_boost::begin(pattern), network_boost::end (pattern));
        return bmh ( corpus_first, corpus_last );
    }
    
    template <typename patIter, typename CorpusRange>
    typename network_boost::lazy_disable_if_c<
        network_boost::is_same<CorpusRange, patIter>::value, typename network_boost::range_iterator<CorpusRange> >
    ::type
    boyer_moore_horspool_search ( CorpusRange &corpus, patIter pat_first, patIter pat_last )
    {
        boyer_moore_horspool<patIter> bmh ( pat_first, pat_last );
        return bm (network_boost::begin (corpus), network_boost::end (corpus));
    }
    
    template <typename PatternRange, typename CorpusRange>
    typename network_boost::range_iterator<CorpusRange>::type
    boyer_moore_horspool_search ( CorpusRange &corpus, const PatternRange &pattern )
    {
        typedef typename network_boost::range_iterator<const PatternRange>::type pattern_iterator;
        boyer_moore_horspool<pattern_iterator> bmh ( network_boost::begin(pattern), network_boost::end (pattern));
        return bmh (network_boost::begin (corpus), network_boost::end (corpus));
    }


    //  Creator functions -- take a pattern range, return an object
    template <typename Range>
    network_boost::algorithm::boyer_moore_horspool<typename network_boost::range_iterator<const Range>::type>
    make_boyer_moore_horspool ( const Range &r ) {
        return network_boost::algorithm::boyer_moore_horspool
            <typename network_boost::range_iterator<const Range>::type> (network_boost::begin(r), network_boost::end(r));
        }
    
    template <typename Range>
    network_boost::algorithm::boyer_moore_horspool<typename network_boost::range_iterator<Range>::type>
    make_boyer_moore_horspool ( Range &r ) {
        return network_boost::algorithm::boyer_moore_horspool
            <typename network_boost::range_iterator<Range>::type> (network_boost::begin(r), network_boost::end(r));
        }
