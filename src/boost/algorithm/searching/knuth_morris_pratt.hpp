...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        knuth_morris_pratt<pattern_iterator> kmp ( network_boost::begin(pattern), network_boost::end (pattern));
        return kmp ( corpus_first, corpus_last );
    }
    ...
    {
        knuth_morris_pratt<patIter> kmp ( pat_first, pat_last );
        return kmp (network_boost::begin (corpus), network_boost::end (corpus));
    }
    ...
    template <typename Range>
    network_boost::algorithm::knuth_morris_pratt<typename network_boost::range_iterator<const Range>::type>
    make_knuth_morris_pratt ( const Range &r ) {
        return network_boost::algorithm::knuth_morris_pratt
            <typename network_boost::range_iterator<const Range>::type> (network_boost::begin(r), network_boost::end(r));
        }
    
    template <typename Range>
    network_boost::algorithm::knuth_morris_pratt<typename network_boost::range_iterator<Range>::type>
