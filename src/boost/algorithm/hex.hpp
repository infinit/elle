...
*/
struct hex_decode_error : virtual network_boost::exception, virtual std::exception {};
struct not_enough_input : virtual hex_decode_error {};
struct non_hex_input    : virtual hex_decode_error {};
typedef network_boost::error_info<struct bad_char_,char> bad_char;
...
//      We are assuming ASCII for the values - but what about the storage?
    ...
    typename network_boost::enable_if<network_boost::is_integral<typename hex_iterator_traits<OutputIterator>::value_type>, OutputIterator>::type
...
typename network_boost::enable_if<network_boost::is_integral<typename detail::hex_iterator_traits<InputIterator>::value_type>, OutputIterator>::type
...
/// \note           Based on the MySQL function of the same name
template <typename T, typename OutputIterator>
typename network_boost::enable_if<network_boost::is_integral<T>, OutputIterator>::type
...
typename network_boost::enable_if<network_boost::is_integral<typename detail::hex_iterator_traits<typename Range::iterator>::value_type>, OutputIterator>::type
hex ( const Range &r, OutputIterator out ) {
    return hex (network_boost::begin(r), network_boost::end(r), out);
}
...
OutputIterator unhex ( const Range &r, OutputIterator out ) {
    return unhex (network_boost::begin(r), network_boost::end(r), out);
    }
