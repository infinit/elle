...
//  2. Any common elements on the front have been removed (not necessary for correctness, just for performance)
    ...
    //  Skip the common prefix (if any)
        ...
        if ( first1 != last1 && first2 != last2 )
            return network_boost::algorithm::detail::is_permutation_inner ( first1, last1, first2, last2,
...
//  Skip the common prefix (if any)
    ...
    //  Create last2
        ...
        return network_boost::algorithm::detail::is_permutation_inner ( first1, last1, first2, last2, p );
        }
...
{
    return network_boost::algorithm::is_permutation (network_boost::begin (r), network_boost::end (r), first2 );
}
...
typename network_boost::disable_if_c<network_boost::is_same<Range, ForwardIterator>::value, bool>::type
is_permutation ( const Range &r, ForwardIterator first2, BinaryPredicate pred )
{
    return network_boost::algorithm::is_permutation (network_boost::begin (r), network_boost::end (r), first2, pred );
}
