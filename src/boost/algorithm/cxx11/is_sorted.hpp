...
///
    ...
    ForwardIterator is_sorted_until ( ForwardIterator first, ForwardIterator last )
    {
        ...
        return network_boost::algorithm::is_sorted_until ( first, last, std::less<value_type>());
    }
...
///
    ...
    {
        return network_boost::algorithm::is_sorted_until (first, last, p) == last;
    }
...
///
    ...
    {
        return network_boost::algorithm::is_sorted_until (first, last) == last;
    }
...
///
    ...
    typename network_boost::lazy_disable_if_c<
        network_boost::is_same<R, Pred>::value, 
        typename network_boost::range_iterator<const R> 
    >::type is_sorted_until ( const R &range, Pred p )
    {
        return network_boost::algorithm::is_sorted_until ( network_boost::begin ( range ), network_boost::end ( range ), p );
    }
...
///
    template <typename R>
    typename network_boost::range_iterator<const R>::type is_sorted_until ( const R &range )
    {
        return network_boost::algorithm::is_sorted_until ( network_boost::begin ( range ), network_boost::end ( range ));
    }
...
///
    template <typename R, typename Pred>
    typename network_boost::lazy_disable_if_c< network_boost::is_same<R, Pred>::value, network_boost::mpl::identity<bool> >::type
    is_sorted ( const R &range, Pred p )
    {
        return network_boost::algorithm::is_sorted ( network_boost::begin ( range ), network_boost::end ( range ), p );
    }
...
///
    ...
    {
        return network_boost::algorithm::is_sorted ( network_boost::begin ( range ), network_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return network_boost::algorithm::is_sorted (first, last, std::less<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        return is_increasing ( network_boost::begin ( range ), network_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return network_boost::algorithm::is_sorted (first, last, std::greater<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        return is_decreasing ( network_boost::begin ( range ), network_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return network_boost::algorithm::is_sorted (first, last, std::less_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        return is_strictly_increasing ( network_boost::begin ( range ), network_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return network_boost::algorithm::is_sorted (first, last, std::greater_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        return is_strictly_decreasing ( network_boost::begin ( range ), network_boost::end ( range ));
    }
