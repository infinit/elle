...
typename network_boost::range_iterator<Range>::type partition_point ( Range &r, Predicate p )
{
    return network_boost::algorithm::partition_point (network_boost::begin(r), network_boost::end(r), p);
}
