...
//  storage handling routines -----------------------------------------------//
            ...
            inline void copy_to_storage(
                ...
                const WhatT& What )
            {
                Storage.insert( Storage.end(), ::network_boost::begin(What), ::network_boost::end(What) );
            }
...
//  process segment routine -----------------------------------------------//
            ...
            struct process_segment_helper
            {
                    ...
                    ForwardIteratorT SegmentEnd )
                {
                    ...
                    ForwardIteratorT It=::network_boost::algorithm::detail::move_from_storage( Storage, InsertIt, SegmentBegin );
            ...
            struct process_segment_helper< true >
            {
...

                {
                    ...
                    ::network_boost::algorithm::detail::replace( Input, InsertIt, SegmentBegin, Storage );
                    // Empty the storage
                    Storage.clear();
