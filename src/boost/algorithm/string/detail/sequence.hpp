...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::network_boost::algorithm::detail::insert( Input, At, ::network_boost::begin(Insert), ::network_boost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::network_boost::algorithm::detail::replace( Input, From, To, ::network_boost::begin(Insert), ::network_boost::end(Insert) );
                }
                else
                {
                    ::network_boost::algorithm::detail::insert( Input, From, ::network_boost::begin(Insert), ::network_boost::end(Insert) );
                }
            }
