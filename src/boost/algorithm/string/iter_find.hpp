...
//  iterate find ---------------------------------------------------//
        ...
        /*!
            ...
            \param Result A 'container container' to contain the result of search.
                ...
                Typical type of the result is 
                    \c std::vector<network_boost::iterator_range<iterator>>
        ...
        */
            ...
            FinderT Finder )
        {
            ...
            input_iterator_type InputEnd=::network_boost::end(lit_input);

            typedef transform_iterator<copy_range_type, find_iterator_type>
                transform_iter_type;
    
            transform_iter_type itBegin=
                ::network_boost::make_transform_iterator( 
                    find_iterator_type( ::network_boost::begin(lit_input), InputEnd, Finder ),
                    copy_range_type());
