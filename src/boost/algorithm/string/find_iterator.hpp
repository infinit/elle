        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::network_boost::as_literal(Col));
                m_Match=::network_boost::make_iterator_range(::network_boost::begin(lit_col), ::network_boost::begin(lit_col));
                m_End=::network_boost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::network_boost::as_literal(Col));
                m_Match=make_iterator_range(::network_boost::begin(lit_col), ::network_boost::begin(lit_col));
                m_Next=::network_boost::begin(lit_col);
                m_End=::network_boost::end(lit_col);
