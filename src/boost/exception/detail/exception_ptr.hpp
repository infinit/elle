...
network_boost
    ...
    exception_ptr
        {
        typedef network_boost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    class
    unknown_exception:
        public network_boost::exception,
        ...
        explicit
        unknown_exception( network_boost::exception const & e ):
            network_boost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, network_boost::exception const & e2 ):
                T(e1),
                network_boost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<network_boost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( network_boost::exception const * e2 = get_boost_exception(&e1) )
                return network_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return network_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return network_boost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( network_boost::exception const & e )
            {
            return network_boost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( network_boost::exception const * be = get_boost_exception(&e) )
