...
namespace network_boost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename network_boost::aligned_storage<
            sizeof(value_type),
            network_boost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(network_boost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        network_boost::unordered::detail::functions<
    ...
    public:
        ...
        typedef network_boost::unordered::detail::functions<
            typename Types::hasher,
        ...
        typedef network_boost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef network_boost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef network_boost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef network_boost::unordered::iterator_detail::
        ...
        network_boost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return network_boost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? network_boost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
            ...
            return policy::new_bucket_count(
                network_boost::unordered::detail::double_to_size(floor(
        ...
        table(table& x, network_boost::unordered::detail::move_tag m) :
            functions(x, m),
        ...
        {
            network_boost::unordered::detail::array_constructor<bucket_allocator>
        ...
        {
            network_boost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x)
        {
            ...
            network_boost::swap(buckets_, x.buckets_);
            network_boost::swap(bucket_count_, x.bucket_count_);
            network_boost::swap(size_, x.size_);
        ...
        void delete_node(link_pointer prev)
        {
            ...
            network_boost::unordered::detail::func::destroy_value_impl(node_alloc(),
                n->value_ptr());
            network_boost::unordered::detail::func::destroy(network_boost::addressof(*n));
        ...
        {
            if (this != network_boost::addressof(x))
            {
                assign(x,
                    network_boost::unordered::detail::integral_constant<bool,
                        allocator_traits<node_allocator>::
