...
// network_boost::integer::static_lcm
#include <boost/integer/common_factor_ct.hpp>
// network_boost::simple_segregated_storage
#include <boost/pool/simple_segregated_storage.hpp>
// network_boost::alignment_of
...
class pool: protected simple_segregated_storage < typename UserAllocator::size_type >
{
  ...
  private:
    BOOST_STATIC_CONSTANT(size_type, min_alloc_size =
        (::network_boost::integer::static_lcm<sizeof(void *), sizeof(size_type)>::value) );
    BOOST_STATIC_CONSTANT(size_type, min_align =
        (::network_boost::integer::static_lcm< ::network_boost::alignment_of<void *>::value, ::network_boost::alignment_of<size_type>::value>::value) );
