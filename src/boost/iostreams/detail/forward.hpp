...
#define BOOST_IOSTREAMS_FORWARD(class, impl, device, params, args) \
    ...
    { this->impl(::network_boost::iostreams::detail::wrap(t) args()); } \
    class(device& t params()) \
    { this->impl(::network_boost::iostreams::detail::wrap(t) args()); } \
    class(const ::network_boost::reference_wrapper<device>& ref params()) \
    { this->impl(ref args()); } \
    void open(const device& t params()) \
    { this->impl(::network_boost::iostreams::detail::wrap(t) args()); } \
    void open(device& t params()) \
    { this->impl(::network_boost::iostreams::detail::wrap(t) args()); } \
    void open(const ::network_boost::reference_wrapper<device>& ref params()) \
    { this->impl(ref args()); } \
...
# define BOOST_IOSTREAMS_DISABLE_IF_SAME(device, param) \
    , typename network_boost::disable_if< network_boost::is_same<device, param> >::type* = 0 \
    /**/
#else 
# define BOOST_IOSTREAMS_DISABLE_IF_SAME(device, param)
#endif
