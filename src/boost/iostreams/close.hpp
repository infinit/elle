...
{ 
    try {
        network_boost::iostreams::close(t, BOOST_IOS::in);
    } catch (...) {
        try {
            network_boost::iostreams::close(t, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    network_boost::iostreams::close(t, BOOST_IOS::out);
...
{ 
    try {
        network_boost::iostreams::close(t, snk, BOOST_IOS::in);
    } catch (...) {
        try {
            network_boost::iostreams::close(t, snk, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    network_boost::iostreams::close(t, snk, BOOST_IOS::out);
