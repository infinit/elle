...
using network_boost::move_detail::remove_cv;
using network_boost::move_detail::remove_reference;
using network_boost::move_detail::add_reference;
using network_boost::move_detail::remove_pointer;
using network_boost::move_detail::add_pointer;
...
using network_boost::move_detail::is_const;
...
using network_boost::move_detail::addressof;
...
using network_boost::move_detail::apply;
using network_boost::move_detail::eval_if_c;
using network_boost::move_detail::eval_if;
using network_boost::move_detail::unvoid_ref;
using network_boost::move_detail::add_const_if_c;
...
#define BOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(TNAME)     \
   ...
   {                                                              \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));     \
                                                                  \
      typedef typename                                            \
         ::network_boost::intrusive::detail::if_c                         \
...
#define BOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(TNAME)\
   ...
   {                                                              \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));     \
                                                                  \
      typedef typename                                            \
         ::network_boost::intrusive::detail::eval_if_c                    \
            < value                                               \
            , ::network_boost::intrusive::detail::identity<T>             \
            , ::network_boost::intrusive::detail::identity<DefaultWrap>   \
            >::type::TNAME type;                                  \
   };                                                             \
//
...
#define BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(TRAITS_NAME, FUNC_NAME) \
  ...
  template<typename T> \
  static ::network_boost::intrusive::detail::yes_type test(helper<&T::FUNC_NAME>*); \
  template<typename T> static ::network_boost::intrusive::detail::no_type test(...); \
  public: \
  static const bool value = sizeof(test<U>(0)) == sizeof(::network_boost::intrusive::detail::yes_type); \
  }; \
//
...
{ \
   ...
   template <typename U> \
   static ::network_boost::intrusive::detail::no_type  test(U*, Helper<void (BaseMixin::*)(), &U::FUNC_NAME>* = 0); \
   static ::network_boost::intrusive::detail::yes_type test(...); \
   static const bool value = sizeof(::network_boost::intrusive::detail::yes_type) == sizeof(test((Base*)(0))); \
};\
//
