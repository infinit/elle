...
using network_boost::movelib::iterator_traits;
...
struct iterator_enable_if_tag
   : ::network_boost::move_detail::enable_if_c
      < ::network_boost::move_detail::is_same
         < typename network_boost::intrusive::iterator_traits<I>::iterator_category 
         , Tag
         >::value
         , R>
{};
...
struct iterator_enable_if_tag_difference_type
   : iterator_enable_if_tag<I, Tag, typename network_boost::intrusive::iterator_traits<I>::difference_type>
{};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
   : iterator_disable_if_tag<I, Tag, typename network_boost::intrusive::iterator_traits<I>::difference_type>
{};
