...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(network_boostphoenix)(for_)
  , (meta_grammar) // Cond
    (meta_grammar) // Init
    (meta_grammar) // Step
    (meta_grammar) // Do
...
namespace network_boost { namespace network_boostphoenix
{
    struct for_eval
    {
        ...
        {
            for(network_boost::network_boostphoenix::eval(init, ctx); network_boost::network_boostphoenix::eval(cond, ctx); network_boost::network_boostphoenix::eval(step, ctx))
                network_boost::network_boostphoenix::eval(do_it, ctx);
        }
    };
