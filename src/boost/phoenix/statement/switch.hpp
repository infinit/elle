...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(network_boostphoenix)(switch_case)
  , (proto::terminal<proto::_>)
    (meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(network_boostphoenix)(switch_default_case)
  , (meta_grammar)
)
...
namespace network_boost { namespace network_boostphoenix
{
    ...
    namespace detail
    {
            ...
            : proto::or_<
                proto::when<
                    proto::comma<
                      ...
                      , proto::or_<network_boostphoenix::rule::switch_default_case, network_boostphoenix::rule::switch_case>
                    >
                  , mpl::and_<
                        switch_case_is_nullary(
                            proto::_child_c<0>
        ...
        struct switch_case_grammar
            : proto::or_<
                proto::comma<switch_case_grammar, network_boostphoenix::rule::switch_case>
              , proto::when<network_boostphoenix::rule::switch_case, proto::_>
            >
        {};

        struct switch_case_with_default_grammar
            : proto::or_<
                proto::comma<switch_case_grammar, network_boostphoenix::rule::switch_default_case>
              , proto::when<network_boostphoenix::rule::switch_default_case, proto::_>
            >
        {};
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(network_boostphoenix)(switch_)
  , (meta_grammar)           // Cond
    ...
    struct switch_eval
    {
        ...
        private:
            ...
            ) const
            {
                ...
                switch(network_boost::network_boostphoenix::eval(cond, ctx))
                {
                    case case_label::value:
                        network_boost::network_boostphoenix::eval(proto::child_c<1>(cases), ctx);
                }
            }
            ...
            ) const
            {
                ...
                {
                    default:
                        network_boost::network_boostphoenix::eval(proto::child_c<0>(cases), ctx);
                }
            }
