...
namespace network_boost { namespace network_boostphoenix
{
    ...
    struct try_catch_eval
    {
        ...
        {
            network_boostphoenix::eval(proto::child_c<1>(c), ctx);
        }
        ...
        eval_catch_body(Catch const &c, Exception &e, Context const &ctx) const
        {
            ...
            typedef
                network_boostphoenix::scoped_environment<
                    env_type
                  , env_type
                  , local_type
                  , map_type
            ...
            scoped_env_tpe env(network_boostphoenix::env(ctx), network_boostphoenix::env(ctx), local);

            network_boostphoenix::eval(proto::child_c<2>(c), network_boostphoenix::context(env, network_boostphoenix::actions(ctx)));
        }
    ...
    namespace detail
    {
        struct try_catch_is_nullary
            : proto::or_<
                proto::when<
                    network_boostphoenix::rule::catch_all
                  , proto::call<
                        evaluator(
                            proto::_child_c<0>
                          , proto::_data
                ...
                >
              , proto::when<
                    network_boostphoenix::rule::catch_
                  , proto::or_<
                        proto::when<
                            network_boostphoenix::rule::captured_catch
                          , proto::call<
                                evaluator(
                                    proto::_child_c<2>
                                  , proto::call<
                                        network_boostphoenix::functional::context(
                ...
                >
              , proto::when<
                    network_boostphoenix::rule::try_catch
                  , proto::make<
                        mpl::and_<
                            proto::call<
                                evaluator(
        ...
        struct catch_push_back<TryCatch, Exception, Capture, Expr, 1>
        {
            typedef
                typename proto::result_of::make_expr<
                    network_boostphoenix::tag::catch_
            ...
            typedef
                network_boostphoenix::expression::try_catch<
                    TryCatch
                  , catch_expr
                >
                gen_type;
        ...
        struct catch_all_push_back<TryCatch, Expr, 1>
        {
            typedef
                typename proto::result_of::make_expr<
                    network_boostphoenix::tag::catch_all
                  , proto::basic_default_domain
                  , Expr
                >::type
                catch_expr;
