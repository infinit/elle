...
BOOST_PHOENIX_DEFINE_EXPRESSION_EXT(
    if_actor
  , (network_boost)(network_boostphoenix)(if_)
  , (meta_grammar) // Cond
    (meta_grammar) // Then
)
    
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (network_boost)(network_boostphoenix)(if_else_statement)
  , (meta_grammar) // Cond
    (meta_grammar) // Then
    (meta_grammar) // Else
)
...
namespace network_boost { namespace network_boostphoenix
{
    ...
    struct if_else_eval
    {
        ...
        {
            if(network_boost::network_boostphoenix::eval(cond, ctx))
                network_boost::network_boostphoenix::eval(then, ctx);
        }
        ...
        ) const
        {
            if(network_boost::network_boostphoenix::eval(cond, ctx))
                ...
                network_boost::network_boostphoenix::eval(else_, ctx);
        }
    };
