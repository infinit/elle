...
namespace network_boost {
    template <int I>
    struct is_placeholder<network_boostphoenix::argument<I> >
        : mpl::int_<I>
    {};
}
...
namespace network_boost { namespace network_boostphoenix
{
    namespace expression
    {
        template <int I>
        struct argument
            : expression::terminal<network_boostphoenix::argument<I> >
        {
            typedef typename expression::terminal<network_boostphoenix::argument<I> >::type type;
