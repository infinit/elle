...
namespace network_boost { namespace network_boostphoenix
{
    namespace detail
    {
        ...
        {
            typedef
                typename network_boost::network_boostphoenix::result_of::context<State, Data>::type
                context_type;
            ...
            {
                return Fun()(e, network_boost::network_boostphoenix::context(s, d));
            }
        };
    }
    ...
    namespace proto
    {
        ...
        struct is_callable<network_boostphoenix::call<Fun, Dummy> > : mpl::true_ {};
    }
}
