...
namespace network_boost { namespace network_boostphoenix
{
    ...
    {
        struct argument
            : proto::if_<network_boost::is_placeholder<proto::_value>()>
        {};

        struct custom_terminal
            : proto::if_<network_boost::network_boostphoenix::is_custom_terminal<proto::_value>()>
        {};
            ...
            proto::functional::at(
              ...
              , proto::make<
                    detail::placeholder_idx<
                        proto::make<
                            network_boost::is_placeholder<proto::_value>()
                        >
                    >()
                >
            )
