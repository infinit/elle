...
{
    // specialize network_boost::result_of to return the proper result type
    template <typename Expr>
    struct result_of<network_boostphoenix::actor<Expr>()>
        : network_boostphoenix::result_of::actor<typename network_boostphoenix::actor<Expr>::proto_base_expr>
    {};
    
    template <typename Expr>
    struct result_of<network_boostphoenix::actor<Expr> const()>
        : network_boostphoenix::result_of::actor<typename network_boostphoenix::actor<Expr>::proto_base_expr>
    {};
}
