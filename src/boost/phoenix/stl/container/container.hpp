...
//      ----------------                 --------------
//      my_vector.at(5)                  network_boostphoenix::at(arg1, 5)
//      my_list.size()                   network_boostphoenix::size(arg1)
//      my_vector1.swap(my_vector2)      network_boostphoenix::swap(arg1, arg2)
//
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl
    {
        ...
        namespace result_of
        {
            ...
            struct erase
            {
                ...
                //  network_boost::network_boostphoenix::stl::erase::operator() 'void' function
                //  returning a value. Oh well... :*

                typedef
                    network_boost::mpl::eval_if_c<
                      ...
                      , iterator_of<C>
#else
                      , network_boost::mpl::identity<void>
#endif
                      , size_type_of<C>
                    >
                map_erase_result;
        ...
        namespace result_of
        {
                ...
                typedef
                    network_boost::mpl::eval_if_c<
                        network_boost::mpl::and_<
                            network_boost::is_same<Arg3, mpl::void_>
                          , network_boost::mpl::not_<network_boost::is_same<Arg1, Arg2> >
                        >::value
                      , iterator_of<C>
                      , network_boost::mpl::identity<void>
                    >
            ...
            public:
                ...
                typedef typename
                    network_boost::mpl::eval_if_c<
                        network_boost::is_same<Arg2, mpl::void_>::value
                      , choice_1
                      , choice_2
                    >::type
                type;
    ...
    {
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, network_boost::network_boostphoenix::stl::assign, 2)
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, network_boost::network_boostphoenix::stl::assign, 3)
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, network_boost::network_boostphoenix::stl::assign, 4)
        BOOST_PHOENIX_ADAPT_CALLABLE(at, ::network_boost::network_boostphoenix::stl::at_impl, 2)
    ...
    using namespace network_boostphoenix::adl_barrier;
}} // namespace network_boost::network_boostphoenix
