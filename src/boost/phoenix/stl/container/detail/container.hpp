...
namespace network_boost { namespace network_boostphoenix { namespace stl
{
///////////////////////////////////////////////////////////////////////////////
//
    ...
    struct const_qualified_reference_of
    {
        typedef typename
            network_boost::mpl::eval_if_c<
                network_boost::is_const<C>::value
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl_impl
    {
        ...
        struct map_insert_returns_pair
        {
            ...
            typedef network_boost::mpl::bool_<value == sizeof(one)> type;
        };
    }
...
}}} // namespace network_boost::network_boostphoenix::stl
