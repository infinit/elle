...
#define BOOST_PHOENIX_ADAPT_CALLABLE_NULLARY(NAME, FUNC)                        \
    inline                                                                      \
    network_boost::network_boostphoenix::detail::expression::function_eval<FUNC>::type const         \
    NAME()                                                                      \
    {                                                                           \
        return network_boost::network_boostphoenix::detail::expression::                             \
...
#define BOOST_PHOENIX_ADAPT_CALLABLE(NAME, FUNC, N)                             \
    ...
    inline                                                                      \
    typename                                                                    \
        network_boost::network_boostphoenix::detail::expression::function_eval<                      \
            FUNC                                                                \
