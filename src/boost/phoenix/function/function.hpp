...
namespace network_boost { namespace network_boostphoenix
{
    ...
    struct function
    {
      ...
      // Solves the result problem for F(X)
        ...
        struct result<This(A0)>
          : detail::expression::function_eval<F,
            typename network_boost::remove_reference<A0>::type>
        {};
      // Solves the result problem for F(X,Y)
        ...
        struct result<This(A0,A1)>
          : detail::expression::function_eval<F,
            typename network_boost::remove_reference<A0>::type,
            typename network_boost::remove_reference<A1>::type>
        {};
      // Solves the result problem for F(X,Y,Z)
        ...
        struct result<This(A0,A1,A2)>
          : detail::expression::function_eval<F,
            typename network_boost::remove_reference<A0>::type,
            typename network_boost::remove_reference<A1>::type,
            typename network_boost::remove_reference<A2>::type>
        {};
      ...
      struct result<This(A0,A1,A2,A3)>
          : detail::expression::function_eval<F,
            ...
            typename network_boost::remove_reference<A1>::type,
            typename network_boost::remove_reference<A2>::type,
            typename network_boost::remove_reference<A3>::type>
         {};
      ...
      struct result<This(A0,A1,A2,A3,A4)>
          : detail::expression::function_eval<F,
            ...
            typename network_boost::remove_reference<A2>::type,
            typename network_boost::remove_reference<A3>::type,
            typename network_boost::remove_reference<A4>::type>
       {};
      ...
      struct result<This(A0,A1,A2,A3,A4,A5)>
          : detail::expression::function_eval<F,
            ...
            typename network_boost::remove_reference<A3>::type,
            typename network_boost::remove_reference<A4>::type,
            typename network_boost::remove_reference<A5>::type>
       {};
      ...
      struct result<This(A0,A1,A2,A3,A4,A5,A6)>
          : detail::expression::function_eval<F,
            ...
            typename network_boost::remove_reference<A4>::type,
            typename network_boost::remove_reference<A5>::type,
            typename network_boost::remove_reference<A6>::type>
       {};
    ...
    template<typename F>
    struct result_of<network_boostphoenix::function<F>()>
      : network_boostphoenix::detail::expression::function_eval<F>
    {};
