...
==============================================================================*/
namespace network_boost { namespace network_boostphoenix { namespace tag { struct lambda_actor {}; template <typename Ostream> inline Ostream &operator<<( Ostream & os , lambda_actor) { os << "lambda_actor"; return os; } } namespace expression { template <typename A0 , typename A1 , typename A2> struct lambda_actor : network_boost::network_boostphoenix::expr< :: network_boost :: network_boostphoenix :: tag:: lambda_actor , A0 , A1 , A2> {}; } namespace rule { struct lambda_actor : expression:: lambda_actor <proto::terminal<proto::_>, proto::terminal<proto::_>, meta_grammar> {}; } namespace functional { typedef network_boost::proto::functional::make_expr< tag:: lambda_actor > make_lambda_actor; } namespace result_of { template <typename A0 , typename A1 , typename A2> struct make_lambda_actor : network_boost::result_of< functional:: make_lambda_actor(A0 , A1 , A2) > {}; } template <typename A0 , typename A1 , typename A2> inline typename result_of::make_lambda_actor< A0 , A1 , A2 >::type const make_lambda_actor( A0 const& a0 , A1 const& a1 , A2 const& a2 ) { return functional::make_lambda_actor()( a0 , a1 , a2 ); } } } namespace network_boost { namespace network_boostphoenix { template <typename Dummy> struct meta_grammar::case_< :: network_boost :: network_boostphoenix :: tag:: lambda_actor , Dummy > : enable_rule< :: network_boost :: network_boostphoenix :: rule:: lambda_actor , Dummy > {}; } }
namespace network_boost { namespace network_boostphoenix { namespace tag { struct lambda {}; template <typename Ostream> inline Ostream &operator<<( Ostream & os , lambda) { os << "lambda"; return os; } } namespace expression { template <typename A0 , typename A1 , typename A2 , typename A3> struct lambda : network_boost::network_boostphoenix::expr< :: network_boost :: network_boostphoenix :: tag:: lambda , A0 , A1 , A2 , A3> {}; } namespace rule { struct lambda : expression:: lambda <proto::terminal<proto::_>, proto::terminal<proto::_>, proto::terminal<proto::_>, meta_grammar> {}; } namespace functional { typedef network_boost::proto::functional::make_expr< tag:: lambda > make_lambda; } namespace result_of { template <typename A0 , typename A1 , typename A2 , typename A3> struct make_lambda : network_boost::result_of< functional:: make_lambda(A0 , A1 , A2 , A3) > {}; } template <typename A0 , typename A1 , typename A2 , typename A3> inline typename result_of::make_lambda< A0 , A1 , A2 , A3 >::type const make_lambda( A0 const& a0 , A1 const& a1 , A2 const& a2 , A3 const& a3 ) { return functional::make_lambda()( a0 , a1 , a2 , a3 ); } } } namespace network_boost { namespace network_boostphoenix { template <typename Dummy> struct meta_grammar::case_< :: network_boost :: network_boostphoenix :: tag:: lambda , Dummy > : enable_rule< :: network_boost :: network_boostphoenix :: rule:: lambda , Dummy > {}; } }
namespace network_boost { namespace network_boostphoenix
{
    struct lambda_eval
    {
        ...
        operator()(OuterEnv const & outer_env, Locals const & locals, Map const &, Lambda const & lambda, Context const & ctx) const
        {
            ...
            typedef
              ...
              , map_type
            >
            env(network_boostphoenix::env(ctx), proto::value(outer_env), proto::value(locals));
            return eval(lambda, network_boostphoenix::context(env, network_boostphoenix::actions(ctx)));
        }
    };
            ...
            return
                expression::
                    lambda<env_type, locals_type, Map, Lambda>::
                        make(network_boostphoenix::env(ctx), locals, map, lambda);
        }
    };
    template <typename Dummy>
