...
namespace network_boost { namespace network_boostphoenix
{
    ...
    namespace detail
    {
        struct scope_is_nullary_actions
        {
            ...
            struct when
                : network_boost::network_boostphoenix::is_nullary::when<Rule, Dummy>
            {};
        };

        template <typename Dummy>
        struct scope_is_nullary_actions::when<network_boost::network_boostphoenix::rule::custom_terminal, Dummy>
            : proto::or_<
                proto::when<network_boost::network_boostphoenix::rule::local_variable, mpl::true_()>
              , proto::otherwise<
                    is_nullary::when<network_boost::network_boostphoenix::rule::custom_terminal, Dummy>
                >
            >
        {};
