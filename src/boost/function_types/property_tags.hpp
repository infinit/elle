...
namespace network_boost { namespace function_types { 
...
namespace detail 
{
  ...
  template<bits_t Value> struct constant 
    : network_boost::integral_constant<bits_t,Value> 
  { };
  ...
  template<bits_t Bits, bits_t CCID> struct encode_bits
    : constant< 
        ::network_boost::function_types::detail::encode_bits_impl<Bits,CCID>::value 
      >
  { };
  ...
  {
    typedef constant<
      ::network_boost::function_types::detail::tag_ice
        < ::network_boost::function_types::detail::bits<LHS>::value
        , ::network_boost::function_types::detail::mask<LHS>::value
        , ::network_boost::function_types::detail::bits<RHS>::value
        , ::network_boost::function_types::detail::mask<RHS>::value
        >::combined_bits 
    > bits;
  ...
  template<class Tag, class QueryTag> struct represents_impl
    : network_boost::integral_constant<bool,
        ::network_boost::function_types::detail::tag_ice
          < ::network_boost::function_types::detail::bits<Tag>::value
          , ::network_boost::function_types::detail::mask<Tag>::value
          , ::network_boost::function_types::detail::bits<QueryTag>::value
          , ::network_boost::function_types::detail::mask<QueryTag>::value
          >::match
      >
  { };
...
} } // namespace ::network_boost::function_types
