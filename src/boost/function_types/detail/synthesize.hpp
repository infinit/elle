...
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::network_boost::function_types::detail::decode_bits<Bits>::flags
    , ::network_boost::function_types::detail::decode_bits<Bits>::cc_id
    , ::network_boost::mpl::size<Seq>::value
    >
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::network_boost::function_types::detail::bits
