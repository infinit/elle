...
namespace network_boost { namespace function_types { namespace detail {
...
struct cv_code
{
  ...
  BOOST_STATIC_CONSTANT(std::size_t, value = 
      sizeof(::network_boost::function_types::detail::switch_cv(
         ::network_boost::function_types::detail::ref_to_ptr(_t) ) ));
};

template<typename T> struct cv_traits 
{
  typedef typename network_boost::function_types::detail::cv_tag_impl< 
    ::network_boost::function_types::detail::cv_code<T>::value >::type
  tag;
...
} } } // namespace network_boost::function_types::detail
