...
{
   typedef typename network_boost::int_t<sizeof(way) * CHAR_BIT>::least cast_type;
...
void cpp_regex_traits_char_layer<charT>::init()
{
   ...
   if(cat_name.size() && (this->m_pmessages != 0))
   {
      ...
      if((int)cat < 0)
      {
         ...
         network_boost::BOOST_REGEX_DETAIL_NS::raise_runtime_error(err);
      }
   }
   //
...
public:
   ...
   typedef typename network_boost::make_unsigned<native_mask_type>::type  unsigned_native_mask_type;
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      // Error messages:
      //
      for(network_boost::regex_constants::error_type i = static_cast<network_boost::regex_constants::error_type>(0); 
         i <= network_boost::regex_constants::error_unknown; 
         i = static_cast<network_boost::regex_constants::error_type>(i + 1))
      {
      ...
      static const char_class_type masks[16] = 
      {
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_alnum,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_alpha,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_cntrl,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_digit,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_graph,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_lower,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_print,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_punct,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_space,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_upper,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_blank,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_word,
         ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_upper,
      ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
      ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::network_boost::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_word) && (c == '_'))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_unicode) && ::network_boost::BOOST_REGEX_DETAIL_NS::is_extended(c))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::network_boost::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline network_boost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l)
{
   cpp_regex_traits_base<charT> key(l);
   return ::network_boost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
public:
   ...
   bool isctype(charT c, char_class_type f) const
   {
      ...
      if((f & mask_base) 
         ...
         && (::network_boost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v')))
         return true;
...
private:
   network_boost::shared_ptr<const BOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
