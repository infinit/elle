...
namespace network_boost{ namespace BOOST_REGEX_DETAIL_NS{
...
inline bool is_separator(charT c)
{
   return BOOST_REGEX_MAKE_BOOL(
      ...
      || (static_cast<network_boost::uint16_t>(c) == 0x2028u)
      || (static_cast<network_boost::uint16_t>(c) == 0x2029u)
      || (static_cast<network_boost::uint16_t>(c) == 0x85u));
}
template <>
