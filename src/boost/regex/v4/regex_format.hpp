...
struct trivial_format_traits
{
   ...
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::global_lower(c);
   }
   static charT toupper(charT c)
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::global_upper(c);
   }
...
private:
   ...
   {
      typedef typename network_boost::is_convertible<ForwardIter, const char_type*>::type tag_type;
...
#endif
   inline int toi(ForwardIter& i, ForwardIter j, int base, const network_boost::mpl::false_&)
   {
      if(i != j)
      {
         std::vector<char_type> v(i, j);
...
#pragma warning(pop)
#endif
   inline int toi(ForwardIter& i, ForwardIter j, int base, const network_boost::mpl::true_&)
   {
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_all()
{
   ...
   while(m_position != m_end)
   {
      ...
      {
      case '&':
         if(m_flags & ::network_boost::regex_constants::format_sed)
         {
            ++m_position;
            put(m_results[0]);
            break;
      ...
      case '\\':
         ...
         break;
      case '(':
         if(m_flags & network_boost::regex_constants::format_all)
         {
            ++m_position;
      ...
      case ')':
         ...
         break;
      case ':':
         if((m_flags & network_boost::regex_constants::format_all) && m_have_conditional)
         {
            return;
         }
         put(*m_position);
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_perl()
{
   ...
   default:
      ...
      {
         std::ptrdiff_t len = ::network_boost::BOOST_REGEX_DETAIL_NS::distance(m_position, m_end);
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_escape()
{
   ...
   default:
      ...
      if((m_flags & network_boost::regex_constants::format_sed) == 0)
      {
         bool breakout = false;
         switch(*m_position)
         {
      ...
      int v = this->toi(m_position, m_position+len, 10);
      if((v > 0) || ((v == 0) && (m_flags & ::network_boost::regex_constants::format_sed)))
      {
         put(m_results[v]);
         break;
      }
      else if(v == 0)
      {
         ...
         --m_position;
         len = ::network_boost::BOOST_REGEX_DETAIL_NS::distance(m_position, m_end);
...
template<typename Formatter, bool IsFunction = network_boost::is_function<Formatter>::value>
...
private:
   ...
   //
   BOOST_STATIC_ASSERT((::network_boost::is_pointer<F>::value || ::network_boost::is_function<F>::value || ::network_boost::is_class<F>::value));
   static formatter_wrapper<typename unwrap_reference<F>::type> f;
   static M m;
   static O out;
   static network_boost::regex_constants::match_flag_type flags;
public:
...
public:
   ...
   //
   typedef typename network_boost::mpl::if_<
      network_boost::mpl::and_<network_boost::is_pointer<F>, network_boost::mpl::not_<network_boost::is_function<typename network_boost::remove_pointer<F>::type> > >,
      network_boost::mpl::int_<0>,
      typename network_boost::mpl::if_<
         has_const_iterator<F>,
         network_boost::mpl::int_<1>,
         network_boost::mpl::int_<format_traits_imp<F, M, O>::value>
      >::type
   >::type type;
   //
   ...
   //
   BOOST_STATIC_ASSERT( network_boost::is_class<F>::value && !has_const_iterator<F>::value ? (type::value > 1) : true);
};
...
struct format_functor3
{
   ...
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type f)
   {
      return network_boost::unwrap_ref(func)(m, i, f);
   }
   template <class OutputIter, class Traits>
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type f, const Traits&)
   {
      return (*this)(m, i, f);
   }
private:
...
struct format_functor2
{
   ...
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type /*f*/)
   {
      return network_boost::unwrap_ref(func)(m, i);
   }
   template <class OutputIter, class Traits>
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type f, const Traits&)
   {
...
struct format_functor1
{
   ...
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type /*f*/)
   {
      return do_format_string(network_boost::unwrap_ref(func)(m), i);
   }
   template <class OutputIter, class Traits>
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type f, const Traits&)
   {
...
struct format_functor_c_string
{
   ...
   template <class OutputIter>
   OutputIter operator()(const Match& m, OutputIter i, network_boost::regex_constants::match_flag_type f, const Traits& t = Traits())
   {
...
struct compute_functor_type
{
   ...
   typedef typename network_boost::remove_cv< typename network_boost::remove_pointer<Func>::type>::type maybe_char_type;

   typedef typename mpl::if_<
      ::network_boost::is_same<tag, mpl::int_<0> >, format_functor_c_string<maybe_char_type, Match, Traits>,
      typename mpl::if_<
         ::network_boost::is_same<tag, mpl::int_<1> >, format_functor_container<Func, Match, Traits>,
         typename mpl::if_<
            ::network_boost::is_same<tag, mpl::int_<2> >, format_functor1<Func, Match>,
            typename mpl::if_<
               ::network_boost::is_same<tag, mpl::int_<3> >, format_functor2<Func, Match>, 
