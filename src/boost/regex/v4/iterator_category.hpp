...
public:
   BOOST_STATIC_CONSTANT(bool, value = (::network_boost::is_convertible<cat*, std::random_access_iterator_tag*>::value));
#else
...
{
private:
   typedef detail::is_random_imp_selector< ::network_boost::is_pointer<I>::value> selector;
