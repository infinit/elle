...
// error checking API:
//
BOOST_REGEX_DECL void BOOST_REGEX_CALL verify_options(network_boost::regex_constants::syntax_option_type ef, match_flag_type mf);
//
// function can_start:
//
...
{   
   ...
   const ::network_boost::regex_traits_wrapper<traits_type>& traits_inst = *(e.m_ptraits);
...
private:
   ...
   {
      return ::network_boost::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::network_boost::regex_traits_wrapper<traits>& traits_inst;
