...
//
typedef ::network_boost::uint32_t lcid_type;   // placeholder for LCID.
typedef ::network_boost::shared_ptr<void> cat_type; // placeholder for dll HANDLE.
...
#endif
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type, network_boost::uint32_t mask, char c);
#ifndef BOOST_NO_WREGEX
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type, network_boost::uint32_t mask, wchar_t c);
#ifdef BOOST_REGEX_HAS_OTHER_WCHAR_T
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type state_id, network_boost::uint32_t m, unsigned short c);
#endif
#endif
//
...
public:
   ...
   regex_constants::escape_syntax_type escape_syntax_type(charT c) const
   {
      ...
      if(i == m_char_map.end())
      {
         if(::network_boost::BOOST_REGEX_DETAIL_NS::w32_is_lower(c, this->m_locale)) return regex_constants::escape_type_class;
         if(::network_boost::BOOST_REGEX_DETAIL_NS::w32_is_upper(c, this->m_locale)) return regex_constants::escape_type_not_class;
         return 0;
      }
      return i->second;
   }
   ...
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::w32_tolower(c, this->m_locale);
   }
   bool isctype(network_boost::uint32_t mask, charT c)const
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::w32_is(this->m_locale, mask, c);
   }
...
template <class charT>
w32_regex_traits_char_layer<charT>::w32_regex_traits_char_layer(::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type l) 
   : w32_regex_traits_base<charT>(l)
{
   ...
   if(cat_name.size())
   {
      cat = ::network_boost::BOOST_REGEX_DETAIL_NS::w32_cat_open(cat_name);
      if(!cat)
      {
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::network_boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, i, get_default_message(i));
...
public:
   w32_regex_traits_char_layer(::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type l)
   ...
   bool isctype(network_boost::uint32_t mask, char c)const
   {
...
private:
   ...
   network_boost::uint16_t m_type_map[1u << CHAR_BIT];
   void init();
};
...
public:
   ...
   w32_regex_traits_implementation(::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type l);
   ...
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::w32_transform(this->m_locale, p1, p2);
   }
private:
...
template <class charT>
w32_regex_traits_implementation<charT>::w32_regex_traits_implementation(::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type l)
: w32_regex_traits_char_layer<charT>(l)
{
   ...
   if(cat)
   {
         ...
         i = static_cast<network_boost::regex_constants::error_type>(i + 1))
      {
         ...
         string_type s = ::network_boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, i+200, default_message);
         std::string result;
      ...
      {
         string_type s(::network_boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, j+300, null_string));
         if(s.size())
...
template <class charT>
network_boost::shared_ptr<const w32_regex_traits_implementation<charT> > create_w32_regex_traits(::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type l)
{
   // TODO: create a cache for previously constructed objects.
   return network_boost::object_cache< ::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type, w32_regex_traits_implementation<charT> >::get(l, 5);
}
...
public:
   ...
   typedef ::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type locale_type;
   typedef network_boost::uint_least32_t         char_class_type;

   struct boost_extensions_tag{};

   w32_regex_traits()
      : m_pimpl(BOOST_REGEX_DETAIL_NS::create_w32_regex_traits<charT>(::network_boost::BOOST_REGEX_DETAIL_NS::w32_get_default_locale()))
   { }
   ...
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::w32_toupper(c, this->m_pimpl->m_locale);
   }
   string_type transform(const charT* p1, const charT* p2) const
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::w32_transform(this->m_pimpl->m_locale, p1, p2);
   }
   string_type transform_primary(const charT* p1, const charT* p2) const
   {
   ...
   {
      return ::network_boost::BOOST_REGEX_DETAIL_NS::global_toi(p1, p2, radix, *this);
   }
   int value(charT c, int radix)const
   {
      int result = ::network_boost::BOOST_REGEX_DETAIL_NS::global_value(c);
      return result < radix ? result : -1;
   }
   locale_type imbue(locale_type l)
   {
      ::network_boost::BOOST_REGEX_DETAIL_NS::lcid_type result(getloc());
...
private:
   network_boost::shared_ptr<const BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT> > m_pimpl;
   //
