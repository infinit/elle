...
class BOOST_REGEX_DECL icu_regex_traits_implementation
{
   ...
   typedef network_boost::uint_least32_t        char_class_type;
public:
...
private:
   ...
   network_boost::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_collator;          // The full collation object
   network_boost::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_primary_collator;  // The primary collation object
};

inline network_boost::shared_ptr<icu_regex_traits_implementation> get_icu_regex_traits_implementation(const U_NAMESPACE_QUALIFIER Locale& loc)
{
   return network_boost::shared_ptr<icu_regex_traits_implementation>(new icu_regex_traits_implementation(loc));
}
...
public:
...
#else
   typedef network_boost::uint64_t              char_class_type;
#endif
   ...
   ::network_boost::regex_constants::syntax_type syntax_type(char_type c)const
   {
      return ((c < 0x7f) && (c > 0)) ? BOOST_REGEX_DETAIL_NS::get_default_syntax_type(static_cast<char>(c)) : regex_constants::syntax_char;
   }
   ::network_boost::regex_constants::escape_syntax_type escape_syntax_type(char_type c) const
   {
   ...
   std::string error_string(::network_boost::regex_constants::error_type n) const
   {
...
private:
   ...
   network_boost::shared_ptr< ::network_boost::BOOST_REGEX_DETAIL_NS::icu_regex_traits_implementation> m_pimpl;
};
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              network_boost::regex_constants::syntax_option_type opt, 
                              const network_boost::mpl::int_<1>*)
{
   typedef network_boost::u8_to_u32_iterator<InputIterator, UChar32> conv_type;
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              network_boost::regex_constants::syntax_option_type opt, 
                              const network_boost::mpl::int_<2>*)
{
   typedef network_boost::u16_to_u32_iterator<InputIterator, UChar32> conv_type;
   return u32regex(conv_type(i, i, j), conv_type(j, i, j), opt);
}
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              network_boost::regex_constants::syntax_option_type opt, 
                              const network_boost::mpl::int_<4>*)
{
...
inline u32regex make_u32regex(InputIterator i, 
                              ...
                              network_boost::regex_constants::syntax_option_type opt)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(i, j, opt, static_cast<network_boost::mpl::int_<sizeof(*i)> const*>(0));
}
//
// construction from UTF-8 nul-terminated strings:
//
inline u32regex make_u32regex(const char* p, network_boost::regex_constants::syntax_option_type opt = network_boost::regex_constants::perl)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + std::strlen(p), opt, static_cast<network_boost::mpl::int_<1> const*>(0));
}
inline u32regex make_u32regex(const unsigned char* p, network_boost::regex_constants::syntax_option_type opt = network_boost::regex_constants::perl)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + std::strlen(reinterpret_cast<const char*>(p)), opt, static_cast<network_boost::mpl::int_<1> const*>(0));
}
//
// construction from UTF-16 nul-terminated strings:
//
#ifndef BOOST_NO_WREGEX
inline u32regex make_u32regex(const wchar_t* p, network_boost::regex_constants::syntax_option_type opt = network_boost::regex_constants::perl)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + std::wcslen(p), opt, static_cast<network_boost::mpl::int_<sizeof(wchar_t)> const*>(0));
}
#endif
#if !defined(U_WCHAR_IS_UTF16) && (U_SIZEOF_WCHAR_T != 2)
inline u32regex make_u32regex(const UChar* p, network_boost::regex_constants::syntax_option_type opt = network_boost::regex_constants::perl)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + u_strlen(p), opt, static_cast<network_boost::mpl::int_<2> const*>(0));
}
#endif
//
...
inline u32regex make_u32regex(const std::basic_string<C, T, A>& s, network_boost::regex_constants::syntax_option_type opt = network_boost::regex_constants::perl)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(s.begin(), s.end(), opt, static_cast<network_boost::mpl::int_<sizeof(C)> const*>(0));
}
//
// Construction from ICU string type:
//
inline u32regex make_u32regex(const U_NAMESPACE_QUALIFIER UnicodeString& s, network_boost::regex_constants::syntax_option_type opt = network_boost::regex_constants::perl)
{
   return BOOST_REGEX_DETAIL_NS::do_make_u32regex(s.getBuffer(), s.getBuffer() + s.length(), opt, static_cast<network_boost::mpl::int_<2> const*>(0));
}
...
inline bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 network_boost::mpl::int_<4> const*)
{
   return ::network_boost::regex_match(first, last, m, e, flags);
}
template <class BidiIterator, class Allocator>
bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 const u32regex& e, 
                 match_flag_type flags,
                 network_boost::mpl::int_<2> const*)
{
   typedef u16_to_u32_iterator<BidiIterator, UChar32> conv_type;
   typedef match_results<conv_type>                   match_type;
   //typedef typename match_type::allocator_type        alloc_type;
   match_type what;
   bool result = ::network_boost::regex_match(conv_type(first, first, last), conv_type(last, first, last), what, e, flags);
...
bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 const u32regex& e, 
                 match_flag_type flags,
                 network_boost::mpl::int_<1> const*)
{
...
inline bool do_regex_search(BidiIterator first, BidiIterator last, 
                 ...
                 network_boost::mpl::int_<4> const*)
{
   return ::network_boost::regex_search(first, last, m, e, flags, base);
}
template <class BidiIterator, class Allocator>
                 ...
                 network_boost::mpl::int_<2> const*)
{
   ...
   //typedef typename match_type::allocator_type        alloc_type;
   match_type what;
   bool result = ::network_boost::regex_search(conv_type(first, first, last), conv_type(last, first, last), what, e, flags, conv_type(base));
   // copy results across to m:
   if(result) copy_results(m, what);
   return result;
}
...
namespace BOOST_REGEX_DETAIL_NS{
template <class I>
inline std::pair< network_boost::u8_to_u32_iterator<I>, network_boost::u8_to_u32_iterator<I> >
   make_utf32_seq(I i, I j, mpl::int_<1> const*)
{
   return std::pair< network_boost::u8_to_u32_iterator<I>, network_boost::u8_to_u32_iterator<I> >(network_boost::u8_to_u32_iterator<I>(i, i, j), network_boost::u8_to_u32_iterator<I>(j, i, j));
}
template <class I>
inline std::pair< network_boost::u16_to_u32_iterator<I>, network_boost::u16_to_u32_iterator<I> >
   make_utf32_seq(I i, I j, mpl::int_<2> const*)
{
   return std::pair< network_boost::u16_to_u32_iterator<I>, network_boost::u16_to_u32_iterator<I> >(network_boost::u16_to_u32_iterator<I>(i, i, j), network_boost::u16_to_u32_iterator<I>(j, i, j));
}
template <class I>
inline std::pair< I, I >
...
inline std::pair< network_boost::u8_to_u32_iterator<const charT*>, network_boost::u8_to_u32_iterator<const charT*> >
   make_utf32_seq(const charT* p, mpl::int_<1> const*)
{
   std::size_t len = std::strlen((const char*)p);
   return std::pair< network_boost::u8_to_u32_iterator<const charT*>, network_boost::u8_to_u32_iterator<const charT*> >(network_boost::u8_to_u32_iterator<const charT*>(p, p, p+len), network_boost::u8_to_u32_iterator<const charT*>(p+len, p, p+len));
}
template <class charT>
inline std::pair< network_boost::u16_to_u32_iterator<const charT*>, network_boost::u16_to_u32_iterator<const charT*> >
   make_utf32_seq(const charT* p, mpl::int_<2> const*)
{
   std::size_t len = u_strlen((const UChar*)p);
   return std::pair< network_boost::u16_to_u32_iterator<const charT*>, network_boost::u16_to_u32_iterator<const charT*> >(network_boost::u16_to_u32_iterator<const charT*>(p, p, p + len), network_boost::u16_to_u32_iterator<const charT*>(p+len, p, p + len));
}
template <class charT>
                                 ...
                                 )
{
   ...
   else
   {
      ...
      while(i != j)
      {
         ...
         if(f.size())
            out = ::network_boost::BOOST_REGEX_DETAIL_NS::regex_format_imp(out, *i, &*f.begin(), &*f.begin() + f.size(), flags, e.get_traits());
         else
            out = ::network_boost::BOOST_REGEX_DETAIL_NS::regex_format_imp(out, *i, static_cast<UChar32 const*>(0), static_cast<UChar32 const*>(0), flags, e.get_traits());
         last_m = (*i)[0].second;
