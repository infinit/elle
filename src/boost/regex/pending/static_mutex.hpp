...
// because network_boost::call_once doesn't alow us to pass instance information
...
class BOOST_REGEX_DECL scoped_static_mutex_lock;
extern "C" BOOST_REGEX_DECL void network_boost_regex_free_static_mutex();
...
public:
   typedef scoped_static_mutex_lock scoped_lock;
   static void init();
   static network_boost::recursive_mutex* m_pmutex;
   static network_boost::once_flag m_once;
};
...
public:
   ...
   void unlock();
private:
   network_boost::unique_lock<network_boost::recursive_mutex>* m_plock;
   bool m_have_lock;
};
