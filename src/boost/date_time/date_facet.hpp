...
namespace network_boost { namespace date_time {
  ...
  public:
    ...
    typedef network_boost::date_time::period<date_type,duration_type> period_type;
    typedef std::basic_string<CharT> string_type;
    typedef CharT                    char_type;
    typedef network_boost::date_time::period_formatter<CharT>  period_formatter_type;
    typedef network_boost::date_time::special_values_formatter<CharT>  special_values_formatter_type;
  ...
  protected:
    virtual OutItrT do_put_special(OutItrT next,
                                   std::ios_base& /*a_ios*/,
                                   char_type /*fill_char*/,
                                   const network_boost::date_time::special_values sv) const
    {
                              ...
                              string_type a_format) const
    {
      ...
      if (m_weekday_long_names.size()) {
        network_boost::algorithm::replace_all(a_format,
                                      long_weekday_format,
  ...
  public:
    ...
    typedef std::basic_string<CharT> string_type;
    typedef CharT                    char_type;
    typedef network_boost::date_time::period_parser<date_type, CharT>  period_parser_type;
    typedef network_boost::date_time::special_values_parser<date_type,CharT> special_values_parser_type;
    typedef std::vector<std::basic_string<CharT> > input_collection_type;
               ...
               duration_type& dd) const
    {
      ...
      if(err & std::ios_base::failbit){
        ...
        if(mr.current_match == match_results::PARSE_ERROR) {
          network_boost::throw_exception(std::ios_base::failure("Parse failed. No match found for '" + mr.cache + "'"));
