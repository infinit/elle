...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            network_boost::uint32_t dwLowDateTime;
            network_boost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            network_boost::uint16_t wYear;
            network_boost::uint16_t wMonth;
            network_boost::uint16_t wDayOfWeek;
            network_boost::uint16_t wDay;
            network_boost::uint16_t wHour;
            network_boost::uint16_t wMinute;
            network_boost::uint16_t wSecond;
            network_boost::uint16_t wMilliseconds;
        };
     ...
     *       network_boost::date_time::winapi::file_time type.
     */
    template< typename FileTimeT >
    inline network_boost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
