...
#define BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<network_boost::date_time::time_resolution_traits_adapted64_impl, network_boost::date_time::nano,
...
#undef  BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    network_boost::date_time::time_resolution_traits_adapted64_impl, network_boost::date_time::micro,
...
// #undef BOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<network_boost::int64_t, network_boost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(network_boost::date_time::special_values sv) :
...
#else
    BOOST_STATIC_CONSTANT(network_boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef network_boost::int64_t time_rep_type;
...
#if (defined(BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    BOOST_STATIC_CONSTANT(network_boost::int64_t, tick_per_second = 1000000);
#endif
  };
