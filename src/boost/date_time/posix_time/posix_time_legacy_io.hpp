...
//The following code is removed for configurations with poor std::locale support (eg: MSVC6, gcc 2.9x)
  ...
  {
    typedef network_boost::date_time::ostream_time_duration_formatter<time_duration, charT> duration_formatter;
  ...
  {
    typedef network_boost::date_time::ostream_time_formatter<ptime, charT> time_formatter;
  ...
  {
    typedef network_boost::date_time::ostream_time_period_formatter<time_period, charT> period_formatter;
