...
namespace posix_time {
  ...
  //typedef network_boost::date_time::time_facet<ptime, wchar_t> wptime_facet;
  //! ptime_facet is depricated and will be phased out. use time_facet instead
  //typedef network_boost::date_time::time_facet<ptime, char>     ptime_facet;

  //! wptime_input_facet is depricated and will be phased out. use wtime_input_facet instead
  //typedef network_boost::date_time::time_input_facet<ptime,wchar_t> wptime_input_facet;
  //! ptime_input_facet is depricated and will be phased out. use time_input_facet instead
  //typedef network_boost::date_time::time_input_facet<ptime,char>     ptime_input_facet;

  typedef network_boost::date_time::time_facet<ptime, wchar_t>     wtime_facet;
  typedef network_boost::date_time::time_facet<ptime, char>         time_facet;

  typedef network_boost::date_time::time_input_facet<ptime, wchar_t>     wtime_input_facet;
  typedef network_boost::date_time::time_input_facet<ptime, char>         time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
    ...
    typedef network_boost::date_time::time_facet<ptime, CharT> custom_ptime_facet;
  ...
  std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
             const network_boost::posix_time::time_period& p) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::time_facet<ptime, CharT> custom_ptime_facet;
    std::ostreambuf_iterator<CharT> oitr(os);
    if (std::has_facet<custom_ptime_facet>(os.getloc())) {
