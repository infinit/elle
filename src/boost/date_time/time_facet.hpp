...
namespace date_time {
  ...
  class time_facet :
    public network_boost::date_time::date_facet<typename time_type::date_type , CharT, OutItrT> {
    typedef time_formats< CharT > formats_type;
   public:
    typedef typename time_type::date_type date_type;
    typedef typename time_type::time_duration_type time_duration_type;
    typedef network_boost::date_time::period<time_type,time_duration_type> period_type;
    typedef network_boost::date_time::date_facet<typename time_type::date_type, CharT, OutItrT> base_type;
                ...
                const time_type& time_arg) const
    {
      ...
      network_boost::algorithm::replace_all(local_format,
        network_boost::as_literal(formats_type::full_24_hour_time_format),
        network_boost::as_literal(formats_type::full_24_hour_time_expanded_format));
      network_boost::algorithm::replace_all(local_format,
        network_boost::as_literal(formats_type::short_24_hour_time_format),
        network_boost::as_literal(formats_type::short_24_hour_time_expanded_format));
      ...
      if (local_format.find(posix_zone_string_format) != string_type::npos) {
        if(time_arg.zone_abbrev().empty()) {
          ...
          network_boost::algorithm::erase_all(local_format, posix_zone_string_format);
        }
        else{
          network_boost::algorithm::replace_all(local_format,
      ...
      if (local_format.find(zone_name_format) != string_type::npos) {
        if(time_arg.zone_name().empty()) {
          ...
          ss << ' ' << zone_name_format;
          network_boost::algorithm::erase_all(local_format, ss.str());
        }
        else{
          network_boost::algorithm::replace_all(local_format,
                                        zone_name_format,
      ...
      if (local_format.find(zone_iso_extended_format) != string_type::npos) {
        if(time_arg.zone_name(true).empty()) {
          ...
          network_boost::algorithm::erase_all(local_format, zone_iso_extended_format);
        }
        else{
          network_boost::algorithm::replace_all(local_format,
      ...
      if (local_format.find(zone_iso_format) != string_type::npos) {
        if(time_arg.zone_abbrev(true).empty()) {
          ...
          network_boost::algorithm::erase_all(local_format, zone_iso_format);
        }
        else{
          network_boost::algorithm::replace_all(local_format,
                                        zone_iso_format,
      ...
      if (local_format.find(fractional_seconds_or_none_format) != string_type::npos) {
        ...
        if (frac_str.size()) {
          ...
          network_boost::algorithm::erase_all(local_format,
                                      fractional_seconds_or_none_format);
        }
      }
                ...
                const time_duration_type& time_dur_arg) const
    {
      ...
      if (time_dur_arg.is_negative()) {
        ...
        network_boost::algorithm::replace_all(format,
        ...
        network_boost::algorithm::erase_all(format, duration_sign_negative_only);
        // remove all the %+ in the string with '+'
        network_boost::algorithm::replace_all(format,
                                      duration_sign_always,
                                      positive_sign);
      ...
      if (format.find(unrestricted_hours_format) != string_type::npos) {
        ...
        network_boost::algorithm::replace_all(format, unrestricted_hours_format, hours_str);
      }
      ...
      if (format.find(hours_format) != string_type::npos) {
        ...
        network_boost::algorithm::replace_all(format, hours_format, hours_str);
      }
      ...
      if (format.find(fractional_seconds_or_none_format) != string_type::npos) {
        ...
        if (frac_str.size()) {
          ...
          network_boost::algorithm::erase_all(format,
                                      fractional_seconds_or_none_format);
        }
      }
  ...
  protected:
    ...
    integral_as_string(IntT val, int width = 2)
    {
      ...
      char_type buff[34];
      ss << _i64toa(static_cast<network_boost::int64_t>(val), buff, 10);
#else
      ss << val;
#endif
      return ss.str();
  ...
  class time_input_facet :
    public network_boost::date_time::date_input_facet<typename time_type::date_type , CharT, InItrT> {
    public:
      typedef typename time_type::date_type date_type;
      typedef typename time_type::time_duration_type time_duration_type;
      typedef typename time_duration_type::fractional_seconds_type fracional_seconds_type;
      typedef network_boost::date_time::period<time_type,time_duration_type> period_type;
      typedef network_boost::date_time::date_input_facet<typename time_type::date_type, CharT, InItrT> base_type;
    ...
    protected:
      ...
      InItrT check_special_value(InItrT& sitr,InItrT& stream_end, temporal_type& tt, char_type c='\0') const
      {
        ...
        if(mr.current_match == match_results::PARSE_ERROR) {
          ...
          network_boost::throw_exception(std::ios_base::failure("Parse failed. No match found for '" + tmp + "'"));
