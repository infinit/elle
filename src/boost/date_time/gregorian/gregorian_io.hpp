...
namespace gregorian {
  ...
  typedef network_boost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef network_boost::date_time::period_formatter<char>    period_formatter;
  
  typedef network_boost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef network_boost::date_time::date_facet<date,char>    date_facet;

  typedef network_boost::date_time::period_parser<date,char>       period_parser;
  typedef network_boost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef network_boost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef network_boost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef network_boost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef network_boost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef network_boost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef network_boost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::date& d) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    network_boost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::date_duration& dd) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::date_period& dp) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::greg_month& gm) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::greg_weekday& gw) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::partial_date& pd) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::nth_day_of_the_week_in_month& nkd) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::first_day_of_the_week_in_month& fkd) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::last_day_of_the_week_in_month& lkd) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::first_day_of_the_week_after& fda) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const network_boost::gregorian::first_day_of_the_week_before& fdb) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
