...
namespace local_time {
  ...
  //typedef network_boost::date_time::time_zone_names time_zone_names;
  typedef network_boost::date_time::dst_adjustment_offsets<network_boost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef network_boost::date_time::time_zone_base<network_boost::posix_time::ptime> time_zone;
  typedef network_boost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,
                     ...
                     network_boost::shared_ptr<dst_calc_rule> calc_rule) :
