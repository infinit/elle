...
namespace local_time {
  ...
  typedef network_boost::date_time::period<local_date_time, 
                                   network_boost::posix_time::time_duration> local_time_period;
  ...
  typedef network_boost::shared_ptr<time_zone> time_zone_ptr;
  typedef network_boost::shared_ptr<wtime_zone> wtime_zone_ptr;
