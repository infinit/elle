...
namespace local_time {
  ...
  typedef network_boost::date_time::time_facet<local_date_time, wchar_t> wlocal_time_facet;
  typedef network_boost::date_time::time_facet<local_date_time, char>     local_time_facet;

  typedef network_boost::date_time::time_input_facet<local_date_time::utc_time_type,wchar_t> wlocal_time_input_facet;
  typedef network_boost::date_time::time_input_facet<local_date_time::utc_time_type,char>     local_time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
             const network_boost::local_time::local_time_period& p) {
    network_boost::io::ios_flags_saver iflags(os);
    typedef network_boost::date_time::time_facet<local_date_time, CharT> custom_facet;
    std::ostreambuf_iterator<CharT> oitr(os);
  ...
  inline
  std::basic_istream<CharT, Traits>&
  operator>>(std::basic_istream<CharT, Traits>& is, network_boost::local_time::local_time_period& tp)
  {
    network_boost::io::ios_flags_saver iflags(is);
    typename std::basic_istream<CharT, Traits>::sentry strm_sentry(is, false);
    if (strm_sentry) {
