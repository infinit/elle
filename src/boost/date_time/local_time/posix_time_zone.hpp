...
namespace local_time{
  ...
  typedef network_boost::date_time::dst_adjustment_offsets<network_boost::posix_time::time_duration> dst_adjustment_offsets;
   ...
   * A network_boost::local_time::bad_offset exception will be thrown for:<br>
   ...
   * A network_boost::local_time::bad_adjustment exception will be thrown for:<br>
  ...
  public:
    typedef network_boost::posix_time::time_duration time_duration_type;
    ...
    virtual string_type to_posix_string() const
    {
      ...
      ss.fill('0');
      network_boost::shared_ptr<dst_calc_rule> no_rules;
      // std
      ss << std_zone_abbrev();
      // offset
  ...
  private:
    ...
    network_boost::shared_ptr<dst_calc_rule> dst_calc_rules_;
    ...
    void calc_zone(const string_type& obj){
      ...
      if(sit != obj_end){
        ...
        {
          network_boost::throw_exception(bad_offset(posix_time::to_simple_string(base_utc_offset_)));
        }
      }
      ...
      if(sit != obj_end){
        ...
        {
          network_boost::throw_exception(bad_adjustment(posix_time::to_simple_string(dst_offsets_.dst_adjust_)));
        }
      }
    ...
    void calc_rules(const string_type& start, const string_type& end){
      ...
      {
        network_boost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_start_offset_)));
      }
      ...
      {
        network_boost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_end_offset_)));
      }
    }
...
} } // namespace network_boost::local_time
