...
namespace local_time {
  ...
  inline
  local_date_time 
  operator+(const local_date_time& t, const network_boost::gregorian::months& m)
  {
  ...
  inline
  local_date_time 
  operator+=(local_date_time& t, const network_boost::gregorian::months& m)
  {
    return t += m.get_offset(t.utc_time().date());
  }
  ...
  inline
  local_date_time 
  operator+(const local_date_time& t, const network_boost::gregorian::years& y)
  {
  ...
  inline
  local_date_time 
  operator+=(local_date_time& t, const network_boost::gregorian::years& y)
  {
    return t += y.get_offset(t.utc_time().date());
  }
