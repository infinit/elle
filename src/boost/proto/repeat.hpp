...
#define BOOST_PROTO_ref_a_aux(Z, N, DATA)\
  network_boost::ref(BOOST_PP_CAT(proto_a, N))
...
/// \brief Generates a sequence like <tt>network_boost::ref(a0), network_boost::ref(a1), ...</tt>
///
