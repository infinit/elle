...
namespace network_boost { namespace proto
{
    ...
    /// INTERNAL ONLY
    ///
    # define BOOST_PROTO_ADDROF(x) ((char const volatile*)network_boost::addressof(x))
    /// INTERNAL ONLY
    ///
    ...
    #define BOOST_PROTO_DEFINE_FUN_OP_IMPL_(Z, N, DATA, Const)                                      \
        ...
        typename BOOST_PROTO_RESULT_OF<                                                             \
            proto_generator(                                                                        \
                typename network_boost::proto::result_of::BOOST_PP_CAT(funop, N)<                           \
        ...
        {                                                                                           \
            typedef network_boost::proto::result_of::BOOST_PP_CAT(funop, N)<                                \
                proto_derived_expr Const()                                                          \
              , proto_domain                                                                        \
                BOOST_PP_ENUM_TRAILING_PARAMS_Z(Z, N, const A)                                      \
            > funop;                                                                                \
    ...
    #define BOOST_PROTO_DEFINE_FUN_OP_VARIADIC_IMPL_(Const)                                         \
        ...
        typename BOOST_PROTO_RESULT_OF<                                                             \
            proto_generator(                                                                        \
                typename network_boost::proto::result_of::funop<                                            \
        ...
        {                                                                                           \
            typedef network_boost::proto::result_of::funop<                                                 \
                proto_derived_expr Const()(A const &...)                                            \
              , proto_derived_expr                                                                  \
              , proto_domain                                                                        \
            > funop;                                                                                \
    ...
    #define BOOST_PROTO_BASIC_EXTENDS_(Expr, Derived, Domain)                                       \
        ...
        typedef network_boost::proto::tag::proto_expr<proto_tag, proto_domain> fusion_tag;                  \
        ...
        {                                                                                           \
            return network_boost::addressof(this->proto_base().child0);                                     \
        }                                                                                           \
        /**/
    ...
    #define BOOST_PROTO_EXTENDS_COPY_ASSIGN_IMPL_(This, Const, Typename)                            \
        ...
        Typename() BOOST_PROTO_RESULT_OF<                                                           \
            Typename() This::proto_generator(                                                       \
                Typename() network_boost::proto::base_expr<                                                 \
                    Typename() This::proto_domain                                                   \
                  , network_boost::proto::tag::assign                                                       \
                  , network_boost::proto::list2<                                                            \
                        This &                                                                      \
                      , This Const() &                                                              \
                    >                                                                               \
                >::type                                                                             \
    ...
    #define BOOST_PROTO_EXTENDS_ASSIGN_IMPL_(ThisConst, ThatConst)                                  \
            ...
            proto_generator(                                                                        \
                typename network_boost::proto::base_expr<                                                   \
                  ...
                  , network_boost::proto::list2<                                                            \
                      ...
                      , typename network_boost::proto::result_of::as_child<A ThatConst(), proto_domain>::type \
                    >                                                                               \
                >::type                                                                             \
            )                                                                                       \
        >::type const                                                                               \
        ...
        {                                                                                           \
            ...
            that_type const that = {                                                                \
              ...
              , network_boost::proto::as_child<proto_domain>(a)                                             \
            };                                                                                      \
    ...
    #define BOOST_PROTO_EXTENDS_SUBSCRIPT_IMPL_(ThisConst, ThatConst)                               \
        ...
        typename BOOST_PROTO_RESULT_OF<                                                             \
            proto_generator(                                                                        \
                typename network_boost::proto::base_expr<                                                   \
                    proto_domain                                                                    \
                  , network_boost::proto::tag::subscript                                                    \
                  , network_boost::proto::list2<                                                            \
                        proto_derived_expr ThisConst() &                                            \
                      , typename network_boost::proto::result_of::as_child<A ThatConst(), proto_domain>::type \
                    >                                                                               \
    ...
    namespace exprns_
    {
        ...
        struct virtual_member
        {
            ...
            typedef network_boost::proto::tag::proto_expr<proto_tag, Domain> fusion_tag;
        ...
        #define BOOST_PROTO_EXTENDS_MEMBER_(R, DOMAIN, ELEM)                                            \
            network_boost::proto::exprns_::virtual_member<                                                      \
                proto_derived_expr                                                                      \
