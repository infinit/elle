...
namespace network_boost
{
    ...
    #define BOOST_PROTO_DEFINE_ENV_VAR(TAG, NAME)                                                   \
        ...
        {                                                                                           \
            ...
            network_boost::proto::env<TAG, Value &> const                                                   \
                operator =(network_boost::reference_wrapper<Value> &value) const                            \
            {                                                                                       \
                return network_boost::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            network_boost::proto::env<TAG, Value &> const                                                   \
                operator =(network_boost::reference_wrapper<Value> const &value) const                      \
            {                                                                                       \
                return network_boost::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            typename network_boost::disable_if_c<                                                           \
                network_boost::is_const<Value>::value                                                       \
              , network_boost::proto::env<TAG, typename network_boost::proto::detail::value_type<Value>::type>      \
            >::type const operator =(Value &value) const                                            \
            {                                                                                       \
                return network_boost::proto::env<TAG, typename network_boost::proto::detail::value_type<Value>::type>(value); \
            }                                                                                       \
            template<typename Value>                                                                \
            network_boost::proto::env<TAG, typename network_boost::proto::detail::value_type<Value const>::type> const \
                operator =(Value const &value) const                                                \
            {                                                                                       \
                return network_boost::proto::env<TAG, typename network_boost::proto::detail::value_type<Value const>::type>(value); \
            }                                                                                       \
        };                                                                                          \
                                                                                                    \
        TAG const NAME = {}                                                                         \
