...
namespace network_boost { namespace proto
{
    ...
    struct call<Fun()> : transform<call<Fun()> >
    {
        ...
        /// for <tt>network_boost::result_of\<Fun()\>::type</tt>. Otherwise, it is
        /// a typedef for <tt>network_boost::result_of\<Fun(Expr, State, Data)\>::type</tt>.
        template<typename Expr, typename State, typename Data>
        struct impl
    ...
    struct call<Fun(A0)> : transform<call<Fun(A0)> >
    {
        ...
        /// then \c type is a typedef for <tt>network_boost::result_of\<Fun(X)\>::type</tt>.
        /// Otherwise, it is a typedef for <tt>network_boost::result_of\<Fun(X, State, Data)\>::type</tt>.
    ...
    struct call<Fun(A0, A1)> : transform<call<Fun(A0, A1)> >
    {
          ...
          : transform_impl<Expr, State, Data>
        {
            ...
            /// <tt>network_boost::result_of\<Fun(X, Y)\>::type</tt>. Otherwise, it is
            /// a typedef for <tt>network_boost::result_of\<Fun(X, Y, Data)\>::type</tt>.
