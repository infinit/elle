...
namespace network_boost { namespace proto
{
    ...
    ///     <tt>network_boost::result_of\<when\<_,T\>(E,int,int)\>::type::value</tt>
    ...
    ///     \c E matches <tt>C::case_\<network_boost::result_of\<T(E)\>::type\></tt>.
    ...
    /// <tt>network_boost::result_of\<when\<_,If\>(E,int,int)\>::type::value</tt>
    /// is \c true and \c E matches \c U; or, if
    /// <tt>network_boost::result_of\<when\<_,If\>(E,int,int)\>::type::value</tt>
    ...
    /// if <tt>network_boost::result_of\<when\<_,If\>(E,S,V)\>::type::value</tt>
    ...
    /// matches <tt>C::case_\<network_boost::result_of\<T(E)\>::type\></tt>.
    ///
    ...
    /// <tt>C::case_\<network_boost::result_of\<T(E,S,D)\>::type\>()(e, s, d)</tt>.
