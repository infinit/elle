...
# define BOOST_PROTO_DISABLE_IF_IS_CONST(T)\
    , typename network_boost::disable_if_c<network_boost::is_const<T>::value, network_boost::proto::detail::undefined>::type * = 0
#else
# define BOOST_PROTO_DISABLE_IF_IS_CONST(T)
#endif
...
# define BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)\
    , typename network_boost::disable_if_c<network_boost::is_function<T>::value, network_boost::proto::detail::undefined>::type * = 0
#else
# define BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)
#endif
...
# define BOOST_PROTO_RESULT_OF network_boost::result_of
#else
# define BOOST_PROTO_RESULT_OF network_boost::tr1_result_of
#endif
...
namespace network_boost { namespace proto
{
    namespace detail
    {
        ...
        #define BOOST_PROTO_UNCVREF(X)                                                              \
            typename network_boost::proto::detail::uncvref<X>::type                                         \
            /**/
