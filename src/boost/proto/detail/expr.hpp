    ...
    ///             in the \c network_boost::proto::tag namespace, but it doesn't
    ///             have to be.
    ///
    ...
    #endif
    {
        ...
        /// If \c Tag is \c network_boost::proto::tag::address_of and \c proto_child0 is
        ...
        /// \c network_boost::proto::tag::address_of. Otherwise, this function will
        /// fail to compile.
        ///
        ...
        {
            return network_boost::addressof(this->child0);
        }
    #else
        /// INTERNAL ONLY
        ///
        ...
        /// Encodes the return type of \c expr\<\>::operator(), for use with \c network_boost::result_of\<\>
        ///
