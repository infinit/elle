...
namespace network_boost { namespace proto { namespace detail
{
    ...
    template<typename T>
    struct normalize_arg<network_boost::reference_wrapper<T> >
    {
        typedef T &type;
        typedef T &reference;
    };
    ...
    template<typename T>
    struct normalize_arg<network_boost::reference_wrapper<T> const>
    {
        typedef T &type;
        typedef T &reference;
    };
...
}}} // namespace network_boost::proto::detail
