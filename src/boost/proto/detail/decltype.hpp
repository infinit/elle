...
# define BOOST_PROTO_DECLTYPE_NESTED_TYPEDEF_TPL_(NESTED, EXPR)                                     \
    ...
    static int const BOOST_PP_CAT(sz, NESTED) = sizeof(network_boost::proto::detail::check_reference(EXPR));\
    struct NESTED                                                                                   \
...
namespace network_boost { namespace proto
{
    namespace detail
    {
        ...
        {
            using network_boost::get_pointer;
            void *(&get_pointer(...))[2];
        ...
        {
            return network_boost::addressof(t);
        }
        ...
        using namespace network_boost::proto::detail::get_pointerns                                         \
        /**/

        #define BOOST_PROTO_GET_POINTER(Type, Obj)                                                  \
        network_boost::proto::detail::proto_get_pointer<Type>(                                              \
            network_boost::proto::detail::lvalue(Obj)                                                       \
          , (true ? 0 : get_pointer(Obj))                                                           \
          , (true ? 0 : network_boost::addressof(network_boost::proto::detail::lvalue(Obj)))                        \
        )                                                                                           \
        /**/
        ...
        namespace get_pointerns
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////
            // result_of_ is a wrapper around network_boost::result_of that also handles "invocations" of
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        // normalize a function type for use with network_boost::result_of
