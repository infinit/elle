    ...
    struct push_back
    {
        ...
        struct result<This(Seq, T)>
          : fusion::result_of::push_back<
                typename network_boost::add_const<typename network_boost::remove_reference<Seq>::type>::type
              , typename network_boost::remove_const<typename network_boost::remove_reference<T>::type>::type
            >
        {};
