...
namespace network_boost { namespace proto { namespace functional
{
            ...
            typedef
                typename std::iterator_traits<
                    typename network_boost::remove_const<
                        typename network_boost::remove_reference<InputIter1>::type
                    >::type
                >::difference_type
            type;
        };
    ...
    struct next
    {
        ...
        struct result<This(ForwardIterator)>
        {
            typedef
                typename network_boost::remove_const<
                    typename network_boost::remove_reference<ForwardIterator>::type
                >::type
            type;
        };
    ...
    struct prior
    {
        ...
        struct result<This(BidirectionalIterator)>
        {
            typedef
                typename network_boost::remove_const<
                    typename network_boost::remove_reference<BidirectionalIterator>::type
                >::type
            type;
        };
