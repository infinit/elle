...
BOOST_SYMBOL_IMPORT network_boost::detail::winapi::VOID_ WINAPI
...
BOOST_SYMBOL_IMPORT network_boost::detail::winapi::BOOL_ WINAPI
...
BOOST_SYMBOL_IMPORT network_boost::detail::winapi::DWORD_ WINAPI
GetTickCount(BOOST_DETAIL_WINAPI_VOID);
#endif

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN6
BOOST_SYMBOL_IMPORT network_boost::detail::winapi::ULONGLONG_ WINAPI
...
{
    network_boost::detail::winapi::SYSTEMTIME_ st;
    network_boost::detail::winapi::GetSystemTime(&st);
    network_boost::detail::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
