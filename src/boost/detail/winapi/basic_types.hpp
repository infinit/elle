...
// MinGW64 gcc 4.8.2 fails to compile function declarations with network_boost::detail::winapi::VOID_ arguments even though
...
typedef network_boost::int64_t LONGLONG_;
typedef network_boost::uint64_t ULONGLONG_;
