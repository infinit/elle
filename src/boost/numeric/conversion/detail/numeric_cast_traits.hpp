...
}}//namespace network_boost::numeric;
...
namespace network_boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(network_boost::long_long_type)(network_boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (network_boost::long_long_type)(network_boost::ulong_long_type)
