...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace network_boost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER network_boost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace network_boost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER network_boost::type_of
