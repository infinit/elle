...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*network_boost::type_of::encode_index((network_boost::type_of::encode_counter<1005>*)0)))
...
# define BOOST_TYPEOF(expr) \
    network_boost::type_of::msvc_typeid_wrapper<typeid(network_boost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
struct name {\
    enum {_typeof_register_value=sizeof(typeid(network_boost::type_of::typeof_register_type<name>(expr)))};\
    typedef typename network_boost::type_of::msvc_extract_type<name>::id2type id2type;\
...
struct name {\
    enum {_typeof_register_value=sizeof(typeid(network_boost::type_of::typeof_register_type<name>(expr)))};\
    typedef network_boost::type_of::msvc_extract_type<name>::id2type id2type;\
...
# define BOOST_TYPEOF(expr) \
    network_boost::type_of::msvc_typeid_wrapper<sizeof(*network_boost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        BOOST_STATIC_CONSTANT(int,_typeof_register_value=sizeof(network_boost::type_of::typeof_register_type<name>(expr)));\
        typedef typename network_boost::type_of::msvc_extract_type<name>::id2type id2type;\
        typedef typename id2type::type type;\
    };
