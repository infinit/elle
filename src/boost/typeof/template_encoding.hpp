...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename network_boost::type_of::push_back<V, network_boost::mpl::size_t<ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<network_boost::mpl::size_t<ID>, Iter> self_t;\
        typedef network_boost::mpl::size_t<ID> self_id;\
        typedef Iter iter0;\
