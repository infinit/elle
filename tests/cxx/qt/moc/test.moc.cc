/****************************************************************************
** Meta object code from reading C++ file 'test.hh'
**
** Created: Mon Mar 15 19:48:40 2010
...
#error "The header file 'test.hh' doesn't include <QObject>."
