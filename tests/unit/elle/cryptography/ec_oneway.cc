...
int main()
{
  ...
  std::cout << digest_sha224 << std::endl;
  ...
  std::cout << digest_sha256 << std::endl;
  ...
  std::cout << digest_sha384 << std::endl;
  ...
  std::cout << digest_sha512 << std::endl;
