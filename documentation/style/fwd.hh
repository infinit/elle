 ...
 * to speed up the compilation process. Pointers and references must be
 * forward declared in order to speed up the compilation process.
 *
...
/*
 * Then, files defining type aliases (i.e typedefs) are included.
 */
