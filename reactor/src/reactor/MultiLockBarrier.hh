#ifndef INFINIT_REACTOR_MULTILOCKBARRIER_HH
# define INFINIT_REACTOR_MULTILOCKBARRIER_HH
...
namespace reactor
{
  ...
  /// When all the Locks have been destroyed, the MultiLockBarrier signals those
  /// waiting on it.
