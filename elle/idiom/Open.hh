...
// updated       julien quintard   [mon may  3 22:27:11 2010]
//
...
///
#define declare(_type_, _specialization_)				\
  ...
  elle::radix::Status	Imprint(elle::core::Natural32&) const;		\
									\
  elle::radix::Status	Clone(elle::radix::Object<_specialization_>*&)	\
    const;
...
///
#define embed(_type_, _specialization_, _template_)			\
  _template_								\
  ...
  elle::radix::Status	_type_::Clone(					\
                          elle::radix::Object<_specialization_>*&	\
			    object)					\
    const								\
  {									\
    enter();								\
