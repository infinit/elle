...
test_hmac_represent()
{
  ...
  // MD5.
  test_represent_hmac_n<1, infinit::cryptography::oneway::Algorithm::md5>();
  // SHA.
  test_represent_hmac_n<2, infinit::cryptography::oneway::Algorithm::sha>();
  // SHA-1.
  test_represent_hmac_n<3, infinit::cryptography::oneway::Algorithm::sha1>();
  // SHA-224.
  test_represent_hmac_n<4, infinit::cryptography::oneway::Algorithm::sha224>();
  // SHA-256.
  test_represent_hmac_n<5, infinit::cryptography::oneway::Algorithm::sha256>();
  // SHA-384.
  test_represent_hmac_n<6, infinit::cryptography::oneway::Algorithm::sha384>();
  // SHA-512.
  test_represent_hmac_n<7, infinit::cryptography::oneway::Algorithm::sha512>();
}
