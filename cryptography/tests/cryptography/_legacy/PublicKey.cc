...
test_compare_rsa()
{
  infinit::cryptography::rsa::PublicKey K1 = test_generate_rsa(1024);
  infinit::cryptography::rsa::PublicKey K2 = test_generate_rsa(1024);
...
ELLE_TEST_SUITE()
{
  boost::unit_test::test_suite* suite = BOOST_TEST_SUITE("_legacy/PublicKey");
